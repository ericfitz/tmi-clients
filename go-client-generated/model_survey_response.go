...
type SurveyResponse struct {
	...
	CreatedThreatModelId string `json:"created_threat_model_id,omitempty"`
	...
	ReviewedBy *interface{} `json:"reviewed_by,omitempty"`
	...
	SurveyJson ModelMap `json:"survey_json,omitempty"`
	...
	Answers ModelMap `json:"answers,omitempty"`
	// Optional link to existing threat model for re-reviews
	LinkedThreatModelId string `json:"linked_threat_model_id,omitempty"`
	...
	UiState ModelMap `json:"ui_state,omitempty"`
