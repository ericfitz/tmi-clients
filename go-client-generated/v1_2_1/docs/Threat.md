...
**Description** | Pointer to **string** | Description of the threat and risk to the organization | [optional] 
**Mitigation** | Pointer to **string** | Recommended or planned mitigation(s) for the threat | [optional] 
...
**Severity** | Pointer to **string** | Severity level of the threat | [optional] 
**Score** | Pointer to **float32** | Numeric score representing the risk or impact of the threat | [optional] 
**Priority** | Pointer to **string** | Priority level for addressing the threat | [optional] 
**Mitigated** | Pointer to **bool** | Whether the threat has been mitigated | [optional] 
**Status** | Pointer to **string** | Current status of the threat | [optional] 
...
**IssueUri** | Pointer to **string** | URL to an issue in an issue tracking system for this threat | [optional] 
