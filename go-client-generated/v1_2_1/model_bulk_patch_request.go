...
// checks if the BulkPatchRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkPatchRequest{}
...
type BulkPatchRequest struct {
	...
	Patches []BulkPatchRequestPatchesInner `json:"patches"`
}

type _BulkPatchRequest BulkPatchRequest
...
func (o *BulkPatchRequest) GetPatches() []BulkPatchRequestPatchesInner {
	if o == nil {
		var ret []BulkPatchRequestPatchesInner
		return ret
	}
...
func (o BulkPatchRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkPatchRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["patches"] = o.Patches
	return toSerialize, nil
}

func (o *BulkPatchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = BulkPatchRequest(varBulkPatchRequest)

	return err
}

type NullableBulkPatchRequest struct {
	value *BulkPatchRequest
	isSet bool
}

func (v NullableBulkPatchRequest) Get() *BulkPatchRequest {
	return v.value
}

func (v *NullableBulkPatchRequest) Set(val *BulkPatchRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkPatchRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkPatchRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkPatchRequest(val *BulkPatchRequest) *NullableBulkPatchRequest {
	return &NullableBulkPatchRequest{value: val, isSet: true}
}

func (v NullableBulkPatchRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkPatchRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
