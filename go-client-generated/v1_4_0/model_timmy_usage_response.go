...
// checks if the TimmyUsageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimmyUsageResponse{}
...
type _TimmyUsageResponse TimmyUsageResponse
...
func (o TimmyUsageResponse) MarshalJSON() ([]byte, error) {
...
func (o TimmyUsageResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TimmyUsageResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = TimmyUsageResponse(varTimmyUsageResponse)

	return err
}

type NullableTimmyUsageResponse struct {
	value *TimmyUsageResponse
	isSet bool
}

func (v NullableTimmyUsageResponse) Get() *TimmyUsageResponse {
	return v.value
}

func (v *NullableTimmyUsageResponse) Set(val *TimmyUsageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTimmyUsageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTimmyUsageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimmyUsageResponse(val *TimmyUsageResponse) *NullableTimmyUsageResponse {
	return &NullableTimmyUsageResponse{value: val, isSet: true}
}

func (v NullableTimmyUsageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimmyUsageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
