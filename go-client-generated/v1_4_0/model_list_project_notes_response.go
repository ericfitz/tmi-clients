...
// checks if the ListProjectNotesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListProjectNotesResponse{}
...
type _ListProjectNotesResponse ListProjectNotesResponse
...
func (o ListProjectNotesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListProjectNotesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListProjectNotesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ListProjectNotesResponse(varListProjectNotesResponse)

	return err
}

type NullableListProjectNotesResponse struct {
	value *ListProjectNotesResponse
	isSet bool
}

func (v NullableListProjectNotesResponse) Get() *ListProjectNotesResponse {
	return v.value
}

func (v *NullableListProjectNotesResponse) Set(val *ListProjectNotesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListProjectNotesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListProjectNotesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListProjectNotesResponse(val *ListProjectNotesResponse) *NullableListProjectNotesResponse {
	return &NullableListProjectNotesResponse{value: val, isSet: true}
}

func (v NullableListProjectNotesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListProjectNotesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
