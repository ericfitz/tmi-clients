...
// checks if the UsabilityFeedback type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UsabilityFeedback{}

// UsabilityFeedback struct for UsabilityFeedback
...
type _UsabilityFeedback UsabilityFeedback
...
func (o UsabilityFeedback) MarshalJSON() ([]byte, error) {
...
func (o UsabilityFeedback) ToMap() (map[string]interface{}, error) {
...
func (o *UsabilityFeedback) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UsabilityFeedback(varUsabilityFeedback)

	return err
}

type NullableUsabilityFeedback struct {
	value *UsabilityFeedback
	isSet bool
}

func (v NullableUsabilityFeedback) Get() *UsabilityFeedback {
	return v.value
}

func (v *NullableUsabilityFeedback) Set(val *UsabilityFeedback) {
	v.value = val
	v.isSet = true
}

func (v NullableUsabilityFeedback) IsSet() bool {
	return v.isSet
}

func (v *NullableUsabilityFeedback) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsabilityFeedback(val *UsabilityFeedback) *NullableUsabilityFeedback {
	return &NullableUsabilityFeedback{value: val, isSet: true}
}

func (v NullableUsabilityFeedback) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsabilityFeedback) UnmarshalJSON(src []byte) error {
	v.isSet = true
