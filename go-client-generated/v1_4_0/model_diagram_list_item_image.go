...
// checks if the DiagramListItemImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiagramListItemImage{}

// DiagramListItemImage Image data with version information for thumbnail rendering
type DiagramListItemImage struct {
...
func (o DiagramListItemImage) MarshalJSON() ([]byte, error) {
...
func (o DiagramListItemImage) ToMap() (map[string]interface{}, error) {
...
type NullableDiagramListItemImage struct {
	value *DiagramListItemImage
	isSet bool
}

func (v NullableDiagramListItemImage) Get() *DiagramListItemImage {
	return v.value
}

func (v *NullableDiagramListItemImage) Set(val *DiagramListItemImage) {
	v.value = val
	v.isSet = true
}

func (v NullableDiagramListItemImage) IsSet() bool {
	return v.isSet
}

func (v *NullableDiagramListItemImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiagramListItemImage(val *DiagramListItemImage) *NullableDiagramListItemImage {
	return &NullableDiagramListItemImage{value: val, isSet: true}
}

func (v NullableDiagramListItemImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiagramListItemImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
