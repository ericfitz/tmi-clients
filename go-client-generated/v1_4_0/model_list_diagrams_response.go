...
// checks if the ListDiagramsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDiagramsResponse{}

// ListDiagramsResponse Paginated list of diagrams
type ListDiagramsResponse struct {
	Diagrams []DiagramListItem `json:"diagrams"`
	// Total number of diagrams matching criteria
...
type _ListDiagramsResponse ListDiagramsResponse
...
// GetDiagrams returns the Diagrams field value
func (o *ListDiagramsResponse) GetDiagrams() []DiagramListItem {
	if o == nil {
		var ret []DiagramListItem
		return ret
	}
...
// GetDiagramsOk returns a tuple with the Diagrams field value
...
func (o ListDiagramsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListDiagramsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListDiagramsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListDiagramsResponse := _ListDiagramsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListDiagramsResponse)

	if err != nil {
		return err
	}

	*o = ListDiagramsResponse(varListDiagramsResponse)

	return err
}

type NullableListDiagramsResponse struct {
	value *ListDiagramsResponse
	isSet bool
}

func (v NullableListDiagramsResponse) Get() *ListDiagramsResponse {
	return v.value
}

func (v *NullableListDiagramsResponse) Set(val *ListDiagramsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListDiagramsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListDiagramsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDiagramsResponse(val *ListDiagramsResponse) *NullableListDiagramsResponse {
	return &NullableListDiagramsResponse{value: val, isSet: true}
}

func (v NullableListDiagramsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDiagramsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
