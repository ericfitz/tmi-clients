...
type BaseDiagram struct {
	...
	// True when the diagram was created by an automation/service-account principal. Sticky from creation.
...
func (o *BaseDiagram) SetDeletedAtNil() {
	o.DeletedAt.Set(nil)
}
...
func (o *BaseDiagram) GetAutoGenerated() bool {
...
// and a boolean to check if the value has been set.
func (o *BaseDiagram) GetAutoGeneratedOk() (*bool, bool) {
	if o == nil || IsNil(o.AutoGenerated) {
		return nil, false
	}
...
func (o *BaseDiagram) HasAutoGenerated() bool {
	if o != nil && !IsNil(o.AutoGenerated) {
		return true
	}
...
func (o *BaseDiagram) SetAutoGenerated(v bool) {
	o.AutoGenerated = &v
}

// GetAlias returns the Alias field value if set, zero value otherwise.
func (o *BaseDiagram) GetAlias() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseDiagram) GetAliasOk() (*int32, bool) {
	if o == nil || IsNil(o.Alias) {
		return nil, false
	}
	return o.Alias, true
...
func (o *BaseDiagram) HasAlias() bool {
	if o != nil && !IsNil(o.Alias) {
		return true
	}
...
func (o *BaseDiagram) SetAlias(v int32) {
	o.Alias = &v
}
