...
// checks if the ListTimmyMessagesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTimmyMessagesResponse{}
...
type _ListTimmyMessagesResponse ListTimmyMessagesResponse
...
func NewListTimmyMessagesResponse(messages []TimmyChatMessage, total int32, limit int32, offset int32) *ListTimmyMessagesResponse {
	this := ListTimmyMessagesResponse{}
...
func (o ListTimmyMessagesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListTimmyMessagesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListTimmyMessagesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ListTimmyMessagesResponse(varListTimmyMessagesResponse)

	return err
}

type NullableListTimmyMessagesResponse struct {
	value *ListTimmyMessagesResponse
	isSet bool
}

func (v NullableListTimmyMessagesResponse) Get() *ListTimmyMessagesResponse {
	return v.value
}

func (v *NullableListTimmyMessagesResponse) Set(val *ListTimmyMessagesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTimmyMessagesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTimmyMessagesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTimmyMessagesResponse(val *ListTimmyMessagesResponse) *NullableListTimmyMessagesResponse {
	return &NullableListTimmyMessagesResponse{value: val, isSet: true}
}

func (v NullableListTimmyMessagesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTimmyMessagesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
