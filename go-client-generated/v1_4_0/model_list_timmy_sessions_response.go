...
// checks if the ListTimmySessionsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTimmySessionsResponse{}
...
type _ListTimmySessionsResponse ListTimmySessionsResponse
...
func NewListTimmySessionsResponse(sessions []TimmyChatSession, total int32, limit int32, offset int32) *ListTimmySessionsResponse {
	this := ListTimmySessionsResponse{}
...
func (o ListTimmySessionsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListTimmySessionsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListTimmySessionsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ListTimmySessionsResponse(varListTimmySessionsResponse)

	return err
}

type NullableListTimmySessionsResponse struct {
	value *ListTimmySessionsResponse
	isSet bool
}

func (v NullableListTimmySessionsResponse) Get() *ListTimmySessionsResponse {
	return v.value
}

func (v *NullableListTimmySessionsResponse) Set(val *ListTimmySessionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTimmySessionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTimmySessionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTimmySessionsResponse(val *ListTimmySessionsResponse) *NullableListTimmySessionsResponse {
	return &NullableListTimmySessionsResponse{value: val, isSet: true}
}

func (v NullableListTimmySessionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTimmySessionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
