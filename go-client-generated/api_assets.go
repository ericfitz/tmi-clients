 ...
 * @param body JSON Patch operations to apply to the asset
 * @param threatModelId Threat model identifier
 * @param assetId Asset identifier
@return Asset
*/
func (a *AssetsApiService) PatchThreatModelAsset(ctx context.Context, body []JsonPatchDocumentInner, threatModelId string, assetId string) (Asset, *http.Response, error) {
	var (
