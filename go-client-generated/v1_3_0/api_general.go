...
func (r ApiGetApiInfoRequest) Execute() (*ApiInfo, *http.Response, error) {
...
*/
func (a *GeneralAPIService) GetApiInfo(ctx context.Context) ApiGetApiInfoRequest {
	return ApiGetApiInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return ApiInfo
func (a *GeneralAPIService) GetApiInfoExecute(r ApiGetApiInfoRequest) (*ApiInfo, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GeneralAPIService.GetApiInfo")
	if err != nil {
