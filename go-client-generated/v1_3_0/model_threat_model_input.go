...
// GetThreatModelFramework returns the ThreatModelFramework field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ThreatModelInput) GetThreatModelFramework() string {
	if o == nil || IsNil(o.ThreatModelFramework.Get()) {
		var ret string
		return ret
	}
	return *o.ThreatModelFramework.Get()
}
...
// SetThreatModelFramework gets a reference to the given NullableString and assigns it to the ThreatModelFramework field.
func (o *ThreatModelInput) SetThreatModelFramework(v string) {
	o.ThreatModelFramework.Set(&v)
}
// SetThreatModelFrameworkNil sets the value for ThreatModelFramework to be an explicit nil
func (o *ThreatModelInput) SetThreatModelFrameworkNil() {
	o.ThreatModelFramework.Set(nil)
}
...
func (o ThreatModelInput) ToMap() (map[string]interface{}, error) {
	...
	if o.ThreatModelFramework.IsSet() {
		toSerialize["threat_model_framework"] = o.ThreatModelFramework.Get()
	}
