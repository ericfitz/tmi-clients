...
**Data** | Pointer to **map[string]interface{}** | User-provided data for the add-on (max 1KB JSON-serialized) | [optional] 
...
`func (o *InvokeAddonRequest) GetData() map[string]interface{}`

GetData returns the Data field if non-nil, zero value otherwise.

### GetDataOk

`func (o *InvokeAddonRequest) GetDataOk() (*map[string]interface{}, bool)`
...
`func (o *InvokeAddonRequest) SetData(v map[string]interface{})`

SetData sets Data field to given value.

### HasData

`func (o *InvokeAddonRequest) HasData() bool`
