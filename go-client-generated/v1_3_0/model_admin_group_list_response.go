...
// checks if the AdminGroupListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminGroupListResponse{}
...
type _AdminGroupListResponse AdminGroupListResponse
...
func (o AdminGroupListResponse) MarshalJSON() ([]byte, error) {
...
func (o AdminGroupListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AdminGroupListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AdminGroupListResponse(varAdminGroupListResponse)

	return err
}

type NullableAdminGroupListResponse struct {
	value *AdminGroupListResponse
	isSet bool
}

func (v NullableAdminGroupListResponse) Get() *AdminGroupListResponse {
	return v.value
}

func (v *NullableAdminGroupListResponse) Set(val *AdminGroupListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminGroupListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminGroupListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminGroupListResponse(val *AdminGroupListResponse) *NullableAdminGroupListResponse {
	return &NullableAdminGroupListResponse{value: val, isSet: true}
}

func (v NullableAdminGroupListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminGroupListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
