...
`func (o *RepositoryBase) SetNameNil(b bool)`

 SetNameNil sets the value for Name to be an explicit nil

### UnsetName
`func (o *RepositoryBase) UnsetName()`
...
`func (o *RepositoryBase) SetTypeNil(b bool)`

 SetTypeNil sets the value for Type to be an explicit nil

### UnsetType
`func (o *RepositoryBase) UnsetType()`
...
`func (o *RepositoryBase) GetTimmyEnabled() bool`

GetTimmyEnabled returns the TimmyEnabled field if non-nil, zero value otherwise.

### GetTimmyEnabledOk

`func (o *RepositoryBase) GetTimmyEnabledOk() (*bool, bool)`
...
`func (o *RepositoryBase) SetTimmyEnabled(v bool)`

SetTimmyEnabled sets TimmyEnabled field to given value.

### HasTimmyEnabled

`func (o *RepositoryBase) HasTimmyEnabled() bool`
