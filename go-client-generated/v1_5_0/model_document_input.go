...
type DocumentInput struct {
	...
	PickerRegistration map[string]interface{} `json:"picker_registration,omitempty"`
}
...
// GetPickerRegistration returns the PickerRegistration field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DocumentInput) GetPickerRegistration() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
	return o.PickerRegistration
}

// GetPickerRegistrationOk returns a tuple with the PickerRegistration field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DocumentInput) GetPickerRegistrationOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.PickerRegistration) {
		return map[string]interface{}{}, false
	}
	return o.PickerRegistration, true
}
...
// SetPickerRegistration gets a reference to the given map[string]interface{} and assigns it to the PickerRegistration field.
func (o *DocumentInput) SetPickerRegistration(v map[string]interface{}) {
	o.PickerRegistration = v
}
...
func (o DocumentInput) ToMap() (map[string]interface{}, error) {
	...
	if o.PickerRegistration != nil {
		toSerialize["picker_registration"] = o.PickerRegistration
	}
