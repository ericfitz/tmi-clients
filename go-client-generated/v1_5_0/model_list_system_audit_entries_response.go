...
// checks if the ListSystemAuditEntriesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSystemAuditEntriesResponse{}
...
type _ListSystemAuditEntriesResponse ListSystemAuditEntriesResponse
...
func NewListSystemAuditEntriesResponse(entries []SystemAuditEntry, total int32, limit int32) *ListSystemAuditEntriesResponse {
	this := ListSystemAuditEntriesResponse{}
...
func (o *ListSystemAuditEntriesResponse) SetNextCursorNil() {
...
func (o *ListSystemAuditEntriesResponse) SetPrevCursorNil() {
...
func (o ListSystemAuditEntriesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListSystemAuditEntriesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListSystemAuditEntriesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ListSystemAuditEntriesResponse(varListSystemAuditEntriesResponse)

	return err
}

type NullableListSystemAuditEntriesResponse struct {
	value *ListSystemAuditEntriesResponse
	isSet bool
}

func (v NullableListSystemAuditEntriesResponse) Get() *ListSystemAuditEntriesResponse {
	return v.value
}

func (v *NullableListSystemAuditEntriesResponse) Set(val *ListSystemAuditEntriesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListSystemAuditEntriesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListSystemAuditEntriesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSystemAuditEntriesResponse(val *ListSystemAuditEntriesResponse) *NullableListSystemAuditEntriesResponse {
	return &NullableListSystemAuditEntriesResponse{value: val, isSet: true}
}

func (v NullableListSystemAuditEntriesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSystemAuditEntriesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
