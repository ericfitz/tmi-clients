...
**ModifiedBy** | Pointer to **map[string]interface{}** | Per-viewer access diagnostics; present when access_status is not &#39;accessible&#39; | [optional] [readonly] 
**ModifiedAt** | Pointer to **time.Time** | Last modification timestamp (RFC3339) | [optional] [readonly] 
**ReviewedBy** | Pointer to **map[string]interface{}** | Optional; when present, client has performed a Picker-based attachment | [optional] 
...
**Notes** | Pointer to [**[]TeamNoteListItem**](TeamNoteListItem.md) | List of notes associated with the team | [optional] [readonly] 
...
`func (o *Team) GetNotes() []TeamNoteListItem`

GetNotes returns the Notes field if non-nil, zero value otherwise.

### GetNotesOk

`func (o *Team) GetNotesOk() (*[]TeamNoteListItem, bool)`
...
`func (o *Team) SetNotes(v []TeamNoteListItem)`

SetNotes sets Notes field to given value.

### HasNotes

`func (o *Team) HasNotes() bool`
