...
// GetContentProviders returns the ContentProviders field value if set, zero value otherwise.
func (o *ClientConfig) GetContentProviders() []ContentProvider {
	if o == nil || IsNil(o.ContentProviders) {
...
// GetContentProvidersOk returns a tuple with the ContentProviders field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetContentProviders gets a reference to the given []ContentProvider and assigns it to the ContentProviders field.
...
func (o ClientConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ContentProviders) {
		toSerialize["content_providers"] = o.ContentProviders
	}
