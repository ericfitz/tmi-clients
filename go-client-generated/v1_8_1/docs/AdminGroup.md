...
**IsBuiltin** | Pointer to **bool** | True only for server-seeded built-in groups; false for admin-created groups (which also use provider \&quot;tmi\&quot;) | [optional] [readonly] 
...
`func (o *AdminGroup) GetIsBuiltin() bool`

GetIsBuiltin returns the IsBuiltin field if non-nil, zero value otherwise.

### GetIsBuiltinOk

`func (o *AdminGroup) GetIsBuiltinOk() (*bool, bool)`
...
`func (o *AdminGroup) SetIsBuiltin(v bool)`

SetIsBuiltin sets IsBuiltin field to given value.

### HasIsBuiltin

`func (o *AdminGroup) HasIsBuiltin() bool`
