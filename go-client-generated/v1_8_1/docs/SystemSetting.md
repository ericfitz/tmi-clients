...
**Source** | Pointer to **string** | Where the effective value of this setting comes from. Server-managed, not writable. | [optional] [readonly] 
**ReadOnly** | Pointer to **bool** | Whether this setting can be modified via the API. True when source is not database. | [optional] [readonly] 
