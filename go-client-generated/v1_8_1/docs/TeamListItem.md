...
**NoteCount** | Pointer to **int32** | Number of notes associated with this team | [optional] 
...
`func (o *TeamListItem) GetNoteCount() int32`

GetNoteCount returns the NoteCount field if non-nil, zero value otherwise.

### GetNoteCountOk

`func (o *TeamListItem) GetNoteCountOk() (*int32, bool)`
...
`func (o *TeamListItem) SetNoteCount(v int32)`

SetNoteCount sets NoteCount field to given value.

### HasNoteCount

`func (o *TeamListItem) HasNoteCount() bool`
