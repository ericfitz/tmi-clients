...
------------ | ------------- | ------------- | -------------
**Name** | **NullableString** | Name for the source code reference | 
...
`func NewRepositoryBulkUpdateItem(name NullableString, uri string, id string, ) *RepositoryBulkUpdateItem`
