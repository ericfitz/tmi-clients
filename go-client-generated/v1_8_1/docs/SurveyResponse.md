...
**SurveyVersion** | Pointer to **string** | Survey version captured at creation time - responses always complete on the original version (server-set; response only) | [optional] [readonly] 
