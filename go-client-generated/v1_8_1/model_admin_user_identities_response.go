...
// checks if the AdminUserIdentitiesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminUserIdentitiesResponse{}

// AdminUserIdentitiesResponse A user's primary sign-in identity plus any linked identities, as seen by an administrator
type AdminUserIdentitiesResponse struct {
	Primary AdminUserIdentitiesResponsePrimary `json:"primary"`
...
type _AdminUserIdentitiesResponse AdminUserIdentitiesResponse
...
func NewAdminUserIdentitiesResponse(primary AdminUserIdentitiesResponsePrimary) *AdminUserIdentitiesResponse {
	this := AdminUserIdentitiesResponse{}
...
func (o *AdminUserIdentitiesResponse) GetPrimary() AdminUserIdentitiesResponsePrimary {
	if o == nil {
		var ret AdminUserIdentitiesResponsePrimary
		return ret
	}
...
func (o AdminUserIdentitiesResponse) MarshalJSON() ([]byte, error) {
...
func (o AdminUserIdentitiesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AdminUserIdentitiesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAdminUserIdentitiesResponse := _AdminUserIdentitiesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAdminUserIdentitiesResponse)

	if err != nil {
		return err
	}

	*o = AdminUserIdentitiesResponse(varAdminUserIdentitiesResponse)

	return err
}

type NullableAdminUserIdentitiesResponse struct {
	value *AdminUserIdentitiesResponse
	isSet bool
}

func (v NullableAdminUserIdentitiesResponse) Get() *AdminUserIdentitiesResponse {
	return v.value
}

func (v *NullableAdminUserIdentitiesResponse) Set(val *AdminUserIdentitiesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminUserIdentitiesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminUserIdentitiesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminUserIdentitiesResponse(val *AdminUserIdentitiesResponse) *NullableAdminUserIdentitiesResponse {
	return &NullableAdminUserIdentitiesResponse{value: val, isSet: true}
}

func (v NullableAdminUserIdentitiesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminUserIdentitiesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
