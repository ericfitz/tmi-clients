...
// checks if the ListWebhookQuotasResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListWebhookQuotasResponse{}
...
type ListWebhookQuotasResponse struct {
	...
	Defaults ListWebhookQuotasResponseDefaults `json:"defaults"`
}

type _ListWebhookQuotasResponse ListWebhookQuotasResponse
...
func NewListWebhookQuotasResponse(quotas []WebhookQuota, total int32, limit int32, offset int32, defaults ListWebhookQuotasResponseDefaults) *ListWebhookQuotasResponse {
	this := ListWebhookQuotasResponse{}
	this.Quotas = quotas
	this.Total = total
	this.Limit = limit
	this.Offset = offset
...
func (o *ListWebhookQuotasResponse) GetDefaults() ListWebhookQuotasResponseDefaults {
	if o == nil {
		var ret ListWebhookQuotasResponseDefaults
		return ret
	}
...
func (o ListWebhookQuotasResponse) MarshalJSON() ([]byte, error) {
...
func (o ListWebhookQuotasResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListWebhookQuotasResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ListWebhookQuotasResponse(varListWebhookQuotasResponse)

	return err
}

type NullableListWebhookQuotasResponse struct {
	value *ListWebhookQuotasResponse
	isSet bool
}

func (v NullableListWebhookQuotasResponse) Get() *ListWebhookQuotasResponse {
	return v.value
}

func (v *NullableListWebhookQuotasResponse) Set(val *ListWebhookQuotasResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListWebhookQuotasResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListWebhookQuotasResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWebhookQuotasResponse(val *ListWebhookQuotasResponse) *NullableListWebhookQuotasResponse {
	return &NullableListWebhookQuotasResponse{value: val, isSet: true}
}

func (v NullableListWebhookQuotasResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWebhookQuotasResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
