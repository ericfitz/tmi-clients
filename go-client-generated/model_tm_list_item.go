...
type TmListItem struct {
	...
	Owner *AllOfTmListItemOwner `json:"owner"`
	// User who created the threat model
	CreatedBy *AllOfTmListItemCreatedBy `json:"created_by"`
	...
	SecurityReviewer *AllOfTmListItemSecurityReviewer `json:"security_reviewer,omitempty"`
}
