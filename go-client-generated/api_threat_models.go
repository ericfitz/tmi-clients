 ...
 * @param body Threat Model creation data
@return ThreatModel
*/
 ...
 * @param optional nil or *ThreatModelsApiPatchThreatModelOpts - Optional Parameters:
     * @param "Body" (optional.Interface of []JsonPatchDocumentInner) -  JSON Patch operations to apply to the threat model
@return ThreatModel
*/
...
/*
ThreatModelsApiService Restore a soft-deleted threat model
...
@return ThreatModel
*/
func (a *ThreatModelsApiService) RestoreThreatModel(ctx context.Context, threatModelId string) (ThreatModel, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/threat_models/{threat_model_id}/restore"
	localVarPath = strings.Replace(localVarPath, "{"+"threat_model_id"+"}", fmt.Sprintf("%v", threatModelId), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Complete threat model data for replacement
 * @param threatModelId Threat model identifier
@return ThreatModel
*/
