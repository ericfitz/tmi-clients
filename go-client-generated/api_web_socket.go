...
/*
WebSocketApiService Get a WebSocket authentication ticket
 ...
 * @param sessionId The collaboration session ID the ticket is scoped to
@return WsTicketResponse
*/
func (a *WebSocketApiService) GetWsTicket(ctx context.Context, sessionId string) (WsTicketResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/ws/ticket"
