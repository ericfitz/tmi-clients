...
/*
UsersApiService Delete authenticated user account and all data
 ...
 * @param optional nil or *UsersApiDeleteUserAccountOpts - Optional Parameters:
     * @param "Challenge" (optional.String) -  Challenge string from first request (step 2 only). Must match exactly.
@return DeletionChallenge
*/

type UsersApiDeleteUserAccountOpts struct {
    Challenge optional.String
}

func (a *UsersApiService) DeleteUserAccount(ctx context.Context, localVarOptionals *UsersApiDeleteUserAccountOpts) (DeletionChallenge, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.Challenge.IsSet() {
		localVarQueryParams.Add("challenge", parameterToString(localVarOptionals.Challenge.Value(), ""))
	}
...
/*
UsersApiService Logout current user
...
*/
func (a *UsersApiService) LogoutCurrentUser(ctx context.Context) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/me/logout"
...
/*
UsersApiService Transfer ownership of all owned resources
...
*/
func (a *UsersApiService) TransferCurrentUserOwnership(ctx context.Context, body TransferOwnershipRequest) (TransferOwnershipResult, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/me/transfer"
