...
**UserInternalUuid** | **string** | Internal UUID of the user | [default to null]
**UserEmail** | **string** | Email address of the user | [default to null]
**UserName** | **string** | Display name of the user | [default to null]
**UserProvider** | **string** | OAuth/SAML provider for the user | [default to null]
**UserProviderUserId** | **string** | Provider-specific user identifier | [default to null]
