...
`func (o *Threat) GetSsvc() SSVCScore`

GetSsvc returns the Ssvc field if non-nil, zero value otherwise.

### GetSsvcOk

`func (o *Threat) GetSsvcOk() (*SSVCScore, bool)`
