...
------------- | ------------- | -------------
[**AddGroupMember**](AdministrationAPI.md#AddGroupMember) | **Post** /admin/groups/{group_id}/members | Add member to group
...
[**DeleteAdminGroup**](AdministrationAPI.md#DeleteAdminGroup) | **Delete** /admin/groups/{group_id} | Delete group
[**DeleteAdminUser**](AdministrationAPI.md#DeleteAdminUser) | **Delete** /admin/users/{user_id} | Delete user
...
[**GetAdminGroup**](AdministrationAPI.md#GetAdminGroup) | **Get** /admin/groups/{group_id} | Get group details
...
[**GetAdminUser**](AdministrationAPI.md#GetAdminUser) | **Get** /admin/users/{user_id} | Get user details
...
[**ListGroupMembers**](AdministrationAPI.md#ListGroupMembers) | **Get** /admin/groups/{group_id}/members | List group members
...
[**RemoveGroupMember**](AdministrationAPI.md#RemoveGroupMember) | **Delete** /admin/groups/{group_id}/members/{member_uuid} | Remove member from group
[**TransferAdminUserOwnership**](AdministrationAPI.md#TransferAdminUserOwnership) | **Post** /admin/users/{user_id}/transfer | Transfer user ownership to another user
...
[**UpdateAdminGroup**](AdministrationAPI.md#UpdateAdminGroup) | **Patch** /admin/groups/{group_id} | Update group metadata
[**UpdateAdminUser**](AdministrationAPI.md#UpdateAdminUser) | **Patch** /admin/users/{user_id} | Update user metadata
...
> GroupMember AddGroupMember(ctx, groupId).AddGroupMemberRequest(addGroupMemberRequest).Execute()
...
func main() {
	groupId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | Internal system UUID of the group
	...
	resp, r, err := apiClient.AdministrationAPI.AddGroupMember(context.Background(), groupId).AddGroupMemberRequest(addGroupMemberRequest).Execute()
	if err != nil {
...
**groupId** | **string** | Internal system UUID of the group | 
...
func main() {
	userId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | Internal system UUID of the user
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**userId** | **string** | Internal system UUID of the user | 
...
> DeleteAdminGroup(ctx, groupId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.AdministrationAPI.DeleteAdminGroup(context.Background(), groupId).Execute()
	if err != nil {
...
> DeleteAdminUser(ctx, userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.AdministrationAPI.DeleteAdminUser(context.Background(), userId).Execute()
	if err != nil {
...
> AdminGroup GetAdminGroup(ctx, groupId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdministrationAPI.GetAdminGroup(context.Background(), groupId).Execute()
	if err != nil {
...
> AdminUser GetAdminUser(ctx, userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdministrationAPI.GetAdminUser(context.Background(), userId).Execute()
	if err != nil {
...
> AdminGroupListResponse ListAdminGroups(ctx).Provider(provider).GroupName(groupName).UsedInAuthorizations(usedInAuthorizations).BuiltIn(builtIn).Limit(limit).Offset(offset).SortBy(sortBy).SortOrder(sortOrder).Execute()
...
func main() {
	...
	builtIn := true // bool | Filter groups by built-in (server-seeded) status (optional)
	limit := int32(56) // int32 | Maximum number of results to return (optional) (default to 50)
	offset := int32(56) // int32 | Number of results to skip (optional) (default to 0)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdministrationAPI.ListAdminGroups(context.Background()).Provider(provider).GroupName(groupName).UsedInAuthorizations(usedInAuthorizations).BuiltIn(builtIn).Limit(limit).Offset(offset).SortBy(sortBy).SortOrder(sortOrder).Execute()
	if err != nil {
 ...
 **builtIn** | **bool** | Filter groups by built-in (server-seeded) status | 
 **limit** | **int32** | Maximum number of results to return | [default to 50]
 **offset** | **int32** | Number of results to skip | [default to 0]
...
> GroupMemberListResponse ListGroupMembers(ctx, groupId).Limit(limit).Offset(offset).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdministrationAPI.ListGroupMembers(context.Background(), groupId).Limit(limit).Offset(offset).Execute()
	if err != nil {
...
> ListSystemAuditEntriesResponse ListSystemAuditEntries(ctx).ActorEmail(actorEmail).ActorProvider(actorProvider).CreatedAfter(createdAfter).CreatedBefore(createdBefore).HttpMethod(httpMethod).PathPrefix(pathPrefix).FieldPath(fieldPath).Limit(limit).Cursor(cursor).Around(around).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdministrationAPI.ListSystemAuditEntries(context.Background()).ActorEmail(actorEmail).ActorProvider(actorProvider).CreatedAfter(createdAfter).CreatedBefore(createdBefore).HttpMethod(httpMethod).PathPrefix(pathPrefix).FieldPath(fieldPath).Limit(limit).Cursor(cursor).Around(around).Execute()
	if err != nil {
...
> RemoveGroupMember(ctx, groupId, memberUuid).SubjectType(subjectType).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.AdministrationAPI.RemoveGroupMember(context.Background(), groupId, memberUuid).SubjectType(subjectType).Execute()
	if err != nil {
...
> TransferOwnershipResult TransferAdminUserOwnership(ctx, userId).TransferOwnershipRequest(transferOwnershipRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdministrationAPI.TransferAdminUserOwnership(context.Background(), userId).TransferOwnershipRequest(transferOwnershipRequest).Execute()
	if err != nil {
...
> AdminGroup UpdateAdminGroup(ctx, groupId).UpdateAdminGroupRequest(updateAdminGroupRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdministrationAPI.UpdateAdminGroup(context.Background(), groupId).UpdateAdminGroupRequest(updateAdminGroupRequest).Execute()
	if err != nil {
...
> AdminUser UpdateAdminUser(ctx, userId).UpdateAdminUserRequest(updateAdminUserRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdministrationAPI.UpdateAdminUser(context.Background(), userId).UpdateAdminUserRequest(updateAdminUserRequest).Execute()
	if err != nil {
