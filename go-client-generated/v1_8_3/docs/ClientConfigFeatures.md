...
**TimmyEnabled** | Pointer to **bool** | Whether Timmy (AI chat) is enabled and fully configured on this server | [optional] 
...
`func (o *ClientConfigFeatures) GetTimmyEnabled() bool`

GetTimmyEnabled returns the TimmyEnabled field if non-nil, zero value otherwise.

### GetTimmyEnabledOk

`func (o *ClientConfigFeatures) GetTimmyEnabledOk() (*bool, bool)`
...
`func (o *ClientConfigFeatures) SetTimmyEnabled(v bool)`

SetTimmyEnabled sets TimmyEnabled field to given value.

### HasTimmyEnabled

`func (o *ClientConfigFeatures) HasTimmyEnabled() bool`
