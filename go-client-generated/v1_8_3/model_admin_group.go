...
type AdminGroup struct {
	...
	// OAuth/SAML provider identifier, or \"tmi\" for TMI built-in groups
	...
	// True only for server-seeded built-in groups; false for admin-created groups (which also use provider \"tmi\")
