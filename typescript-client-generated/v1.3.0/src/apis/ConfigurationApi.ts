...
import type { ClientConfig } from "../models/index";
import { ClientConfigFromJSON, ClientConfigToJSON } from "../models/index";
...
export interface ConfigurationApiInterface {
  ...
  ): Promise<runtime.ApiResponse<ClientConfig>>;
  ...
  implements ConfigurationApiInterface
{
  ...
  async getClientConfigRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ClientConfigFromJSON(jsonValue),
    );
  }
