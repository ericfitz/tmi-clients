 ...
 */
export function instanceOfUpdateAdminGroupRequest(
  value: object,
): value is UpdateAdminGroupRequest {
  return true;
}

export function UpdateAdminGroupRequestFromJSON(
  json: any,
): UpdateAdminGroupRequest {
  return UpdateAdminGroupRequestFromJSONTyped(json, false);
}

export function UpdateAdminGroupRequestFromJSONTyped(
  json: any,
...
export function UpdateAdminGroupRequestToJSON(
  json: any,
): UpdateAdminGroupRequest {
  return UpdateAdminGroupRequestToJSONTyped(json, false);
}

export function UpdateAdminGroupRequestToJSONTyped(
  value?: UpdateAdminGroupRequest | null,
