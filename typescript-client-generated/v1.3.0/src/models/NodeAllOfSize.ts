 ...
 * @export
 * @interface NodeAllOfSize
 */
export interface NodeAllOfSize {
    /**
     * Width in pixels
     * @type {number}
     * @memberof NodeAllOfSize
     */
    width: number;
    /**
     * Height in pixels
...
/**
 * Check if a given object implements the NodeAllOfSize interface.
 */
export function instanceOfNodeAllOfSize(value: object): value is NodeAllOfSize {
    if (!('width' in value) || value['width'] === undefined) return false;
    if (!('height' in value) || value['height'] === undefined) return false;
    return true;
}

export function NodeAllOfSizeFromJSON(json: any): NodeAllOfSize {
    return NodeAllOfSizeFromJSONTyped(json, false);
}

export function NodeAllOfSizeFromJSONTyped(json: any, ignoreDiscriminator: boolean): NodeAllOfSize {
    if (json == null) {
        return json;
    }
    return {
...
export function NodeAllOfSizeToJSON(json: any): NodeAllOfSize {
    return NodeAllOfSizeToJSONTyped(json, false);
}

export function NodeAllOfSizeToJSONTyped(value?: NodeAllOfSize | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
