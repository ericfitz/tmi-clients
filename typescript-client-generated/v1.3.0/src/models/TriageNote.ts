...
export function TriageNoteFromJSONTyped(json: any, ignoreDiscriminator: boolean): TriageNote {
    if (json == null) {
        return json;
    }
    return {
...
export function TriageNoteToJSONTyped(value?: Omit<TriageNote, 'id'|'created_at'|'created_by'|'modified_at'|'modified_by'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
