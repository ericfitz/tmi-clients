...
export function instanceOfRelationshipType(value: any): boolean {
  for (const key in RelationshipType) {
    if (Object.prototype.hasOwnProperty.call(RelationshipType, key)) {
      if (RelationshipType[key as keyof typeof RelationshipType] === value) {
        return true;
      }
    }
  }
...
export function RelationshipTypeFromJSONTyped(
  json: any,
...
export function RelationshipTypeToJSONTyped(
  value: any,
  ignoreDiscriminator: boolean,
): RelationshipType {
