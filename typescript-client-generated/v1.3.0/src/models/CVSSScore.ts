...
export function CVSSScoreFromJSONTyped(json: any, ignoreDiscriminator: boolean): CVSSScore {
    if (json == null) {
        return json;
    }
    return {
...
export function CVSSScoreToJSONTyped(value?: CVSSScore | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
