...
export type WebhookTestRequestEventTypeEnum =
  (typeof WebhookTestRequestEventTypeEnum)[keyof typeof WebhookTestRequestEventTypeEnum];

/**
 * Check if a given object implements the WebhookTestRequest interface.
 */
export function instanceOfWebhookTestRequest(
  value: object,
): value is WebhookTestRequest {
  return true;
}
...
export function WebhookTestRequestToJSONTyped(
