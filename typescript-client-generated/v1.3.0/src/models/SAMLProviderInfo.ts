 ...
 */
export function instanceOfSAMLProviderInfo(
  value: object,
): value is SAMLProviderInfo {
  if (!("id" in value) || value["id"] === undefined) return false;
  if (!("name" in value) || value["name"] === undefined) return false;
  if (!("icon" in value) || value["icon"] === undefined) return false;
  if (!("auth_url" in value) || value["auth_url"] === undefined) return false;
  if (!("metadata_url" in value) || value["metadata_url"] === undefined)
    return false;
...
export function SAMLProviderInfoFromJSONTyped(
  json: any,
...
export function SAMLProviderInfoToJSONTyped(
  value?: SAMLProviderInfo | null,
