...
export function instanceOfTMListItem(value: object): value is TMListItem {
  ...
  if (
    ...
    return false;
  if (!("document_count" in value) || value["document_count"] === undefined)
    return false;
  if (!("repo_count" in value) || value["repo_count"] === undefined)
    return false;
  if (!("diagram_count" in value) || value["diagram_count"] === undefined)
    return false;
  if (!("threat_count" in value) || value["threat_count"] === undefined)
    return false;
  if (!("asset_count" in value) || value["asset_count"] === undefined)
    return false;
  if (!("note_count" in value) || value["note_count"] === undefined)
    return false;
  return true;
}
...
export function TMListItemFromJSONTyped(
  json: any,
...
export function TMListItemToJSONTyped(
  value?: Omit<TMListItem, "id" | "status_updated" | "deleted_at"> | null,
