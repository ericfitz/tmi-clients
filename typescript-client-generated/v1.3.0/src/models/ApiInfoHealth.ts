...
export function ApiInfoHealthFromJSONTyped(
  json: any,
  ...
  return {
    database:
      json["database"] == null ?
        undefined
      : ComponentHealthFromJSON(json["database"]),
    redis:
      json["redis"] == null ?
        undefined
      : ComponentHealthFromJSON(json["redis"]),
  };
}
...
export function ApiInfoHealthToJSONTyped(
  value?: ApiInfoHealth | null,
