 ...
 */
export function instanceOfSurveyResponse(
  value: object,
): value is SurveyResponse {
...
export function SurveyResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    revision_notes:
      json["revision_notes"] == null ? undefined : json["revision_notes"],
    created_threat_model_id:
      json["created_threat_model_id"] == null ?
        undefined
      : json["created_threat_model_id"],
    ...
    submitted_at:
      json["submitted_at"] == null ? undefined : new Date(json["submitted_at"]),
    reviewed_at:
...
export function SurveyResponseToJSONTyped(
  value?: Omit<
    SurveyResponse,
    | "survey_version"
    | "id"
