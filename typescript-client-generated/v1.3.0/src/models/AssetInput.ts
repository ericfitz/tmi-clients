...
export type AssetInputTypeEnum = typeof AssetInputTypeEnum[keyof typeof AssetInputTypeEnum];
...
export function AssetInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetInput {
    if (json == null) {
        return json;
    }
    return {
...
export function AssetInputToJSONTyped(value?: AssetInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
