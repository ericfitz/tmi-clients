 ...
 */
export function instanceOfThreatModelInput(
  value: object,
): value is ThreatModelInput {
...
export function ThreatModelInputFromJSONTyped(
  json: any,
  ...
  return {
    ...
    threat_model_framework:
      json["threat_model_framework"] == null ?
        undefined
      : json["threat_model_framework"],
    authorization:
...
export function ThreatModelInputToJSONTyped(
  value?: ThreatModelInput | null,
