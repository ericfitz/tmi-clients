...
export type RepositoryBaseTypeEnum = typeof RepositoryBaseTypeEnum[keyof typeof RepositoryBaseTypeEnum];


/**
 * Check if a given object implements the RepositoryBase interface.
 */
export function instanceOfRepositoryBase(value: object): value is RepositoryBase {
...
export function RepositoryBaseToJSONTyped(value?: RepositoryBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
