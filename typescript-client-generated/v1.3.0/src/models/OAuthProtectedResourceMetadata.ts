...
export type OAuthProtectedResourceMetadataBearerMethodsSupportedEnum = typeof OAuthProtectedResourceMetadataBearerMethodsSupportedEnum[keyof typeof OAuthProtectedResourceMetadataBearerMethodsSupportedEnum];


/**
 * Check if a given object implements the OAuthProtectedResourceMetadata interface.
 */
export function instanceOfOAuthProtectedResourceMetadata(value: object): value is OAuthProtectedResourceMetadata {
    if (!('resource' in value) || value['resource'] === undefined) return false;
    return true;
}

export function OAuthProtectedResourceMetadataFromJSON(json: any): OAuthProtectedResourceMetadata {
    return OAuthProtectedResourceMetadataFromJSONTyped(json, false);
}

export function OAuthProtectedResourceMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): OAuthProtectedResourceMetadata {
    if (json == null) {
        return json;
    }
    return {
        ...
        'tls_client_certificate_bound_access_tokens': json['tls_client_certificate_bound_access_tokens'] == null ? undefined : json['tls_client_certificate_bound_access_tokens'],
    };
}

export function OAuthProtectedResourceMetadataToJSON(json: any): OAuthProtectedResourceMetadata {
    return OAuthProtectedResourceMetadataToJSONTyped(json, false);
}

export function OAuthProtectedResourceMetadataToJSONTyped(value?: OAuthProtectedResourceMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
