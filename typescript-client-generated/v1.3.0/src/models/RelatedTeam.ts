...
export function instanceOfRelatedTeam(value: object): value is RelatedTeam {
  if (!("related_team_id" in value) || value["related_team_id"] === undefined)
    return false;
...
export function RelatedTeamFromJSONTyped(
  json: any,
...
export function RelatedTeamToJSONTyped(
  value?: RelatedTeam | null,
