 ...
 */
export function instanceOfCreateAdminGroupRequest(
  value: object,
): value is CreateAdminGroupRequest {
...
export function CreateAdminGroupRequestFromJSON(
  json: any,
): CreateAdminGroupRequest {
  return CreateAdminGroupRequestFromJSONTyped(json, false);
}

export function CreateAdminGroupRequestFromJSONTyped(
  json: any,
...
export function CreateAdminGroupRequestToJSON(
  json: any,
): CreateAdminGroupRequest {
  return CreateAdminGroupRequestToJSONTyped(json, false);
}

export function CreateAdminGroupRequestToJSONTyped(
  value?: CreateAdminGroupRequest | null,
