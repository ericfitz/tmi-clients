 ...
 */
export function instanceOfUpdateAdminUserRequest(
  value: object,
): value is UpdateAdminUserRequest {
  return true;
}

export function UpdateAdminUserRequestFromJSON(
  json: any,
): UpdateAdminUserRequest {
  return UpdateAdminUserRequestFromJSONTyped(json, false);
}

export function UpdateAdminUserRequestFromJSONTyped(
  json: any,
...
export function UpdateAdminUserRequestToJSON(
  json: any,
): UpdateAdminUserRequest {
  return UpdateAdminUserRequestToJSONTyped(json, false);
}

export function UpdateAdminUserRequestToJSONTyped(
  value?: UpdateAdminUserRequest | null,
