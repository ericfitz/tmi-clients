...
export function ThreatBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ThreatBase {
    if (json == null) {
        return json;
    }
    return {
...
export function ThreatBaseToJSONTyped(value?: ThreatBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
