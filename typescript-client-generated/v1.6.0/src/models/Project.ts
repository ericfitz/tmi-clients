...
export interface Project {
    ...
    /**
     * Responsible parties for this project (resolved on read)
...
export function ProjectToJSONTyped(value?: Omit<Project, 'id'|'team'|'created_by'|'created_at'|'modified_by'|'modified_at'|'notes'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
