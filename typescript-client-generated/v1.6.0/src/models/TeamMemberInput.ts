...
/**
 * Check if a given object implements the TeamMemberInput interface.
 */
export function instanceOfTeamMemberInput(value: object): value is TeamMemberInput {
    if (!('user_id' in value) || value['user_id'] === undefined) return false;
    return true;
}

export function TeamMemberInputFromJSON(json: any): TeamMemberInput {
    return TeamMemberInputFromJSONTyped(json, false);
}

export function TeamMemberInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamMemberInput {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamMemberInputToJSON(json: any): TeamMemberInput {
    return TeamMemberInputToJSONTyped(json, false);
}

export function TeamMemberInputToJSONTyped(value?: TeamMemberInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
