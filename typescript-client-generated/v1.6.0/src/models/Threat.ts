...
export function ThreatFromJSONTyped(json: any, ignoreDiscriminator: boolean): Threat {
    ...
    return {
        ...
        'auto_generated': json['auto_generated'] == null ? undefined : json['auto_generated'],
...
export function ThreatToJSONTyped(value?: Omit<Threat, 'id'|'threat_model_id'|'created_at'|'modified_at'|'deleted_at'|'auto_generated'|'alias'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
