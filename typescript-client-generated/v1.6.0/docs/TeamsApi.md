...
async function example() {
  ...
  const body = {
    // TeamInput | Team creation data
    teamInput: {"name":"Platform Engineering","description":"Core platform infrastructure team"},
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **teamInput** | [TeamInput](TeamInput.md) | Team creation data | |
...
> Team patchTeam(teamId, jsonPatchDocumentInner, ifMatch)
...
> Team updateTeam(teamId, teamInput, ifMatch)
...
async function example() {
  ...
  const body = {
    // string | Team UUID
    teamId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // TeamInput | Complete team data for replacement
    teamInput: {"name":"Platform Engineering","description":"Core platform infrastructure team - updated"},
    // string | Optimistic-locking precondition. Pass the integer version returned by the previous read (or as the body \'version\' field on the previous write). On version mismatch the server returns 409 Conflict. In a future release this header will be required and missing values will return 428 Precondition Required. Accepts an integer version (bare or ETag-quoted) or \"*\" for an unconditional write (RFC 7232). (optional)
    ifMatch: ifMatch_example,
...
|------------- | ------------- | ------------- | -------------|
| **teamId** | `string` | Team UUID | [Defaults to `undefined`] |
| **teamInput** | [TeamInput](TeamInput.md) | Complete team data for replacement | |
| **ifMatch** | `string` | Optimistic-locking precondition. Pass the integer version returned by the previous read (or as the body \&#39;version\&#39; field on the previous write). On version mismatch the server returns 409 Conflict. In a future release this header will be required and missing values will return 428 Precondition Required. Accepts an integer version (bare or ETag-quoted) or \&quot;*\&quot; for an unconditional write (RFC 7232). | [Optional] [Defaults to `undefined`] |
