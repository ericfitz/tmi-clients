...
> ThreatModel createThreatModel(threatModelInput)
...
async function example() {
  ...
  const body = {
    // ThreatModelInput | Threat Model creation data
    threatModelInput: ...,
  } satisfies CreateThreatModelRequest;

  try {
    const data = await api.createThreatModel(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  } satisfies DeleteThreatModelRequest;

  try {
    const data = await api.deleteThreatModel(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  const body = {
    // string | Threat model identifier
    threatModelId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies GetThreatModelRequest;

  try {
    const data = await api.getThreatModel(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **429** | Too Many Requests - Rate limit exceeded. The client has sent too many requests in a given amount of time. See rate limit headers for details. |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix timestamp (seconds since epoch) when the rate limit window resets <br>  * Retry-After - Number of seconds to wait before retrying the request <br>  |
| **500** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **200** | Full threat model details |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  * ETag - Current optimistic-locking version of the resource (RFC 7232). Echo this value back via If-Match on the next PUT/PATCH. <br>  |
| **401** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **403** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **404** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
...
async function example() {
  ...
  const body = {
    ...
    offset: 56,
    // string | Filter by owner name or email (optional)
    owner: owner_example,
    ...
    // string | Filter by issue URI (partial match) (optional)
    issueUri: issueUri_example,
    ...
    // Date | Filter threat models where status was updated after this timestamp (RFC3339) (optional)
    statusUpdatedAfter: 2013-10-20T19:20:30+01:00,
    // Date | Filter threat models where status was updated before this timestamp (RFC3339) (optional)
  ...
  try {
    const data = await api.listThreatModels(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **owner** | `string` | Filter by owner name or email | [Optional] [Defaults to `undefined`] |
...
| **issueUri** | `string` | Filter by issue URI (partial match) | [Optional] [Defaults to `undefined`] |
...
> ThreatModel patchThreatModel(threatModelId, ifMatch, jsonPatchDocumentInner)
...
async function example() {
  ...
  const body = {
    ...
    // Array<JsonPatchDocumentInner> | JSON Patch operations to apply to the threat model (optional)
    jsonPatchDocumentInner: [{"op":"replace","path":"/name","value":"Updated Name"},{"op":"add","path":"/description","value":"New description"}],
  } satisfies PatchThreatModelRequest;

  try {
    const data = await api.patchThreatModel(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **jsonPatchDocumentInner** | `Array<JsonPatchDocumentInner>` | JSON Patch operations to apply to the threat model | [Optional] |
...
| **500** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **415** | Unsupported media type - the request Content-Type is not supported for this operation |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **200** | Threat model updated successfully |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  * ETag - Current optimistic-locking version of the resource (RFC 7232). Echo this value back via If-Match on the next PUT/PATCH. <br>  |
| **401** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **403** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **404** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
...
async function example() {
  ...
  const body = {
    // string | Threat model identifier
    threatModelId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies RestoreThreatModelRequest;

  try {
    const data = await api.restoreThreatModel(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> ThreatModel updateThreatModel(threatModelId, threatModelInput, ifMatch)
...
async function example() {
  ...
  const body = {
    // string | Threat model identifier
    threatModelId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // ThreatModelInput | Complete threat model data for replacement
    threatModelInput: ...,
    // string | Optimistic-locking precondition. Pass the integer version returned by the previous read (or as the body \'version\' field on the previous write). On version mismatch the server returns 409 Conflict. In a future release this header will be required and missing values will return 428 Precondition Required. Accepts an integer version (bare or ETag-quoted) or \"*\" for an unconditional write (RFC 7232). (optional)
    ifMatch: ifMatch_example,
  } satisfies UpdateThreatModelRequest;

  try {
    const data = await api.updateThreatModel(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
