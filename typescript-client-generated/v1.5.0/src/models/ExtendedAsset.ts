...
export type ExtendedAssetTypeEnum = typeof ExtendedAssetTypeEnum[keyof typeof ExtendedAssetTypeEnum];
...
export function ExtendedAssetFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtendedAsset {
    if (json == null) {
        return json;
    }
    return {
...
export function ExtendedAssetToJSONTyped(value?: Omit<ExtendedAsset, 'id'|'metadata'|'deleted_at'|'alias'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
