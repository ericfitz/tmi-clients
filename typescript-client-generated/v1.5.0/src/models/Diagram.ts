...
export function DiagramToJSONTyped(value?: Omit<Diagram, 'id'|'created_at'|'modified_at'|'update_vector'|'deleted_at'|'auto_generated'|'alias'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    return value;
}
