...
export function DocumentFromJSONTyped(json: any, ignoreDiscriminator: boolean): Document {
    ...
    return {
        ...
        'content_source': json['content_source'] == null ? undefined : json['content_source'],
        'access_diagnostics': json['access_diagnostics'] == null ? undefined : json['access_diagnostics'],
        'access_status_updated_at': json['access_status_updated_at'] == null ? undefined : (new Date(json['access_status_updated_at'])),
