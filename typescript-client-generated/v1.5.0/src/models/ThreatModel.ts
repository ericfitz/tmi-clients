...
export function ThreatModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): ThreatModel {
    ...
    return {
        ...
        'diagrams': json['diagrams'] == null ? undefined : ((json['diagrams'] as Array<any>).map(DiagramFromJSON)),
...
export function ThreatModelToJSONTyped(value?: Omit<ThreatModel, 'alias'|'id'|'created_at'|'modified_at'|'created_by'|'documents'|'repositories'|'diagrams'|'threats'|'notes'|'assets'|'status_updated'|'is_confidential'|'deleted_at'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
