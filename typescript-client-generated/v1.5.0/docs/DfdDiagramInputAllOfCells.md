...
```typescript
import type { DfdDiagramInputAllOfCells } from '@tmiclient/client'
...
const example = {
  ...
  "connector": null,
  "defaultLabel": null,
} satisfies DfdDiagramInputAllOfCells
...
const exampleParsed = JSON.parse(exampleJSON) as DfdDiagramInputAllOfCells
