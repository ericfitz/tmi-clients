...
```typescript
import type { ListThreatModelAuditTrailResponse } from '@tmiclient/client'
...
const example = {
  ...
  "next_cursor": null,
  "prev_cursor": null,
} satisfies ListThreatModelAuditTrailResponse
...
const exampleParsed = JSON.parse(exampleJSON) as ListThreatModelAuditTrailResponse
