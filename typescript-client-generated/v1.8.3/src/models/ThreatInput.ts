...
export function ThreatInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ThreatInput {
    if (json == null) {
        return json;
    }
    return {
...
export function ThreatInputToJSONTyped(value?: ThreatInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
