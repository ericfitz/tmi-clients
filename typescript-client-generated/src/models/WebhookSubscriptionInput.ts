 ...
 */
export function instanceOfWebhookSubscriptionInput(value: object): value is WebhookSubscriptionInput {
...
export function WebhookSubscriptionInputFromJSON(json: any): WebhookSubscriptionInput {
    return WebhookSubscriptionInputFromJSONTyped(json, false);
}

export function WebhookSubscriptionInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookSubscriptionInput {
    if (json == null) {
        return json;
    }
    return {
...
export function WebhookSubscriptionInputToJSON(json: any): WebhookSubscriptionInput {
    return WebhookSubscriptionInputToJSONTyped(json, false);
}

export function WebhookSubscriptionInputToJSONTyped(value?: WebhookSubscriptionInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
