...
export function ApiInfoApiFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiInfoApi {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiInfoApiToJSONTyped(value?: ApiInfoApi | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
