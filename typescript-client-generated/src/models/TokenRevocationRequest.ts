...
export type TokenRevocationRequestTokenTypeHintEnum = typeof TokenRevocationRequestTokenTypeHintEnum[keyof typeof TokenRevocationRequestTokenTypeHintEnum];


/**
 * Check if a given object implements the TokenRevocationRequest interface.
 */
export function instanceOfTokenRevocationRequest(value: object): value is TokenRevocationRequest {
    if (!('token' in value) || value['token'] === undefined) return false;
    return true;
}

export function TokenRevocationRequestFromJSON(json: any): TokenRevocationRequest {
    return TokenRevocationRequestFromJSONTyped(json, false);
}

export function TokenRevocationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TokenRevocationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function TokenRevocationRequestToJSON(json: any): TokenRevocationRequest {
    return TokenRevocationRequestToJSONTyped(json, false);
}

export function TokenRevocationRequestToJSONTyped(value?: TokenRevocationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
