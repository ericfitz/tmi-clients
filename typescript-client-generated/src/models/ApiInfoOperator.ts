 ...
 * 
 * @export
 * @interface ApiInfoOperator
 */
export interface ApiInfoOperator {
    /**
     * Operator name from environment variables
     * @type {string}
     * @memberof ApiInfoOperator
     */
    name: string;
    /**
...
/**
 * Check if a given object implements the ApiInfoOperator interface.
 */
export function instanceOfApiInfoOperator(value: object): value is ApiInfoOperator {
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('contact' in value) || value['contact'] === undefined) return false;
    return true;
}

export function ApiInfoOperatorFromJSON(json: any): ApiInfoOperator {
    return ApiInfoOperatorFromJSONTyped(json, false);
}

export function ApiInfoOperatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiInfoOperator {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiInfoOperatorToJSON(json: any): ApiInfoOperator {
    return ApiInfoOperatorToJSONTyped(json, false);
}

export function ApiInfoOperatorToJSONTyped(value?: ApiInfoOperator | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
