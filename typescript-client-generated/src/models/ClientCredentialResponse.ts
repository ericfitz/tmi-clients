 ...
 * @export
 * @interface ClientCredentialResponse
 */
export interface ClientCredentialResponse {
    /**
     * Unique identifier for the credential
     * @type {string}
     * @memberof ClientCredentialResponse
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the ClientCredentialResponse interface.
 */
export function instanceOfClientCredentialResponse(value: object): value is ClientCredentialResponse {
...
export function ClientCredentialResponseFromJSON(json: any): ClientCredentialResponse {
    return ClientCredentialResponseFromJSONTyped(json, false);
}

export function ClientCredentialResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientCredentialResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientCredentialResponseToJSON(json: any): ClientCredentialResponse {
    return ClientCredentialResponseToJSONTyped(json, false);
}

export function ClientCredentialResponseToJSONTyped(value?: ClientCredentialResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
