...
export function DocumentToJSONTyped(value?: Omit<Document, 'id'|'metadata'|'created_at'|'modified_at'|'deleted_at'|'access_status'|'content_source'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
