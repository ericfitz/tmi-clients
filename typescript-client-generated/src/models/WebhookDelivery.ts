...
export function WebhookDeliveryFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookDelivery {
    ...
    return {
        ...
        'last_activity_at': json['last_activity_at'] == null ? undefined : (new Date(json['last_activity_at'])),
        'addon_id': json['addon_id'] == null ? undefined : json['addon_id'],
        'invoked_by': json['invoked_by'] == null ? undefined : UserFromJSON(json['invoked_by']),
    };
}
