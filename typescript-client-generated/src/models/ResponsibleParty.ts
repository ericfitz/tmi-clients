 ...
 */
export function instanceOfResponsibleParty(value: object): value is ResponsibleParty {
...
export function ResponsiblePartyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponsibleParty {
    if (json == null) {
        return json;
    }
    return {
...
export function ResponsiblePartyToJSONTyped(value?: Omit<ResponsibleParty, 'user'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
