...
import { type DfdDiagramInput, DfdDiagramInputFromJSONTyped, DfdDiagramInputToJSON, DfdDiagramInputToJSONTyped } from './DfdDiagramInput';
/**
...
export type BaseDiagramInputTypeEnum = typeof BaseDiagramInputTypeEnum[keyof typeof BaseDiagramInputTypeEnum];
...
export function BaseDiagramInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseDiagramInput {
    if (json == null) {
        return json;
    }
...
export function BaseDiagramInputToJSONTyped(value?: BaseDiagramInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (!ignoreDiscriminator) {
        switch (value['type']) {
            case 'DFD-1.0.0':
                return DfdDiagramInputToJSONTyped(value as DfdDiagramInput, ignoreDiscriminator);
            default:
                return value;
        }
    }
