...
export type SystemSettingTypeEnum = typeof SystemSettingTypeEnum[keyof typeof SystemSettingTypeEnum];
...
export type SystemSettingSourceEnum = typeof SystemSettingSourceEnum[keyof typeof SystemSettingSourceEnum];
...
export function SystemSettingToJSONTyped(value?: Omit<SystemSetting, 'source'|'read_only'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
