 ...
 */
export function instanceOfDeletionChallenge(value: object): value is DeletionChallenge {
    if (!('challenge_text' in value) || value['challenge_text'] === undefined) return false;
...
export function DeletionChallengeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeletionChallenge {
    if (json == null) {
        return json;
    }
    return {
...
export function DeletionChallengeToJSONTyped(value?: DeletionChallenge | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
