...
/**
 * Check if a given object implements the SurveyInput interface.
 */
export function instanceOfSurveyInput(value: object): value is SurveyInput {
...
export function SurveyInputFromJSON(json: any): SurveyInput {
    return SurveyInputFromJSONTyped(json, false);
}

export function SurveyInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): SurveyInput {
    if (json == null) {
        return json;
    }
    return {
...
export function SurveyInputToJSON(json: any): SurveyInput {
    return SurveyInputToJSONTyped(json, false);
}

export function SurveyInputToJSONTyped(value?: SurveyInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
