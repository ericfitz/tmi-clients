...
export function DocumentBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentBase {
    if (json == null) {
        return json;
    }
    return {
...
export function DocumentBaseToJSONTyped(value?: DocumentBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
