 ...
 */
export function instanceOfProjectNoteListItem(value: object): value is ProjectNoteListItem {
...
export function ProjectNoteListItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectNoteListItem {
    if (json == null) {
        return json;
    }
    return {
...
export function ProjectNoteListItemToJSONTyped(value?: Omit<ProjectNoteListItem, 'id'|'created_at'|'modified_at'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
