...
export function EdgeAttrsLineFromJSONTyped(json: any, ignoreDiscriminator: boolean): EdgeAttrsLine {
    if (json == null) {
        return json;
    }
    return {
...
export function EdgeAttrsLineToJSONTyped(value?: EdgeAttrsLine | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
