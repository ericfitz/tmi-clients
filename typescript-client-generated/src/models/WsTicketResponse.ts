 ...
 */
export function instanceOfWsTicketResponse(value: object): value is WsTicketResponse {
...
export function WsTicketResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WsTicketResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function WsTicketResponseToJSONTyped(value?: WsTicketResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
