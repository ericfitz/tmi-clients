 ...
 * @export
 * @interface RepositoryBaseParameters
 */
export interface RepositoryBaseParameters {
    /**
     * Reference type (branch, tag, or commit)
     * @type {RepositoryBaseParametersRefTypeEnum}
     * @memberof RepositoryBaseParameters
     */
    refType: RepositoryBaseParametersRefTypeEnum;
    /**
 ...
 * @export
 */
export const RepositoryBaseParametersRefTypeEnum = {
    Branch: 'branch',
    Tag: 'tag',
    Commit: 'commit'
} as const;
export type RepositoryBaseParametersRefTypeEnum = typeof RepositoryBaseParametersRefTypeEnum[keyof typeof RepositoryBaseParametersRefTypeEnum];


/**
 * Check if a given object implements the RepositoryBaseParameters interface.
 */
...
export function RepositoryBaseParametersFromJSON(json: any): RepositoryBaseParameters {
    return RepositoryBaseParametersFromJSONTyped(json, false);
}

export function RepositoryBaseParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): RepositoryBaseParameters {
    if (json == null) {
        return json;
    }
    return {
...
export function RepositoryBaseParametersToJSON(json: any): RepositoryBaseParameters {
    return RepositoryBaseParametersToJSONTyped(json, false);
}

export function RepositoryBaseParametersToJSONTyped(value?: RepositoryBaseParameters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
