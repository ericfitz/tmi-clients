...
export function AdminGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdminGroup {
    ...
    return {
        ...
        'is_builtin': json['is_builtin'] == null ? undefined : json['is_builtin'],
    };
}
...
export function AdminGroupToJSONTyped(value?: Omit<AdminGroup, 'used_in_authorizations'|'used_in_admin_grants'|'member_count'|'is_builtin'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
