...
import type { SSVCScore } from './SSVCScore';
import {
    SSVCScoreFromJSON,
    SSVCScoreFromJSONTyped,
    SSVCScoreToJSON,
    SSVCScoreToJSONTyped,
} from './SSVCScore';
 ...
 */
export function instanceOfThreatBulkUpdateItem(value: object): value is ThreatBulkUpdateItem {
...
export function ThreatBulkUpdateItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): ThreatBulkUpdateItem {
    if (json == null) {
        return json;
    }
    return {
        ...
        'mitigation': json['mitigation'] === undefined ? undefined : json['mitigation'] === null ? null : json['mitigation'],
        'diagram_id': json['diagram_id'] === undefined ? undefined : json['diagram_id'] === null ? null : json['diagram_id'],
        'cell_id': json['cell_id'] === undefined ? undefined : json['cell_id'] === null ? null : json['cell_id'],
        ...
        'asset_id': json['asset_id'] === undefined ? undefined : json['asset_id'] === null ? null : json['asset_id'],
        ...
        'ssvc': json['ssvc'] === undefined ? undefined : json['ssvc'] === null ? null : SSVCScoreFromJSON(json['ssvc']),
        'id': json['id'],
    };
}
...
export function ThreatBulkUpdateItemToJSONTyped(value?: ThreatBulkUpdateItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'ssvc': SSVCScoreToJSON(value['ssvc']),
        'id': value['id'],
    };
}
