...
export interface Document {
     ...
     * @type {DocumentAccessStatusEnum}
     * @memberof Document
     */
    readonly access_status?: DocumentAccessStatusEnum;
    /**
     ...
     * @memberof Document
     */
    readonly access_diagnostics?: object | null;
    /**
     * Timestamp of the last access_status transition (RFC3339)
     * @type {Date}
     * @memberof Document
     */
    readonly access_status_updated_at?: Date | null;
    /**
 ...
 * @export
 */
export const DocumentAccessStatusEnum = {
...
export type DocumentAccessStatusEnum = typeof DocumentAccessStatusEnum[keyof typeof DocumentAccessStatusEnum];
...
export function DocumentFromJSONTyped(json: any, ignoreDiscriminator: boolean): Document {
    ...
    return {
        ...
        'access_status': json['access_status'] == null ? undefined : json['access_status'],
        'content_source': json['content_source'] === undefined ? undefined : json['content_source'] === null ? null : json['content_source'],
        'access_diagnostics': json['access_diagnostics'] === undefined ? undefined : json['access_diagnostics'] === null ? null : json['access_diagnostics'],
        'access_status_updated_at': json['access_status_updated_at'] === undefined ? undefined : json['access_status_updated_at'] === null ? null : (new Date(json['access_status_updated_at'])),
...
export function DocumentToJSONTyped(value?: Omit<Document, 'id'|'metadata'|'created_at'|'modified_at'|'deleted_at'|'access_status'|'content_source'|'access_diagnostics'|'access_status_updated_at'|'alias'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
