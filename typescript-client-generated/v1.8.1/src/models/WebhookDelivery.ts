...
export function WebhookDeliveryFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookDelivery {
    ...
    return {
        ...
        'last_activity_at': json['last_activity_at'] === undefined ? undefined : json['last_activity_at'] === null ? null : (new Date(json['last_activity_at'])),
        'addon_id': json['addon_id'] === undefined ? undefined : json['addon_id'] === null ? null : json['addon_id'],
        'invoked_by': json['invoked_by'] === undefined ? undefined : json['invoked_by'] === null ? null : UserFromJSON(json['invoked_by']),
    };
}
...
export function WebhookDeliveryToJSONTyped(value?: WebhookDelivery | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'next_retry_at': value['next_retry_at'] == null ? value['next_retry_at'] : value['next_retry_at'].toISOString(),
        ...
        'last_activity_at': value['last_activity_at'] == null ? value['last_activity_at'] : value['last_activity_at'].toISOString(),
