...
export interface Team {
     ...
     * @memberof Team
     */
    readonly notes?: Array<TeamNoteListItem>;
    /**
    ...
    /**
     * List of team members with their roles (resolved on read)
     * @type {Array<TeamMember>}
     * @memberof Team
     */
    members?: Array<TeamMember>;
    /**
     * Responsible parties for this team (in lieu of owner) (resolved on read)
...
export function TeamFromJSONTyped(json: any, ignoreDiscriminator: boolean): Team {
    ...
    return {
        ...
        'notes': json['notes'] == null ? undefined : ((json['notes'] as Array<any>).map(TeamNoteListItemFromJSON)),
...
export function TeamToJSONTyped(value?: Omit<Team, 'id'|'created_by'|'created_at'|'modified_by'|'modified_at'|'notes'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
