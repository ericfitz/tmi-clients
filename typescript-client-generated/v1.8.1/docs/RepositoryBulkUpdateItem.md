...
```typescript
import type { RepositoryBulkUpdateItem } from '@tmiclient/client'
...
const example = {
  ...
  "timmy_enabled": null,
  "id": null,
} satisfies RepositoryBulkUpdateItem
...
const exampleParsed = JSON.parse(exampleJSON) as RepositoryBulkUpdateItem
