...
> SurveyResponse patchIntakeSurveyResponse(surveyResponseId, jsonPatchDocumentInner, ifMatch)
...
> SurveyResponse updateIntakeSurveyResponse(surveyResponseId, surveyResponseInput, ifMatch)
