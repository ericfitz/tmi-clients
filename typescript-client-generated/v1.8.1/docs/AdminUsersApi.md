...
> adminDeleteUserContentToken(userId, providerId)
...
|------------- | ------------- | ------------- | -------------|
| **userId** | `string` | Internal system UUID of the user | [Defaults to `undefined`] |
...
> adminDeleteUserIdentity(userId, identityId)
...
async function example() {
  ...
  const body = {
    // string | Internal system UUID of the user
    userId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // string | Linked identity unique identifier
    identityId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies AdminDeleteUserIdentityRequest;

  try {
    const data = await api.adminDeleteUserIdentity(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **userId** | `string` | Internal system UUID of the user | [Defaults to `undefined`] |
| **identityId** | `string` | Linked identity unique identifier | [Defaults to `undefined`] |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **204** | Linked identity unlinked. |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **400** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **401** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **403** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **404** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
...
> ContentTokenList adminListUserContentTokens(userId)
...
> AdminUserIdentitiesResponse adminListUserIdentities(userId)
...
async function example() {
  ...
  const body = {
    // string | Internal system UUID of the user
    userId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies AdminListUserIdentitiesRequest;

  try {
    const data = await api.adminListUserIdentities(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | The target user\&#39;s primary and linked sign-in identities. |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **400** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **401** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **403** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **404** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
...
> ClientCredentialResponse createAdminUserClientCredential(userId, createCurrentUserClientCredentialRequest)
...
import type { CreateAdminUserClientCredentialRequest } from '@tmiclient/client';
...
async function example() {
  ...
  const body = {
    // string | Internal system UUID of the user
    userId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // CreateCurrentUserClientCredentialRequest | Client credential creation parameters
    createCurrentUserClientCredentialRequest: ...,
  } satisfies CreateAdminUserClientCredentialRequest;

  try {
    const data = await api.createAdminUserClientCredential(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> CreateAutomationAccountResponse createAutomationAccount(createAutomationAccountRequest)
...
async function example() {
  ...
  const body = {
    // CreateAutomationAccountRequest | Automation account creation parameters
    createAutomationAccountRequest: ...,
  } satisfies CreateAutomationAccountOperationRequest;

  try {
    const data = await api.createAutomationAccount(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> deleteAdminUserClientCredential(userId, credentialId)
...
async function example() {
  ...
  } satisfies DeleteAdminUserClientCredentialRequest;

  try {
    const data = await api.deleteAdminUserClientCredential(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> ListClientCredentialsResponse listAdminUserClientCredentials(userId, limit, offset)
...
async function example() {
  ...
  const body = {
    ...
    offset: 56,
  } satisfies ListAdminUserClientCredentialsRequest;

  try {
    const data = await api.listAdminUserClientCredentials(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
