...
|------------- | ------------- | -------------|
| [**createAddon**](AddonsApi.md#createaddonoperation) | **POST** /addons | Create add-on |
...
| [**invokeAddon**](AddonsApi.md#invokeaddonoperation) | **POST** /addons/{id}/invoke | Invoke add-on |
...
| [**updateInvocationStatus**](AddonsApi.md#updateinvocationstatusoperation) | **POST** /invocations/{id}/status | Update invocation status |



## createAddon

> AddonResponse createAddon(createAddonRequest)
...
async function example() {
  ...
  } satisfies DeleteAddonRequest;

  try {
    const data = await api.deleteAddon(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  const body = {
    // string | Resource identifier
    id: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies GetAddonRequest;

  try {
    const data = await api.getAddon(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetInvocationRequest } from '@tmiclient/client';
...
async function example() {
  ...
  const body = {
    // string | Resource identifier
    id: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies GetInvocationRequest;

  try {
    const data = await api.getInvocation(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> InvokeAddonResponse invokeAddon(id, invokeAddonRequest)
...
async function example() {
  ...
  const body = {
    // string | Resource identifier
    id: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // InvokeAddonRequest | Addon invocation parameters
    invokeAddonRequest: ...,
  } satisfies InvokeAddonOperationRequest;

  try {
    const data = await api.invokeAddon(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **401** | Unauthorized - authentication required |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **404** | Add-on not found |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
| **429** | Rate limit exceeded (quota: 1 active invocation or 10 per hour) |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  * Retry-After - Seconds until rate limit resets <br>  |
| **500** | Internal server error |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
...
> ListAddonsResponse listAddons(limit, offset, threatModelId)
...
async function example() {
  ...
  } satisfies ListAddonsRequest;

  try {
    const data = await api.listAddons(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> ListInvocationsResponse listInvocations(limit, offset, status, addonId)
...
import type { ListInvocationsRequest } from '@tmiclient/client';
...
async function example() {
  ...
  const body = {
    ...
    // string | Filter by add-on (optional)
    addonId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies ListInvocationsRequest;

  try {
    const data = await api.listInvocations(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **addonId** | `string` | Filter by add-on | [Optional] [Defaults to `undefined`] |
...
> UpdateInvocationStatusResponse updateInvocationStatus(id, xWebhookSignature, updateInvocationStatusRequest)
...
import type { UpdateInvocationStatusOperationRequest } from '@tmiclient/client';
...
async function example() {
  ...
  const body = {
    ...
    // UpdateInvocationStatusRequest | Invocation status update
    updateInvocationStatusRequest: ...,
  } satisfies UpdateInvocationStatusOperationRequest;

  try {
    const data = await api.updateInvocationStatus(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
