...
async function example() {
  ...
  const body = {
    ...
    // number | Number of results to skip (optional)
    offset: 56,
    // 'created_at' | 'last_login' | 'email' | Field to sort by (optional)
...
| **limit** | `number` | Maximum number of results to return | [Optional] [Defaults to `50`] |
| **offset** | `number` | Number of results to skip | [Optional] [Defaults to `0`] |
| **sortBy** | `created_at`, `last_login`, `email` | Field to sort by | [Optional] [Defaults to `&#39;created_at&#39;`] [Enum: created_at, last_login, email] |
...
> AdminUserListResponse listAdminUsers(provider, email, createdAfter, createdBefore, lastLoginAfter, lastLoginBefore, limit, offset, sortBy, sortOrder)
