...
export function ThreatModelToJSONTyped(value?: Omit<ThreatModel, 'id'|'created_at'|'modified_at'|'created_by'|'documents'|'repositories'|'diagrams'|'threats'|'notes'|'assets'|'status_updated'|'is_confidential'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
