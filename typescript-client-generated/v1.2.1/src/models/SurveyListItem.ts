 ...
 */
export function instanceOfSurveyListItem(
  value: object,
): value is SurveyListItem {
...
export function SurveyListItemFromJSONTyped(
  json: any,
...
export function SurveyListItemToJSONTyped(
  value?: Omit<SurveyListItem, "id"> | null,
