 ...
 */
export function instanceOfCollaborationSession(
  value: object,
  ...
  if (!("threat_model_id" in value) || value["threat_model_id"] === undefined)
    return false;
  if (
    !("threat_model_name" in value) ||
    value["threat_model_name"] === undefined
  )
    return false;
  if (!("diagram_id" in value) || value["diagram_id"] === undefined)
    return false;
  if (!("diagram_name" in value) || value["diagram_name"] === undefined)
    return false;
  if (!("participants" in value) || value["participants"] === undefined)
    return false;
  if (!("websocket_url" in value) || value["websocket_url"] === undefined)
    return false;
  return true;
}
...
export function CollaborationSessionFromJSONTyped(
  json: any,
  ...
  return {
    ...
    presenter:
      json["presenter"] == null ? undefined : UserFromJSON(json["presenter"]),
...
export function CollaborationSessionToJSONTyped(
  value?: Omit<
    CollaborationSession,
    "session_id" | "host" | "presenter"
  > | null,
