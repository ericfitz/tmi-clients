 ...
 */
export function instanceOfGetOpenIDConfiguration200Response(
  value: object,
): value is GetOpenIDConfiguration200Response {
  if (!("issuer" in value) || value["issuer"] === undefined) return false;
  if (
    !("authorization_endpoint" in value) ||
    value["authorization_endpoint"] === undefined
  )
    return false;
  if (!("token_endpoint" in value) || value["token_endpoint"] === undefined)
    return false;
  if (!("jwks_uri" in value) || value["jwks_uri"] === undefined) return false;
  if (
    !("response_types_supported" in value) ||
    value["response_types_supported"] === undefined
  )
    return false;
  if (
    !("subject_types_supported" in value) ||
    value["subject_types_supported"] === undefined
  )
    return false;
  if (
    !("id_token_signing_alg_values_supported" in value) ||
    value["id_token_signing_alg_values_supported"] === undefined
  )
    return false;
  return true;
}

export function GetOpenIDConfiguration200ResponseFromJSON(
  json: any,
): GetOpenIDConfiguration200Response {
  return GetOpenIDConfiguration200ResponseFromJSONTyped(json, false);
}

export function GetOpenIDConfiguration200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    claims_supported:
      json["claims_supported"] == null ? undefined : json["claims_supported"],
...
export function GetOpenIDConfiguration200ResponseToJSON(
  json: any,
): GetOpenIDConfiguration200Response {
  return GetOpenIDConfiguration200ResponseToJSONTyped(json, false);
}

export function GetOpenIDConfiguration200ResponseToJSONTyped(
  value?: GetOpenIDConfiguration200Response | null,
