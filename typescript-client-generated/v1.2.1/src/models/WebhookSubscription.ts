...
export type WebhookSubscriptionStatusEnum = typeof WebhookSubscriptionStatusEnum[keyof typeof WebhookSubscriptionStatusEnum];
...
export function WebhookSubscriptionToJSONTyped(value?: WebhookSubscription | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'last_successful_use': value['last_successful_use'] == null ? value['last_successful_use'] : value['last_successful_use'].toISOString(),
