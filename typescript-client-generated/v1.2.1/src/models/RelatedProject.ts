...
export function RelatedProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelatedProject {
    if (json == null) {
        return json;
    }
    return {
...
export function RelatedProjectToJSONTyped(value?: RelatedProject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
