...
export function NoteInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): NoteInput {
    if (json == null) {
        return json;
    }
    return {
...
export function NoteInputToJSONTyped(value?: NoteInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
