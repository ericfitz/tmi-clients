 ...
 * @export
 * @interface BaseDiagramImage
 */
export interface BaseDiagramImage {
    /**
     * BASE64 encoded SVG representation of the diagram, used for thumbnails and reports
     * @type {string}
     * @memberof BaseDiagramImage
     */
    svg?: string;
    /**
...
/**
 * Check if a given object implements the BaseDiagramImage interface.
 */
export function instanceOfBaseDiagramImage(value: object): value is BaseDiagramImage {
    return true;
}

export function BaseDiagramImageFromJSON(json: any): BaseDiagramImage {
    return BaseDiagramImageFromJSONTyped(json, false);
}

export function BaseDiagramImageFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseDiagramImage {
    if (json == null) {
        return json;
    }
    return {
...
export function BaseDiagramImageToJSON(json: any): BaseDiagramImage {
    return BaseDiagramImageToJSONTyped(json, false);
}

export function BaseDiagramImageToJSONTyped(value?: BaseDiagramImage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
