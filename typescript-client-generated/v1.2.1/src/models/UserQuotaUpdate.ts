...
/**
 * Check if a given object implements the UserQuotaUpdate interface.
 */
export function instanceOfUserQuotaUpdate(value: object): value is UserQuotaUpdate {
    if (!('max_requests_per_minute' in value) || value['max_requests_per_minute'] === undefined) return false;
    return true;
}

export function UserQuotaUpdateFromJSON(json: any): UserQuotaUpdate {
    return UserQuotaUpdateFromJSONTyped(json, false);
}

export function UserQuotaUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserQuotaUpdate {
    if (json == null) {
        return json;
    }
    return {
...
export function UserQuotaUpdateToJSON(json: any): UserQuotaUpdate {
    return UserQuotaUpdateToJSONTyped(json, false);
}

export function UserQuotaUpdateToJSONTyped(value?: UserQuotaUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
