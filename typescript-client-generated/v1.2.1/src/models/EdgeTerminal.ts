...
export function EdgeTerminalFromJSONTyped(json: any, ignoreDiscriminator: boolean): EdgeTerminal {
    if (json == null) {
        return json;
    }
    return {
...
export function EdgeTerminalToJSONTyped(value?: EdgeTerminal | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
