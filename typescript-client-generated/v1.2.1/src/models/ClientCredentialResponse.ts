 ...
 */
export function instanceOfClientCredentialResponse(
  value: object,
): value is ClientCredentialResponse {
...
export function ClientCredentialResponseFromJSON(
  json: any,
): ClientCredentialResponse {
  return ClientCredentialResponseFromJSONTyped(json, false);
}

export function ClientCredentialResponseFromJSONTyped(
  json: any,
...
export function ClientCredentialResponseToJSON(
  json: any,
): ClientCredentialResponse {
  return ClientCredentialResponseToJSONTyped(json, false);
}

export function ClientCredentialResponseToJSONTyped(
  value?: ClientCredentialResponse | null,
