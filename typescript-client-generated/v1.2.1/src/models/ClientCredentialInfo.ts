 ...
 */
export function instanceOfClientCredentialInfo(value: object): value is ClientCredentialInfo {
...
export function ClientCredentialInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientCredentialInfo {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientCredentialInfoToJSONTyped(value?: ClientCredentialInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
