...
export interface UserAccountApiInterface {
   ...
   */
  createCurrentUserPreferencesRequestOpts(
    requestParameters: CreateCurrentUserPreferencesRequest,
   ...
   * @memberof UserAccountApiInterface
   */
  createCurrentUserPreferencesRaw(
    requestParameters: CreateCurrentUserPreferencesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: { [key: string]: any } }>>;
   ...
   * @memberof UserAccountApiInterface
   */
  updateCurrentUserPreferencesRequestOpts(
    requestParameters: UpdateCurrentUserPreferencesRequest,
  ): Promise<runtime.RequestOpts>;
   ...
   * @memberof UserAccountApiInterface
   */
  updateCurrentUserPreferencesRaw(
    requestParameters: UpdateCurrentUserPreferencesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: { [key: string]: any } }>>;
...
export class UserAccountApi
  ...
  implements UserAccountApiInterface
{
  /**
   * Creates request options for createCurrentUserPreferences without sending the request
   */
  async createCurrentUserPreferencesRequestOpts(
    requestParameters: CreateCurrentUserPreferencesRequest,
  ): Promise<runtime.RequestOpts> {
   ...
   * Create user preferences
   */
  async createCurrentUserPreferencesRaw(
    requestParameters: CreateCurrentUserPreferencesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: { [key: string]: any } }>> {
    const requestOptions =
      await this.createCurrentUserPreferencesRequestOpts(requestParameters);
   ...
   * Create user preferences
   */
  async createCurrentUserPreferences(
    requestParameters: CreateCurrentUserPreferencesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<{ [key: string]: { [key: string]: any } }> {
    const response = await this.createCurrentUserPreferencesRaw(
      requestParameters,
      initOverrides,
    );
   ...
   * Get user preferences
   */
  async getCurrentUserPreferencesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: { [key: string]: any } }>> {
   ...
   * Creates request options for updateCurrentUserPreferences without sending the request
   */
  async updateCurrentUserPreferencesRequestOpts(
    requestParameters: UpdateCurrentUserPreferencesRequest,
  ): Promise<runtime.RequestOpts> {
    if (requestParameters["requestBody"] == null) {
      throw new runtime.RequiredError(
   ...
   * Update user preferences
   */
  async updateCurrentUserPreferencesRaw(
    requestParameters: UpdateCurrentUserPreferencesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: { [key: string]: any } }>> {
    const requestOptions =
      await this.updateCurrentUserPreferencesRequestOpts(requestParameters);
    const response = await this.request(requestOptions, initOverrides);
  ...
  async updateCurrentUserPreferences(
    ...
    const response = await this.updateCurrentUserPreferencesRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
