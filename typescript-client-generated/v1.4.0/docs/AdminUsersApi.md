...
> ClientCredentialResponse createAdminUserClientCredential(internalUuid, createCurrentUserClientCredentialRequest)
...
> ListClientCredentialsResponse listAdminUserClientCredentials(internalUuid, limit, offset)
