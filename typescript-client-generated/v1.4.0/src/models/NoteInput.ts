...
/**
 * Check if a given object implements the NoteInput interface.
 */
export function instanceOfNoteInput(value: object): value is NoteInput {
  if (!("name" in value) || value["name"] === undefined) return false;
  if (!("content" in value) || value["content"] === undefined) return false;
  return true;
}

export function NoteInputFromJSON(json: any): NoteInput {
  return NoteInputFromJSONTyped(json, false);
}

export function NoteInputFromJSONTyped(
  json: any,
...
export function NoteInputToJSON(json: any): NoteInput {
  return NoteInputToJSONTyped(json, false);
}

export function NoteInputToJSONTyped(
  value?: NoteInput | null,
