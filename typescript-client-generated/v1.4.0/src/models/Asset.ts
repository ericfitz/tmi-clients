...
export function AssetToJSONTyped(value?: Omit<Asset, 'id'|'metadata'|'created_at'|'modified_at'|'deleted_at'|'alias'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
