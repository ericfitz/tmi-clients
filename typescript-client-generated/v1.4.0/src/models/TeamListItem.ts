...
export function TeamListItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamListItem {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamListItemToJSONTyped(value?: TeamListItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
