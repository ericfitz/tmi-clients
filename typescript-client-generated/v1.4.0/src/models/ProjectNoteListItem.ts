...
/**
 * Check if a given object implements the ProjectNoteListItem interface.
 */
export function instanceOfProjectNoteListItem(
  value: object,
): value is ProjectNoteListItem {
  if (!("id" in value) || value["id"] === undefined) return false;
  if (!("name" in value) || value["name"] === undefined) return false;
  return true;
}

export function ProjectNoteListItemFromJSON(json: any): ProjectNoteListItem {
  return ProjectNoteListItemFromJSONTyped(json, false);
}

export function ProjectNoteListItemFromJSONTyped(
  json: any,
...
export function ProjectNoteListItemToJSON(json: any): ProjectNoteListItem {
  return ProjectNoteListItemToJSONTyped(json, false);
}

export function ProjectNoteListItemToJSONTyped(
  value?: Omit<ProjectNoteListItem, "id" | "created_at" | "modified_at"> | null,
