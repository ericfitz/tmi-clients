...
export function TeamFromJSONTyped(
  ...
  return {
    ...
    members:
      json["members"] == null ?
        undefined
      : (json["members"] as Array<any>).map(TeamMemberFromJSON),
    responsible_parties:
    ...
    related_teams:
      json["related_teams"] == null ?
        undefined
      : (json["related_teams"] as Array<any>).map(RelatedTeamFromJSON),
    uri: json["uri"] == null ? undefined : json["uri"],
    email_address:
      json["email_address"] == null ? undefined : json["email_address"],
    status:
      json["status"] == null ? undefined : TeamStatusFromJSON(json["status"]),
    ...
    notes:
      json["notes"] == null ?
        undefined
      : (json["notes"] as Array<any>).map(TeamNoteListItemFromJSON),
  };
}
...
export function TeamToJSONTyped(
  value?: Omit<
    Team,
    "id" | "created_by" | "created_at" | "modified_by" | "modified_at" | "notes"
  > | null,
  ...
  return {
    ...
    members:
      value["members"] == null ?
        undefined
      : (value["members"] as Array<any>).map(TeamMemberToJSON),
    responsible_parties:
    ...
    related_teams:
      value["related_teams"] == null ?
        undefined
      : (value["related_teams"] as Array<any>).map(RelatedTeamToJSON),
    uri: value["uri"],
