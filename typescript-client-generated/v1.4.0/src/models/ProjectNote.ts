...
export function ProjectNoteFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectNote {
    if (json == null) {
        return json;
    }
    return {
...
export function ProjectNoteToJSONTyped(value?: Omit<ProjectNote, 'id'|'created_at'|'modified_at'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
