...
/**
 * Check if a given object implements the ProjectNote interface.
 */
export function instanceOfProjectNote(value: object): value is ProjectNote {
...
export function ProjectNoteFromJSON(json: any): ProjectNote {
  return ProjectNoteFromJSONTyped(json, false);
}

export function ProjectNoteFromJSONTyped(
  json: any,
...
export function ProjectNoteToJSON(json: any): ProjectNote {
  return ProjectNoteToJSONTyped(json, false);
}

export function ProjectNoteToJSONTyped(
  value?: Omit<ProjectNote, "id" | "created_at" | "modified_at"> | null,
