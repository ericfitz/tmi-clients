 ...
 */
export function instanceOfTriageNoteBase(value: object): value is TriageNoteBase {
...
export function TriageNoteBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TriageNoteBase {
    if (json == null) {
        return json;
    }
    return {
...
export function TriageNoteBaseToJSONTyped(value?: TriageNoteBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
