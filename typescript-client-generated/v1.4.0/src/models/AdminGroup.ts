...
export function instanceOfAdminGroup(value: object): value is AdminGroup {
  ...
  if (!("group_name" in value) || value["group_name"] === undefined)
    return false;
  if (!("first_used" in value) || value["first_used"] === undefined)
    return false;
  if (!("last_used" in value) || value["last_used"] === undefined) return false;
  if (!("usage_count" in value) || value["usage_count"] === undefined)
    return false;
  return true;
}
...
export function AdminGroupFromJSONTyped(
  json: any,
  ...
  return {
    ...
    used_in_authorizations:
      json["used_in_authorizations"] == null ?
        undefined
      : json["used_in_authorizations"],
    used_in_admin_grants:
      json["used_in_admin_grants"] == null ?
        undefined
      : json["used_in_admin_grants"],
    member_count:
...
export function AdminGroupToJSONTyped(
  value?: Omit<
    AdminGroup,
    "used_in_authorizations" | "used_in_admin_grants" | "member_count"
  > | null,
