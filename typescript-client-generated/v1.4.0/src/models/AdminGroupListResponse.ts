 ...
 */
export function instanceOfAdminGroupListResponse(
  value: object,
): value is AdminGroupListResponse {
...
export function AdminGroupListResponseFromJSON(
  json: any,
): AdminGroupListResponse {
  return AdminGroupListResponseFromJSONTyped(json, false);
}

export function AdminGroupListResponseFromJSONTyped(
  json: any,
...
export function AdminGroupListResponseToJSON(
  json: any,
): AdminGroupListResponse {
  return AdminGroupListResponseToJSONTyped(json, false);
}

export function AdminGroupListResponseToJSONTyped(
  value?: AdminGroupListResponse | null,
