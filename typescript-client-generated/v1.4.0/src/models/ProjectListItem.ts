 ...
 */
export function instanceOfProjectListItem(
  value: object,
): value is ProjectListItem {
...
export function ProjectListItemFromJSONTyped(
  json: any,
...
export function ProjectListItemToJSONTyped(
  value?: ProjectListItem | null,
