 ...
 * @export
 */
export type DfdDiagramInputAllOfCells =
  | ({ shape: "actor" } & Node)
  | ({ shape: "flow" } & Edge)
  | ({ shape: "process" } & Node)
...
export function DfdDiagramInputAllOfCellsFromJSON(
  json: any,
): DfdDiagramInputAllOfCells {
  return DfdDiagramInputAllOfCellsFromJSONTyped(json, false);
}

export function DfdDiagramInputAllOfCellsFromJSONTyped(
  json: any,
...
export function DfdDiagramInputAllOfCellsToJSONTyped(
  value?: DfdDiagramInputAllOfCells | null,
