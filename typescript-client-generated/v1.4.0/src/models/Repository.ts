...
export function RepositoryToJSONTyped(value?: Omit<Repository, 'id'|'metadata'|'created_at'|'modified_at'|'deleted_at'|'alias'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
