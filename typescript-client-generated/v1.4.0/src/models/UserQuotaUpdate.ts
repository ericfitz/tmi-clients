 ...
 */
export function instanceOfUserQuotaUpdate(
  value: object,
): value is UserQuotaUpdate {
  if (
...
export function UserQuotaUpdateFromJSONTyped(
  json: any,
...
export function UserQuotaUpdateToJSONTyped(
  value?: UserQuotaUpdate | null,
