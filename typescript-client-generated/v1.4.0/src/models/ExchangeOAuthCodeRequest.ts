...
export type ExchangeOAuthCodeRequestGrantTypeEnum =
  (typeof ExchangeOAuthCodeRequestGrantTypeEnum)[keyof typeof ExchangeOAuthCodeRequestGrantTypeEnum];

/**
 * Check if a given object implements the ExchangeOAuthCodeRequest interface.
 */
export function instanceOfExchangeOAuthCodeRequest(
  value: object,
): value is ExchangeOAuthCodeRequest {
  if (!("grant_type" in value) || value["grant_type"] === undefined)
    return false;
  return true;
}

export function ExchangeOAuthCodeRequestFromJSON(
  json: any,
): ExchangeOAuthCodeRequest {
  return ExchangeOAuthCodeRequestFromJSONTyped(json, false);
}

export function ExchangeOAuthCodeRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    code_verifier:
      json["code_verifier"] == null ? undefined : json["code_verifier"],
...
export function ExchangeOAuthCodeRequestToJSON(
  json: any,
): ExchangeOAuthCodeRequest {
  return ExchangeOAuthCodeRequestToJSONTyped(json, false);
}

export function ExchangeOAuthCodeRequestToJSONTyped(
  value?: ExchangeOAuthCodeRequest | null,
