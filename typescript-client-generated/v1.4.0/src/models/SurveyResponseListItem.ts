 ...
 */
export function instanceOfSurveyResponseListItem(
  value: object,
): value is SurveyResponseListItem {
...
export function SurveyResponseListItemFromJSON(
  json: any,
): SurveyResponseListItem {
  return SurveyResponseListItemFromJSONTyped(json, false);
}

export function SurveyResponseListItemFromJSONTyped(
  json: any,
...
export function SurveyResponseListItemToJSON(
  json: any,
): SurveyResponseListItem {
  return SurveyResponseListItemToJSONTyped(json, false);
}

export function SurveyResponseListItemToJSONTyped(
  value?: Omit<SurveyResponseListItem, "id"> | null,
  ...
  return {
    ...
    submitted_at:
      value["submitted_at"] == null ?
        value["submitted_at"]
      : value["submitted_at"].toISOString(),
    modified_at:
