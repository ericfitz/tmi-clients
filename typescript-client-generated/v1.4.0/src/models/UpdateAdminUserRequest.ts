...
/**
 * Check if a given object implements the UpdateAdminUserRequest interface.
 */
export function instanceOfUpdateAdminUserRequest(value: object): value is UpdateAdminUserRequest {
    return true;
}

export function UpdateAdminUserRequestFromJSON(json: any): UpdateAdminUserRequest {
    return UpdateAdminUserRequestFromJSONTyped(json, false);
}

export function UpdateAdminUserRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateAdminUserRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateAdminUserRequestToJSON(json: any): UpdateAdminUserRequest {
    return UpdateAdminUserRequestToJSONTyped(json, false);
}

export function UpdateAdminUserRequestToJSONTyped(value?: UpdateAdminUserRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
