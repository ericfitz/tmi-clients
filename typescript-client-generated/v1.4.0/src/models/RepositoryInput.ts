...
export type RepositoryInputTypeEnum = typeof RepositoryInputTypeEnum[keyof typeof RepositoryInputTypeEnum];


/**
 * Check if a given object implements the RepositoryInput interface.
 */
export function instanceOfRepositoryInput(value: object): value is RepositoryInput {
...
export function RepositoryInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): RepositoryInput {
    if (json == null) {
        return json;
    }
    return {
...
export function RepositoryInputToJSONTyped(value?: RepositoryInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
