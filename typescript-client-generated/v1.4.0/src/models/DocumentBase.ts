...
/**
 * Check if a given object implements the DocumentBase interface.
 */
export function instanceOfDocumentBase(value: object): value is DocumentBase {
...
export function DocumentBaseFromJSON(json: any): DocumentBase {
  return DocumentBaseFromJSONTyped(json, false);
}

export function DocumentBaseFromJSONTyped(
  json: any,
...
export function DocumentBaseToJSON(json: any): DocumentBase {
  return DocumentBaseToJSONTyped(json, false);
}

export function DocumentBaseToJSONTyped(
  value?: DocumentBase | null,
