...
export type AddonParameterTypeEnum =
  (typeof AddonParameterTypeEnum)[keyof typeof AddonParameterTypeEnum];

/**
 * Check if a given object implements the AddonParameter interface.
 */
export function instanceOfAddonParameter(
  value: object,
): value is AddonParameter {
...
export function AddonParameterFromJSONTyped(
  json: any,
  ...
  return {
    ...
    metadata_key:
      json["metadata_key"] == null ? undefined : json["metadata_key"],
    number_min: json["number_min"] == null ? undefined : json["number_min"],
    number_max: json["number_max"] == null ? undefined : json["number_max"],
    string_max_length:
      json["string_max_length"] == null ? undefined : json["string_max_length"],
    string_validation_regex:
      json["string_validation_regex"] == null ?
        undefined
      : json["string_validation_regex"],
  };
}
...
export function AddonParameterToJSONTyped(
  value?: AddonParameter | null,
