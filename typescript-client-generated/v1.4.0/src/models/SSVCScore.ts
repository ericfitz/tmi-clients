...
export type SSVCScoreDecisionEnum =
  (typeof SSVCScoreDecisionEnum)[keyof typeof SSVCScoreDecisionEnum];
...
export function instanceOfSSVCScore(value: object): value is SSVCScore {
  ...
  if (!("methodology" in value) || value["methodology"] === undefined)
    return false;
  return true;
}
...
export function SSVCScoreFromJSONTyped(
  json: any,
...
export function SSVCScoreToJSONTyped(
  value?: SSVCScore | null,
