 ...
 * @export
 * @interface TeamProjectNoteBase
 */
export interface TeamProjectNoteBase {
    /**
     * Note name
     * @type {string}
     * @memberof TeamProjectNoteBase
     */
    name: string;
    /**
...
/**
 * Check if a given object implements the TeamProjectNoteBase interface.
 */
export function instanceOfTeamProjectNoteBase(value: object): value is TeamProjectNoteBase {
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('content' in value) || value['content'] === undefined) return false;
    return true;
}

export function TeamProjectNoteBaseFromJSON(json: any): TeamProjectNoteBase {
    return TeamProjectNoteBaseFromJSONTyped(json, false);
}

export function TeamProjectNoteBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamProjectNoteBase {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamProjectNoteBaseToJSON(json: any): TeamProjectNoteBase {
    return TeamProjectNoteBaseToJSONTyped(json, false);
}

export function TeamProjectNoteBaseToJSONTyped(value?: TeamProjectNoteBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
