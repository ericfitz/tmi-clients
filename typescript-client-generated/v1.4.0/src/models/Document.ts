...
export type DocumentAccessStatusEnum =
  (typeof DocumentAccessStatusEnum)[keyof typeof DocumentAccessStatusEnum];
...
export function DocumentFromJSONTyped(
  ...
  return {
    ...
    access_status:
      json["access_status"] == null ? undefined : json["access_status"],
    content_source:
      json["content_source"] == null ? undefined : json["content_source"],
  };
}
