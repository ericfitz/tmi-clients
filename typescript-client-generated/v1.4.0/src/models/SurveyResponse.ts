...
export function SurveyResponseToJSONTyped(value?: Omit<SurveyResponse, 'survey_version'|'id'|'is_confidential'|'revision_notes'|'created_threat_model_id'|'owner'|'created_at'|'modified_at'|'submitted_at'|'reviewed_at'|'reviewed_by'|'survey_json'|'created_by'|'version'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
