 ...
 */
export function instanceOfThreatModelBase(value: object): value is ThreatModelBase {
...
export function ThreatModelBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ThreatModelBase {
    if (json == null) {
        return json;
    }
    return {
...
export function ThreatModelBaseToJSONTyped(value?: ThreatModelBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
