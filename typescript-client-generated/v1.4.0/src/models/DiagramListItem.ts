...
export type DiagramListItemTypeEnum = typeof DiagramListItemTypeEnum[keyof typeof DiagramListItemTypeEnum];


/**
 * Check if a given object implements the DiagramListItem interface.
 */
export function instanceOfDiagramListItem(value: object): value is DiagramListItem {
...
export function DiagramListItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): DiagramListItem {
    if (json == null) {
        return json;
    }
    return {
...
export function DiagramListItemToJSONTyped(value?: Omit<DiagramListItem, 'id'|'created_at'|'modified_at'|'deleted_at'|'alias'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
