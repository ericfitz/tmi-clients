...
export type BaseDiagramTypeEnum =
  (typeof BaseDiagramTypeEnum)[keyof typeof BaseDiagramTypeEnum];
...
export function BaseDiagramFromJSONTyped(
  json: any,
  ...
  return {
    ...
    update_vector:
      json["update_vector"] == null ? undefined : json["update_vector"],
    image:
      json["image"] == null ?
        undefined
...
export function BaseDiagramToJSONTyped(
  value?: Omit<
    BaseDiagram,
    "id" | "created_at" | "modified_at" | "update_vector" | "deleted_at"
  > | null,
