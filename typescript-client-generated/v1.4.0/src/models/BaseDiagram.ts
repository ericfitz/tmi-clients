...
export function BaseDiagramToJSONTyped(value?: Omit<BaseDiagram, 'id'|'created_at'|'modified_at'|'update_vector'|'deleted_at'|'auto_generated'|'alias'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
