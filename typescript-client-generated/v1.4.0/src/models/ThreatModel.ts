...
export function ThreatModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    documents:
      json["documents"] == null ?
        undefined
      : (json["documents"] as Array<any>).map(DocumentFromJSON),
    repositories:
    ...
    diagrams:
      json["diagrams"] == null ?
        undefined
      : (json["diagrams"] as Array<any>).map(DfdDiagramFromJSON),
    threats:
      json["threats"] == null ?
        undefined
      : (json["threats"] as Array<any>).map(ThreatFromJSON),
    notes:
      json["notes"] == null ?
        undefined
      : (json["notes"] as Array<any>).map(NoteFromJSON),
    assets:
      json["assets"] == null ?
        undefined
      : (json["assets"] as Array<any>).map(ExtendedAssetFromJSON),
    status_updated:
      json["status_updated"] == null ?
        undefined
      : new Date(json["status_updated"]),
    is_confidential:
      json["is_confidential"] == null ? undefined : json["is_confidential"],
    deleted_at:
...
export function ThreatModelToJSONTyped(
  value?: Omit<
    ThreatModel,
    | "id"
    | "created_at"
