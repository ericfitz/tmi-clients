...
export type MinimalNodeShapeEnum =
  (typeof MinimalNodeShapeEnum)[keyof typeof MinimalNodeShapeEnum];
...
export function instanceOfMinimalNode(value: object): value is MinimalNode {
  ...
  if (
    !("security_boundary" in value) ||
    value["security_boundary"] === undefined
  )
    return false;
  return true;
}
...
export function MinimalNodeFromJSONTyped(
  json: any,
...
export function MinimalNodeToJSONTyped(
  value?: MinimalNode | null,
