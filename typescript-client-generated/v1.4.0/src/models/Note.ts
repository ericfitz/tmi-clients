...
export function NoteToJSONTyped(value?: Omit<Note, 'id'|'metadata'|'created_at'|'modified_at'|'deleted_at'|'auto_generated'|'alias'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
