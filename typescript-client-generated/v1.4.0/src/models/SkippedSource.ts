...
/**
 * Check if a given object implements the SkippedSource interface.
 */
export function instanceOfSkippedSource(value: object): value is SkippedSource {
...
export function SkippedSourceFromJSON(json: any): SkippedSource {
    return SkippedSourceFromJSONTyped(json, false);
}

export function SkippedSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkippedSource {
    if (json == null) {
        return json;
    }
    return {
...
export function SkippedSourceToJSON(json: any): SkippedSource {
    return SkippedSourceToJSONTyped(json, false);
}

export function SkippedSourceToJSONTyped(value?: SkippedSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
