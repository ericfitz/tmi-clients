...
export interface RepositoriesApiInterface {
   ...
   */
  patchThreatModelRepositoryRequestOpts(
    requestParameters: PatchThreatModelRepositoryRequest,
  ...
  implements RepositoriesApiInterface
{
   ...
   * Creates request options for patchThreatModelRepository without sending the request
   */
  async patchThreatModelRepositoryRequestOpts(
    requestParameters: PatchThreatModelRepositoryRequest,
  ): Promise<runtime.RequestOpts> {
   ...
   * Partially update repository
   */
  async patchThreatModelRepositoryRaw(
    requestParameters: PatchThreatModelRepositoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Repository>> {
    const requestOptions =
      await this.patchThreatModelRepositoryRequestOpts(requestParameters);
   ...
   * Partially update repository
   */
  async patchThreatModelRepository(
    requestParameters: PatchThreatModelRepositoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Repository> {
    const response = await this.patchThreatModelRepositoryRaw(
      requestParameters,
      initOverrides,
    );
