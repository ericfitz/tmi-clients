...
import type { GetUserAPIQuota429Response } from "../models/index";
import {
...
export interface SAMLApiInterface {
   ...
   */
  listSAMLUsersRequestOpts(
    requestParameters: ListSAMLUsersRequest,
...
export class SAMLApi extends runtime.BaseAPI implements SAMLApiInterface {
   ...
   * Creates request options for listSAMLUsers without sending the request
   */
  async listSAMLUsersRequestOpts(
    requestParameters: ListSAMLUsersRequest,
  ): Promise<runtime.RequestOpts> {
   ...
   * List SAML users for UI autocomplete
   */
  async listSAMLUsersRaw(
    requestParameters: ListSAMLUsersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<object>> {
    const requestOptions =
      await this.listSAMLUsersRequestOpts(requestParameters);
  ...
  async listSAMLUsers(
    ...
    const response = await this.listSAMLUsersRaw(
      requestParameters,
      initOverrides,
    );
