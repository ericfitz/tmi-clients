...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TriageNote', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TriageNote();
      });

      it('should create an instance of TriageNote', function() {
        // TODO: update the code to test TriageNote
        expect(instance).to.be.a(TmiJsClient.TriageNote);
      });
