...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfTMListItemOwner', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AllOfTMListItemOwner();
      });

      it('should create an instance of AllOfTMListItemOwner', function() {
        // TODO: update the code to test AllOfTMListItemOwner
        expect(instance).to.be.a(TmiJsClient.AllOfTMListItemOwner);
      });
