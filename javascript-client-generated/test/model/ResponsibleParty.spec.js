...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResponsibleParty', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ResponsibleParty();
      });

      it('should create an instance of ResponsibleParty', function() {
        // TODO: update the code to test ResponsibleParty
        expect(instance).to.be.a(TmiJsClient.ResponsibleParty);
      });
      ...
      it('should have the property customRole (base name: "custom_role")', function() {
        // TODO: update the code to test the property customRole
        expect(instance).to.have.property('customRole');
        // expect(instance.customRole).to.be(expectedValueLiteral);
      });
