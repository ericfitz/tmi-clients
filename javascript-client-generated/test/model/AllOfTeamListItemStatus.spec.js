...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfTeamListItemStatus', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AllOfTeamListItemStatus();
      });

      it('should create an instance of AllOfTeamListItemStatus', function() {
        // TODO: update the code to test AllOfTeamListItemStatus
        expect(instance).to.be.a(TmiJsClient.AllOfTeamListItemStatus);
      });
