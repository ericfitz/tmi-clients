...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListSurveyResponsesResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListSurveyResponsesResponse();
      });

      it('should create an instance of ListSurveyResponsesResponse', function() {
        // TODO: update the code to test ListSurveyResponsesResponse
        expect(instance).to.be.a(TmiJsClient.ListSurveyResponsesResponse);
      });

      it('should have the property surveyResponses (base name: "survey_responses")', function() {
        // TODO: update the code to test the property surveyResponses
        expect(instance).to.have.property('surveyResponses');
        // expect(instance.surveyResponses).to.be(expectedValueLiteral);
      });
