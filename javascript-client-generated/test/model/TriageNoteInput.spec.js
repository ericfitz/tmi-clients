...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TriageNoteInput', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TriageNoteInput();
      });

      it('should create an instance of TriageNoteInput', function() {
        // TODO: update the code to test TriageNoteInput
        expect(instance).to.be.a(TmiJsClient.TriageNoteInput);
      });
