...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveyListItem', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveyListItem();
      });

      it('should create an instance of SurveyListItem', function() {
        // TODO: update the code to test SurveyListItem
        expect(instance).to.be.a(TmiJsClient.SurveyListItem);
      });
