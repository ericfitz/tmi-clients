...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAddonQuotasResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListAddonQuotasResponse();
      });

      it('should create an instance of ListAddonQuotasResponse', function() {
        // TODO: update the code to test ListAddonQuotasResponse
        expect(instance).to.be.a(TmiJsClient.ListAddonQuotasResponse);
      });
