...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InternalUuidClientCredentialsBody', function() {
      beforeEach(function() {
        instance = new TmiJsClient.InternalUuidClientCredentialsBody();
      });

      it('should create an instance of InternalUuidClientCredentialsBody', function() {
        // TODO: update the code to test InternalUuidClientCredentialsBody
        expect(instance).to.be.a(TmiJsClient.InternalUuidClientCredentialsBody);
      });
