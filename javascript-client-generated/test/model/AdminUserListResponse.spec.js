...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdminUserListResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AdminUserListResponse();
      });

      it('should create an instance of AdminUserListResponse', function() {
        // TODO: update the code to test AdminUserListResponse
        expect(instance).to.be.a(TmiJsClient.AdminUserListResponse);
      });
