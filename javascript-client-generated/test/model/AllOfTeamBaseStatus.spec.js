...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfTeamBaseStatus', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AllOfTeamBaseStatus();
      });

      it('should create an instance of AllOfTeamBaseStatus', function() {
        // TODO: update the code to test AllOfTeamBaseStatus
        expect(instance).to.be.a(TmiJsClient.AllOfTeamBaseStatus);
      });
