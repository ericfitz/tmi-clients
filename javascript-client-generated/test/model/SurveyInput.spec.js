...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveyInput', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveyInput();
      });

      it('should create an instance of SurveyInput', function() {
        // TODO: update the code to test SurveyInput
        expect(instance).to.be.a(TmiJsClient.SurveyInput);
      });
