...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateAdminUserRequest', function() {
      beforeEach(function() {
        instance = new TmiJsClient.UpdateAdminUserRequest();
      });

      it('should create an instance of UpdateAdminUserRequest', function() {
        // TODO: update the code to test UpdateAdminUserRequest
        expect(instance).to.be.a(TmiJsClient.UpdateAdminUserRequest);
      });
