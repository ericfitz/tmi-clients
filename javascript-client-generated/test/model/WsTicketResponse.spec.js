...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WsTicketResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.WsTicketResponse();
      });

      it('should create an instance of WsTicketResponse', function() {
        // TODO: update the code to test WsTicketResponse
        expect(instance).to.be.a(TmiJsClient.WsTicketResponse);
      });
