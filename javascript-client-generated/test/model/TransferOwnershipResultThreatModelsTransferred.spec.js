...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransferOwnershipResultThreatModelsTransferred', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TransferOwnershipResultThreatModelsTransferred();
      });

      it('should create an instance of TransferOwnershipResultThreatModelsTransferred', function() {
        // TODO: update the code to test TransferOwnershipResultThreatModelsTransferred
        expect(instance).to.be.a(TmiJsClient.TransferOwnershipResultThreatModelsTransferred);
      });
      ...
      it('should have the property threatModelIds (base name: "threat_model_ids")', function() {
        // TODO: update the code to test the property threatModelIds
        expect(instance).to.have.property('threatModelIds');
        // expect(instance.threatModelIds).to.be(expectedValueLiteral);
      });
