...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveyResponseCreateRequest', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveyResponseCreateRequest();
      });

      it('should create an instance of SurveyResponseCreateRequest', function() {
        // TODO: update the code to test SurveyResponseCreateRequest
        expect(instance).to.be.a(TmiJsClient.SurveyResponseCreateRequest);
      });
