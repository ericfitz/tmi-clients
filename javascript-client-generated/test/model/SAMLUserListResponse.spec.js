...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SAMLUserListResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SAMLUserListResponse();
      });

      it('should create an instance of SAMLUserListResponse', function() {
        // TODO: update the code to test SAMLUserListResponse
        expect(instance).to.be.a(TmiJsClient.SAMLUserListResponse);
      });
