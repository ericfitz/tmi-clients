...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListWebhookSubscriptionsResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListWebhookSubscriptionsResponse();
      });

      it('should create an instance of ListWebhookSubscriptionsResponse', function() {
        // TODO: update the code to test ListWebhookSubscriptionsResponse
        expect(instance).to.be.a(TmiJsClient.ListWebhookSubscriptionsResponse);
      });
