...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserWithAdminStatus', function() {
      ...
      it('should have the property isSecurityReviewer (base name: "is_security_reviewer")', function() {
        // TODO: update the code to test the property isSecurityReviewer
        expect(instance).to.have.property('isSecurityReviewer');
        // expect(instance.isSecurityReviewer).to.be(expectedValueLiteral);
      });
