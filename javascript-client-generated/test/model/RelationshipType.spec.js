  ...
  describe('(package)', function() {
    describe('RelationshipType', function() {
      ...
      it('should have the property parent', function() {
        ...
        expect(instance.parent).to.be("parent");
      });

      it('should have the property child', function() {
        expect(instance).to.have.property('child');
        expect(instance.child).to.be("child");
      });

      it('should have the property dependency', function() {
        expect(instance).to.have.property('dependency');
        expect(instance.dependency).to.be("dependency");
      });

      it('should have the property dependent', function() {
        expect(instance).to.have.property('dependent');
        expect(instance.dependent).to.be("dependent");
      });

      it('should have the property supersedes', function() {
        expect(instance).to.have.property('supersedes');
        expect(instance.supersedes).to.be("supersedes");
      });

      it('should have the property supersededBy', function() {
        expect(instance).to.have.property('supersededBy');
        expect(instance.supersededBy).to.be("superseded_by");
      });

      it('should have the property related', function() {
        expect(instance).to.have.property('related');
        expect(instance.related).to.be("related");
      });
