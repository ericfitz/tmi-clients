...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20010', function() {
      beforeEach(function() {
        instance = new TmiJsClient.InlineResponse20010();
      });

      it('should create an instance of InlineResponse20010', function() {
        // TODO: update the code to test InlineResponse20010
        expect(instance).to.be.a(TmiJsClient.InlineResponse20010);
      });

      it('should have the property migrated (base name: "migrated")', function() {
        // TODO: update the code to test the property migrated
        expect(instance).to.have.property('migrated');
        // expect(instance.migrated).to.be(expectedValueLiteral);
      });
