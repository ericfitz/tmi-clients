...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdminUser', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AdminUser();
      });

      it('should create an instance of AdminUser', function() {
        // TODO: update the code to test AdminUser
        expect(instance).to.be.a(TmiJsClient.AdminUser);
      });
      ...
      it('should have the property providerUserId (base name: "provider_user_id")', function() {
        // TODO: update the code to test the property providerUserId
        expect(instance).to.have.property('providerUserId');
        // expect(instance.providerUserId).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property activeThreatModels (base name: "active_threat_models")', function() {
        // TODO: update the code to test the property activeThreatModels
        expect(instance).to.have.property('activeThreatModels');
