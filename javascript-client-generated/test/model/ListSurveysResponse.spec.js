...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListSurveysResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListSurveysResponse();
      });

      it('should create an instance of ListSurveysResponse', function() {
        // TODO: update the code to test ListSurveysResponse
        expect(instance).to.be.a(TmiJsClient.ListSurveysResponse);
      });
