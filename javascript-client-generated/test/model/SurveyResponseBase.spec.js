...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveyResponseBase', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveyResponseBase();
      });

      it('should create an instance of SurveyResponseBase', function() {
        // TODO: update the code to test SurveyResponseBase
        expect(instance).to.be.a(TmiJsClient.SurveyResponseBase);
      });
      ...
      it('should have the property linkedThreatModelId (base name: "linked_threat_model_id")', function() {
        // TODO: update the code to test the property linkedThreatModelId
        expect(instance).to.have.property('linkedThreatModelId');
        // expect(instance.linkedThreatModelId).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property uiState (base name: "ui_state")', function() {
        // TODO: update the code to test the property uiState
        expect(instance).to.have.property('uiState');
        // expect(instance.uiState).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property surveyVersion (base name: "survey_version")', function() {
        // TODO: update the code to test the property surveyVersion
        expect(instance).to.have.property('surveyVersion');
        // expect(instance.surveyVersion).to.be(expectedValueLiteral);
      });
