...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BulkPatchRequestPatches', function() {
      beforeEach(function() {
        instance = new TmiJsClient.BulkPatchRequestPatches();
      });

      it('should create an instance of BulkPatchRequestPatches', function() {
        // TODO: update the code to test BulkPatchRequestPatches
        expect(instance).to.be.a(TmiJsClient.BulkPatchRequestPatches);
      });
