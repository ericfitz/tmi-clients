...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransferOwnershipRequest', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TransferOwnershipRequest();
      });

      it('should create an instance of TransferOwnershipRequest', function() {
        // TODO: update the code to test TransferOwnershipRequest
        expect(instance).to.be.a(TmiJsClient.TransferOwnershipRequest);
      });

      it('should have the property targetUserId (base name: "target_user_id")', function() {
        // TODO: update the code to test the property targetUserId
        expect(instance).to.have.property('targetUserId');
        // expect(instance.targetUserId).to.be(expectedValueLiteral);
      });
