...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SystemSetting', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SystemSetting();
      });

      it('should create an instance of SystemSetting', function() {
        // TODO: update the code to test SystemSetting
        expect(instance).to.be.a(TmiJsClient.SystemSetting);
      });
