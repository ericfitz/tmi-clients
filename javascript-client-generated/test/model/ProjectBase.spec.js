...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectBase', function() {
      ...
      it('should have the property responsibleParties (base name: "responsible_parties")', function() {
        // TODO: update the code to test the property responsibleParties
        expect(instance).to.have.property('responsibleParties');
        // expect(instance.responsibleParties).to.be(expectedValueLiteral);
      });

      it('should have the property relatedProjects (base name: "related_projects")', function() {
        // TODO: update the code to test the property relatedProjects
        expect(instance).to.have.property('relatedProjects');
        // expect(instance.relatedProjects).to.be(expectedValueLiteral);
      });
