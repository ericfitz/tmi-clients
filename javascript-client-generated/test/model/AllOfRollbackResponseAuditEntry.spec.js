...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfRollbackResponseAuditEntry', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AllOfRollbackResponseAuditEntry();
      });

      it('should create an instance of AllOfRollbackResponseAuditEntry', function() {
        // TODO: update the code to test AllOfRollbackResponseAuditEntry
        expect(instance).to.be.a(TmiJsClient.AllOfRollbackResponseAuditEntry);
      });
