...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ColorPaletteEntry', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ColorPaletteEntry();
      });

      it('should create an instance of ColorPaletteEntry', function() {
        // TODO: update the code to test ColorPaletteEntry
        expect(instance).to.be.a(TmiJsClient.ColorPaletteEntry);
      });
