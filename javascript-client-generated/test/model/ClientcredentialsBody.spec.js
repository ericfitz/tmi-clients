...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClientcredentialsBody', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ClientcredentialsBody();
      });

      it('should create an instance of ClientcredentialsBody', function() {
        // TODO: update the code to test ClientcredentialsBody
        expect(instance).to.be.a(TmiJsClient.ClientcredentialsBody);
      });
