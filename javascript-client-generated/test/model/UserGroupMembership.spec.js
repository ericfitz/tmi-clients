...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserGroupMembership', function() {
      beforeEach(function() {
        instance = new TmiJsClient.UserGroupMembership();
      });

      it('should create an instance of UserGroupMembership', function() {
        // TODO: update the code to test UserGroupMembership
        expect(instance).to.be.a(TmiJsClient.UserGroupMembership);
      });
