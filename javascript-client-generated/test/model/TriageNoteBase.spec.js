...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TriageNoteBase', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TriageNoteBase();
      });

      it('should create an instance of TriageNoteBase', function() {
        // TODO: update the code to test TriageNoteBase
        expect(instance).to.be.a(TmiJsClient.TriageNoteBase);
      });
