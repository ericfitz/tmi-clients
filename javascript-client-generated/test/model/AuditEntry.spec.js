...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuditEntry', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AuditEntry();
      });

      it('should create an instance of AuditEntry', function() {
        // TODO: update the code to test AuditEntry
        expect(instance).to.be.a(TmiJsClient.AuditEntry);
      });
      ...
      it('should have the property changeSummary (base name: "change_summary")', function() {
