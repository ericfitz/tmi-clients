...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MinimalNode', function() {
      beforeEach(function() {
        instance = new TmiJsClient.MinimalNode();
      });

      it('should create an instance of MinimalNode', function() {
        // TODO: update the code to test MinimalNode
        expect(instance).to.be.a(TmiJsClient.MinimalNode);
      });
      ...
      it('should have the property dataAssetIds (base name: "dataAssetIds")', function() {
        // TODO: update the code to test the property dataAssetIds
        expect(instance).to.have.property('dataAssetIds');
        // expect(instance.dataAssetIds).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property securityBoundary (base name: "security_boundary")', function() {
        // TODO: update the code to test the property securityBoundary
        expect(instance).to.have.property('securityBoundary');
        // expect(instance.securityBoundary).to.be(expectedValueLiteral);
      });
