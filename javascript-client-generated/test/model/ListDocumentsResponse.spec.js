...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListDocumentsResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListDocumentsResponse();
      });

      it('should create an instance of ListDocumentsResponse', function() {
        // TODO: update the code to test ListDocumentsResponse
        expect(instance).to.be.a(TmiJsClient.ListDocumentsResponse);
      });
