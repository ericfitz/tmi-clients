...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListDiagramsResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListDiagramsResponse();
      });

      it('should create an instance of ListDiagramsResponse', function() {
        // TODO: update the code to test ListDiagramsResponse
        expect(instance).to.be.a(TmiJsClient.ListDiagramsResponse);
      });
