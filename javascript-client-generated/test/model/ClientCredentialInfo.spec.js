...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClientCredentialInfo', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ClientCredentialInfo();
      });

      it('should create an instance of ClientCredentialInfo', function() {
        // TODO: update the code to test ClientCredentialInfo
        expect(instance).to.be.a(TmiJsClient.ClientCredentialInfo);
      });
