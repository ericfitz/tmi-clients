...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfProjectListItemStatus', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AllOfProjectListItemStatus();
      });

      it('should create an instance of AllOfProjectListItemStatus', function() {
        // TODO: update the code to test AllOfProjectListItemStatus
        expect(instance).to.be.a(TmiJsClient.AllOfProjectListItemStatus);
      });
