...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MyGroupListResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.MyGroupListResponse();
      });

      it('should create an instance of MyGroupListResponse', function() {
        // TODO: update the code to test MyGroupListResponse
        expect(instance).to.be.a(TmiJsClient.MyGroupListResponse);
      });
