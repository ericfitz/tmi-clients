...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListTriageNotesResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListTriageNotesResponse();
      });

      it('should create an instance of ListTriageNotesResponse', function() {
        // TODO: update the code to test ListTriageNotesResponse
        expect(instance).to.be.a(TmiJsClient.ListTriageNotesResponse);
      });

      it('should have the property triageNotes (base name: "triage_notes")', function() {
        // TODO: update the code to test the property triageNotes
        expect(instance).to.have.property('triageNotes');
        // expect(instance.triageNotes).to.be(expectedValueLiteral);
      });
