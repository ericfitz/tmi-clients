...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenRevocationRequest', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TokenRevocationRequest();
      });

      it('should create an instance of TokenRevocationRequest', function() {
        // TODO: update the code to test TokenRevocationRequest
        expect(instance).to.be.a(TmiJsClient.TokenRevocationRequest);
      });
