...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20011', function() {
      beforeEach(function() {
        instance = new TmiJsClient.InlineResponse20011();
      });

      it('should create an instance of InlineResponse20011', function() {
        // TODO: update the code to test InlineResponse20011
        expect(instance).to.be.a(TmiJsClient.InlineResponse20011);
      });

      it('should have the property reencrypted (base name: "reencrypted")', function() {
        // TODO: update the code to test the property reencrypted
        expect(instance).to.have.property('reencrypted');
        // expect(instance.reencrypted).to.be(expectedValueLiteral);
      });
