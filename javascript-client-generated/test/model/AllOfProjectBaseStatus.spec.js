...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfProjectBaseStatus', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AllOfProjectBaseStatus();
      });

      it('should create an instance of AllOfProjectBaseStatus', function() {
        // TODO: update the code to test AllOfProjectBaseStatus
        expect(instance).to.be.a(TmiJsClient.AllOfProjectBaseStatus);
      });
