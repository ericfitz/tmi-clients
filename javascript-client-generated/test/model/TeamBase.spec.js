...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamBase', function() {
      ...
      it('should have the property relatedTeams (base name: "related_teams")', function() {
        // TODO: update the code to test the property relatedTeams
        expect(instance).to.have.property('relatedTeams');
        // expect(instance.relatedTeams).to.be(expectedValueLiteral);
      });
