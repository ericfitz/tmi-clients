...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JsonPatchDocumentInner', function() {
      beforeEach(function() {
        instance = new TmiJsClient.JsonPatchDocumentInner();
      });

      it('should create an instance of JsonPatchDocumentInner', function() {
        // TODO: update the code to test JsonPatchDocumentInner
        expect(instance).to.be.a(TmiJsClient.JsonPatchDocumentInner);
      });
