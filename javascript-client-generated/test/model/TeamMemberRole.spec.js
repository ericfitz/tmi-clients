...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamMemberRole', function() {
      ...
      it('should have the property engineeringLead', function() {
        expect(instance).to.have.property('engineeringLead');
        expect(instance.engineeringLead).to.be("engineering_lead");
      });

      it('should have the property engineer', function() {
        expect(instance).to.have.property('engineer');
        expect(instance.engineer).to.be("engineer");
      });

      it('should have the property productManager', function() {
        expect(instance).to.have.property('productManager');
        expect(instance.productManager).to.be("product_manager");
      });

      it('should have the property businessLeader', function() {
        expect(instance).to.have.property('businessLeader');
        expect(instance.businessLeader).to.be("business_leader");
      });

      it('should have the property securitySpecialist', function() {
        expect(instance).to.have.property('securitySpecialist');
        expect(instance.securitySpecialist).to.be("security_specialist");
      });
