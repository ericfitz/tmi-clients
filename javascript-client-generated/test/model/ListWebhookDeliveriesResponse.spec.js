...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListWebhookDeliveriesResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListWebhookDeliveriesResponse();
      });

      it('should create an instance of ListWebhookDeliveriesResponse', function() {
        // TODO: update the code to test ListWebhookDeliveriesResponse
        expect(instance).to.be.a(TmiJsClient.ListWebhookDeliveriesResponse);
      });
