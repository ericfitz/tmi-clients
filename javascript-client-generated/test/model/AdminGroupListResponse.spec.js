...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdminGroupListResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AdminGroupListResponse();
      });

      it('should create an instance of AdminGroupListResponse', function() {
        // TODO: update the code to test AdminGroupListResponse
        expect(instance).to.be.a(TmiJsClient.AdminGroupListResponse);
      });
