...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveyResponseListItem', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveyResponseListItem();
      });

      it('should create an instance of SurveyResponseListItem', function() {
        // TODO: update the code to test SurveyResponseListItem
        expect(instance).to.be.a(TmiJsClient.SurveyResponseListItem);
      });
      ...
      it('should have the property surveyName (base name: "survey_name")', function() {
        // TODO: update the code to test the property surveyName
        expect(instance).to.have.property('surveyName');
        // expect(instance.surveyName).to.be(expectedValueLiteral);
      });
