...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveySettings', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveySettings();
      });

      it('should create an instance of SurveySettings', function() {
        // TODO: update the code to test SurveySettings
        expect(instance).to.be.a(TmiJsClient.SurveySettings);
      });

      it('should have the property allowThreatModelLinking (base name: "allow_threat_model_linking")', function() {
        // TODO: update the code to test the property allowThreatModelLinking
        expect(instance).to.have.property('allowThreatModelLinking');
        // expect(instance.allowThreatModelLinking).to.be(expectedValueLiteral);
      });
