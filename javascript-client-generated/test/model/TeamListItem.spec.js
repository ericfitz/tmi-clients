...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamListItem', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TeamListItem();
      });

      it('should create an instance of TeamListItem', function() {
        // TODO: update the code to test TeamListItem
        expect(instance).to.be.a(TmiJsClient.TeamListItem);
      });
