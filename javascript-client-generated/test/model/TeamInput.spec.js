...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamInput', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TeamInput();
      });

      it('should create an instance of TeamInput', function() {
        // TODO: update the code to test TeamInput
        expect(instance).to.be.a(TmiJsClient.TeamInput);
      });
