...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvokeAddonRequest', function() {
      beforeEach(function() {
        instance = new TmiJsClient.InvokeAddonRequest();
      });

      it('should create an instance of InvokeAddonRequest', function() {
        // TODO: update the code to test InvokeAddonRequest
        expect(instance).to.be.a(TmiJsClient.InvokeAddonRequest);
      });
