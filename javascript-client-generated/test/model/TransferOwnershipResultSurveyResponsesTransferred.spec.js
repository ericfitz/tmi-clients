...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransferOwnershipResultSurveyResponsesTransferred', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TransferOwnershipResultSurveyResponsesTransferred();
      });

      it('should create an instance of TransferOwnershipResultSurveyResponsesTransferred', function() {
        // TODO: update the code to test TransferOwnershipResultSurveyResponsesTransferred
        expect(instance).to.be.a(TmiJsClient.TransferOwnershipResultSurveyResponsesTransferred);
      });
      ...
      it('should have the property surveyResponseIds (base name: "survey_response_ids")', function() {
        // TODO: update the code to test the property surveyResponseIds
        expect(instance).to.have.property('surveyResponseIds');
        // expect(instance.surveyResponseIds).to.be(expectedValueLiteral);
      });
