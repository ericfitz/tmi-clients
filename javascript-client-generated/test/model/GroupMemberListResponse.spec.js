...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupMemberListResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.GroupMemberListResponse();
      });

      it('should create an instance of GroupMemberListResponse', function() {
        // TODO: update the code to test GroupMemberListResponse
        expect(instance).to.be.a(TmiJsClient.GroupMemberListResponse);
      });
