...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAuditTrailResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListAuditTrailResponse();
      });

      it('should create an instance of ListAuditTrailResponse', function() {
        // TODO: update the code to test ListAuditTrailResponse
        expect(instance).to.be.a(TmiJsClient.ListAuditTrailResponse);
      });

      it('should have the property auditEntries (base name: "audit_entries")', function() {
        // TODO: update the code to test the property auditEntries
        expect(instance).to.have.property('auditEntries');
        // expect(instance.auditEntries).to.be(expectedValueLiteral);
      });
