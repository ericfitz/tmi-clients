...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListUserQuotasResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListUserQuotasResponse();
      });

      it('should create an instance of ListUserQuotasResponse', function() {
        // TODO: update the code to test ListUserQuotasResponse
        expect(instance).to.be.a(TmiJsClient.ListUserQuotasResponse);
      });
