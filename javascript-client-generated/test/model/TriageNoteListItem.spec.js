...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TriageNoteListItem', function() {
      beforeEach(function() {
        instance = new TmiJsClient.TriageNoteListItem();
      });

      it('should create an instance of TriageNoteListItem', function() {
        // TODO: update the code to test TriageNoteListItem
        expect(instance).to.be.a(TmiJsClient.TriageNoteListItem);
      });
