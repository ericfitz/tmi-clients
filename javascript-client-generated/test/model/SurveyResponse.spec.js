...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveyResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveyResponse();
      });

      it('should create an instance of SurveyResponse', function() {
        // TODO: update the code to test SurveyResponse
        expect(instance).to.be.a(TmiJsClient.SurveyResponse);
      });
      ...
      it('should have the property revisionNotes (base name: "revision_notes")', function() {
        // TODO: update the code to test the property revisionNotes
        expect(instance).to.have.property('revisionNotes');
        // expect(instance.revisionNotes).to.be(expectedValueLiteral);
      });

      it('should have the property createdThreatModelId (base name: "created_threat_model_id")', function() {
        // TODO: update the code to test the property createdThreatModelId
        expect(instance).to.have.property('createdThreatModelId');
        // expect(instance.createdThreatModelId).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property surveyJson (base name: "survey_json")', function() {
        // TODO: update the code to test the property surveyJson
        expect(instance).to.have.property('surveyJson');
        // expect(instance.surveyJson).to.be(expectedValueLiteral);
      });
