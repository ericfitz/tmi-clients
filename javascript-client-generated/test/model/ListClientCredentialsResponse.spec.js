...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListClientCredentialsResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListClientCredentialsResponse();
      });

      it('should create an instance of ListClientCredentialsResponse', function() {
        // TODO: update the code to test ListClientCredentialsResponse
        expect(instance).to.be.a(TmiJsClient.ListClientCredentialsResponse);
      });
