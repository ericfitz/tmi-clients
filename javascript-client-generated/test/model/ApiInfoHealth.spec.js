...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApiInfoHealth', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ApiInfoHealth();
      });

      it('should create an instance of ApiInfoHealth', function() {
        // TODO: update the code to test ApiInfoHealth
        expect(instance).to.be.a(TmiJsClient.ApiInfoHealth);
      });
      ...
      it('should have the property redis (base name: "redis")', function() {
        // TODO: update the code to test the property redis
        expect(instance).to.have.property('redis');
        // expect(instance.redis).to.be(expectedValueLiteral);
      });
