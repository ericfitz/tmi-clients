...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddGroupMemberRequest', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AddGroupMemberRequest();
      });

      it('should create an instance of AddGroupMemberRequest', function() {
        // TODO: update the code to test AddGroupMemberRequest
        expect(instance).to.be.a(TmiJsClient.AddGroupMemberRequest);
      });
