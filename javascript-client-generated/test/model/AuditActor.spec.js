...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuditActor', function() {
      beforeEach(function() {
        instance = new TmiJsClient.AuditActor();
      });

      it('should create an instance of AuditActor', function() {
        // TODO: update the code to test AuditActor
        expect(instance).to.be.a(TmiJsClient.AuditActor);
      });
