...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectListItem', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ProjectListItem();
      });

      it('should create an instance of ProjectListItem', function() {
        // TODO: update the code to test ProjectListItem
        expect(instance).to.be.a(TmiJsClient.ProjectListItem);
      });
