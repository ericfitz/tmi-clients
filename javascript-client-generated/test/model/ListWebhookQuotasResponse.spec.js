...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListWebhookQuotasResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListWebhookQuotasResponse();
      });

      it('should create an instance of ListWebhookQuotasResponse', function() {
        // TODO: update the code to test ListWebhookQuotasResponse
        expect(instance).to.be.a(TmiJsClient.ListWebhookQuotasResponse);
      });
