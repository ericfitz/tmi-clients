...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListThreatsResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListThreatsResponse();
      });

      it('should create an instance of ListThreatsResponse', function() {
        // TODO: update the code to test ListThreatsResponse
        expect(instance).to.be.a(TmiJsClient.ListThreatsResponse);
      });
