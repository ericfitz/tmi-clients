...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateAdminGroupRequest', function() {
      beforeEach(function() {
        instance = new TmiJsClient.CreateAdminGroupRequest();
      });

      it('should create an instance of CreateAdminGroupRequest', function() {
        // TODO: update the code to test CreateAdminGroupRequest
        expect(instance).to.be.a(TmiJsClient.CreateAdminGroupRequest);
      });
