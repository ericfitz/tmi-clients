...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Oauth2TokenBody1', function() {
      beforeEach(function() {
        instance = new TmiJsClient.Oauth2TokenBody1();
      });

      it('should create an instance of Oauth2TokenBody1', function() {
        // TODO: update the code to test Oauth2TokenBody1
        expect(instance).to.be.a(TmiJsClient.Oauth2TokenBody1);
      });
