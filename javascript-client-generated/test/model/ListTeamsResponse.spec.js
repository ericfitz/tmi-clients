...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListTeamsResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListTeamsResponse();
      });

      it('should create an instance of ListTeamsResponse', function() {
        // TODO: update the code to test ListTeamsResponse
        expect(instance).to.be.a(TmiJsClient.ListTeamsResponse);
      });
