...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WebhookDelivery', function() {
      beforeEach(function() {
        instance = new TmiJsClient.WebhookDelivery();
      });

      it('should create an instance of WebhookDelivery', function() {
        // TODO: update the code to test WebhookDelivery
        expect(instance).to.be.a(TmiJsClient.WebhookDelivery);
      });
      ...
      it('should have the property attempts (base name: "attempts")', function() {
        // TODO: update the code to test the property attempts
        expect(instance).to.have.property('attempts');
        // expect(instance.attempts).to.be(expectedValueLiteral);
      });

      it('should have the property nextRetryAt (base name: "next_retry_at")', function() {
        // TODO: update the code to test the property nextRetryAt
        expect(instance).to.have.property('nextRetryAt');
        // expect(instance.nextRetryAt).to.be(expectedValueLiteral);
      });
