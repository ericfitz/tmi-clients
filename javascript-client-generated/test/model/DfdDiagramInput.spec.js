...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DfdDiagramInput', function() {
      beforeEach(function() {
        instance = new TmiJsClient.DfdDiagramInput();
      });

      it('should create an instance of DfdDiagramInput', function() {
        // TODO: update the code to test DfdDiagramInput
        expect(instance).to.be.a(TmiJsClient.DfdDiagramInput);
      });
