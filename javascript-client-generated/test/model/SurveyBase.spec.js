...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveyBase', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveyBase();
      });

      it('should create an instance of SurveyBase', function() {
        // TODO: update the code to test SurveyBase
        expect(instance).to.be.a(TmiJsClient.SurveyBase);
      });
