...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateAutomationAccountRequest', function() {
      beforeEach(function() {
        instance = new TmiJsClient.CreateAutomationAccountRequest();
      });

      it('should create an instance of CreateAutomationAccountRequest', function() {
        // TODO: update the code to test CreateAutomationAccountRequest
        expect(instance).to.be.a(TmiJsClient.CreateAutomationAccountRequest);
      });
