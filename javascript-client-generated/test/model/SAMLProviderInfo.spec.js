...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SAMLProviderInfo', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SAMLProviderInfo();
      });

      it('should create an instance of SAMLProviderInfo', function() {
        // TODO: update the code to test SAMLProviderInfo
        expect(instance).to.be.a(TmiJsClient.SAMLProviderInfo);
      });
      ...
      it('should have the property acsUrl (base name: "acs_url")', function() {
        // TODO: update the code to test the property acsUrl
        expect(instance).to.have.property('acsUrl');
        // expect(instance.acsUrl).to.be(expectedValueLiteral);
      });

      it('should have the property sloUrl (base name: "slo_url")', function() {
        // TODO: update the code to test the property sloUrl
        expect(instance).to.have.property('sloUrl');
