...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SurveyResponseInput', function() {
      beforeEach(function() {
        instance = new TmiJsClient.SurveyResponseInput();
      });

      it('should create an instance of SurveyResponseInput', function() {
        // TODO: update the code to test SurveyResponseInput
        expect(instance).to.be.a(TmiJsClient.SurveyResponseInput);
      });
