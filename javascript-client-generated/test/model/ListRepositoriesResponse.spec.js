...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListRepositoriesResponse', function() {
      beforeEach(function() {
        instance = new TmiJsClient.ListRepositoriesResponse();
      });

      it('should create an instance of ListRepositoriesResponse', function() {
        // TODO: update the code to test ListRepositoriesResponse
        expect(instance).to.be.a(TmiJsClient.ListRepositoriesResponse);
      });
