...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.TmiThreatModelingImprovedApi);
  }
}(this, function(expect, TmiThreatModelingImprovedApi) {
  'use strict';

  var instance;

  describe('(package)', function() {
    describe('MinimalEdge', function() {
      beforeEach(function() {
        instance = new TmiThreatModelingImprovedApi.MinimalEdge();
      });

      it('should create an instance of MinimalEdge', function() {
        // TODO: update the code to test MinimalEdge
        expect(instance).to.be.a(TmiThreatModelingImprovedApi.MinimalEdge);
      });
      ...
      it('should have the property dataAssetId (base name: "dataAssetId")', function() {
        // TODO: update the code to test the property dataAssetId
        expect(instance).to.have.property('dataAssetId');
        // expect(instance.dataAssetId).to.be(expectedValueLiteral);
      });
