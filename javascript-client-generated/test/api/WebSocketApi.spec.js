...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TmiJsClient.WebSocketApi();
  });

  describe('(package)', function() {
    describe('WebSocketApi', function() {
      describe('getWsTicket', function() {
        it('should call getWsTicket successfully', function(done) {
          // TODO: uncomment, update parameter values for getWsTicket call and complete the assertions
          /*

          instance.getWsTicket(sessionId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(TmiJsClient.WsTicketResponse);
