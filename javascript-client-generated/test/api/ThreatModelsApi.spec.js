...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TmiJsClient.ThreatModelsApi();
  });
  ...
  describe('(package)', function() {
    describe('ThreatModelsApi', function() {
      ...
      describe('restoreThreatModel', function() {
        it('should call restoreThreatModel successfully', function(done) {
          // TODO: uncomment, update parameter values for restoreThreatModel call and complete the assertions
          /*

          instance.restoreThreatModel(threatModelId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(TmiJsClient.ThreatModel);
