...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TmiJsClient.CollaborationApi();
  });
  ...
  describe('(package)', function() {
    describe('CollaborationApi', function() {
      ...
      describe('getCurrentUserSessions', function() {
        it('should call getCurrentUserSessions successfully', function(done) {
          // TODO: uncomment getCurrentUserSessions call and complete the assertions
          /*

          instance.getCurrentUserSessions().then(function(data) {
            // TODO: update response assertions
