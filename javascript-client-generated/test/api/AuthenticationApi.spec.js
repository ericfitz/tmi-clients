...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthenticationApi', function() {
      ...
      describe('listMyGroupMembers', function() {
        it('should call listMyGroupMembers successfully', function(done) {
          // TODO: uncomment, update parameter values for listMyGroupMembers call and complete the assertions
          /*
          var opts = {};

          instance.listMyGroupMembers(internalUuid, opts).then(function(data) {
            // TODO: update response assertions
      ...
      describe('listMyGroups', function() {
        it('should call listMyGroups successfully', function(done) {
          // TODO: uncomment listMyGroups call and complete the assertions
          /*

          instance.listMyGroups().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(TmiJsClient.MyGroupListResponse);
