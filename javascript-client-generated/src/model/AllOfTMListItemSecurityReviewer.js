...
/**
 * The AllOfTMListItemSecurityReviewer model module.
 * @module model/AllOfTMListItemSecurityReviewer
 * @version 1.0.0
 */
export default class AllOfTMListItemSecurityReviewer extends User {
  /**
   * Constructs a new <code>AllOfTMListItemSecurityReviewer</code>.
   ...
   * @alias module:model/AllOfTMListItemSecurityReviewer
   * @class
  ...
  /**
   * Constructs a <code>AllOfTMListItemSecurityReviewer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfTMListItemSecurityReviewer} obj Optional instance to populate.
   * @return {module:model/AllOfTMListItemSecurityReviewer} The populated <code>AllOfTMListItemSecurityReviewer</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfTMListItemSecurityReviewer.prototype);
