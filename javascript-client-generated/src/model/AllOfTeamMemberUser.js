...
/**
 * The AllOfTeamMemberUser model module.
 * @module model/AllOfTeamMemberUser
 * @version 1.0.0
 */
export default class AllOfTeamMemberUser extends User {
  /**
   * Constructs a new <code>AllOfTeamMemberUser</code>.
   * Resolved user details (read-only, populated by server)
   * @alias module:model/AllOfTeamMemberUser
   * @class
  ...
  /**
   * Constructs a <code>AllOfTeamMemberUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfTeamMemberUser} obj Optional instance to populate.
   * @return {module:model/AllOfTeamMemberUser} The populated <code>AllOfTeamMemberUser</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfTeamMemberUser.prototype);
