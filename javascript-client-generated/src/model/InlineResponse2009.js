...
import SAMLProviderInfo from './SAMLProviderInfo';
...
export default class InlineResponse2009 {
   ...
   * @class
   * @param providers {Array.<module:model/SAMLProviderInfo>} 
   */
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('providers'))
        obj.providers = ApiClient.convertToType(data['providers'], [SAMLProviderInfo]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/SAMLProviderInfo>} providers
 */
InlineResponse2009.prototype.providers = undefined;
