...
/**
 * The AllOfTriageNoteListItemCreatedBy model module.
 * @module model/AllOfTriageNoteListItemCreatedBy
 * @version 1.0.0
 */
export default class AllOfTriageNoteListItemCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfTriageNoteListItemCreatedBy</code>.
   * User who created this triage note
   * @alias module:model/AllOfTriageNoteListItemCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfTriageNoteListItemCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfTriageNoteListItemCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfTriageNoteListItemCreatedBy} The populated <code>AllOfTriageNoteListItemCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfTriageNoteListItemCreatedBy.prototype);
