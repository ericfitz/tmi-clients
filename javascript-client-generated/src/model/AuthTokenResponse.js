...
export default class AuthTokenResponse {
   ...
   * @param refreshToken {String} Refresh token for obtaining new access tokens
   * @param tokenType {module:model/AuthTokenResponse.TokenTypeEnum} Token type
   * @param expiresIn {Number} Access token expiration time in seconds
   */
 ...
 */
AuthTokenResponse.prototype.accessToken = undefined;

/**
 * Refresh token for obtaining new access tokens
 * @member {String} refreshToken
 */
AuthTokenResponse.prototype.refreshToken = undefined;
 ...
 * @readonly
 */
AuthTokenResponse.TokenTypeEnum = {
  /**
   * value: "Bearer"
   * @const
   */
...
/**
 * Token type
 * @member {module:model/AuthTokenResponse.TokenTypeEnum} tokenType
 */
AuthTokenResponse.prototype.tokenType = undefined;

/**
 * Access token expiration time in seconds
 * @member {Number} expiresIn
 */
AuthTokenResponse.prototype.expiresIn = undefined;
