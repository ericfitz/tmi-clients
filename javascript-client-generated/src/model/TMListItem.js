...
export default class TMListItem {
   ...
   * @param owner {Object} User who owns the threat model
   * @param createdBy {Object} User who created the threat model
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('security_reviewer'))
        obj.securityReviewer = ApiClient.convertToType(data['security_reviewer'], Object);
      if (data.hasOwnProperty('deleted_at'))
        obj.deletedAt = ApiClient.convertToType(data['deleted_at'], 'Date');
    }
    return obj;
  }
}
 ...
 * @member {Object} securityReviewer
 */
TMListItem.prototype.securityReviewer = undefined;
 ...
 */
TMListItem.prototype.deletedAt = undefined;
