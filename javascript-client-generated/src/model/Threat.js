...
/**
 * The Threat model module.
 * @module model/Threat
 * @version 1.0.0
 */
export default class Threat extends ThreatBase {
  /**
   * Constructs a new <code>Threat</code>.
   * A security threat identified during threat modeling, with severity, status, and mitigation details
   * @alias module:model/Threat
   * @class
  ...
  /**
   * Constructs a <code>Threat</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Threat} obj Optional instance to populate.
   * @return {module:model/Threat} The populated <code>Threat</code> instance.
   */
 ...
 * @member {String} id
 */
Threat.prototype.id = undefined;

/**
 * Unique identifier of the parent threat model (UUID)
 * @member {String} threatModelId
 */
Threat.prototype.threatModelId = undefined;

/**
 * Creation timestamp (RFC3339)
 * @member {Date} createdAt
 */
Threat.prototype.createdAt = undefined;

/**
 * Last modification timestamp (RFC3339)
 * @member {Date} modifiedAt
 */
Threat.prototype.modifiedAt = undefined;
 ...
 */
Threat.prototype.deletedAt = undefined;
