...
import TriageNoteBase from './TriageNoteBase';

/**
 * The TriageNote model module.
 * @module model/TriageNote
 * @version 1.0.0
 */
export default class TriageNote extends TriageNoteBase {
  /**
   * Constructs a new <code>TriageNote</code>.
   * Complete TriageNote schema with server-generated fields
   * @alias module:model/TriageNote
   * @class
  ...
  /**
   * Constructs a <code>TriageNote</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TriageNote} obj Optional instance to populate.
   * @return {module:model/TriageNote} The populated <code>TriageNote</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TriageNote();
      TriageNoteBase.constructFromObject(data, obj);
 ...
 * @member {Number} id
 */
TriageNote.prototype.id = undefined;

/**
 * Creation timestamp (RFC3339)
 * @member {Date} createdAt
 */
TriageNote.prototype.createdAt = undefined;

/**
 * User who created this triage note
 * @member {Object} createdBy
 */
TriageNote.prototype.createdBy = undefined;

/**
 * Last modification timestamp (RFC3339)
 * @member {Date} modifiedAt
 */
TriageNote.prototype.modifiedAt = undefined;

/**
 * User who last modified this triage note
 * @member {Object} modifiedBy
 */
TriageNote.prototype.modifiedBy = undefined;
