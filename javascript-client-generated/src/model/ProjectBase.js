...
export default class ProjectBase {
   ...
   * @param teamId {String} UUID of the team this project belongs to
   */
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('related_projects'))
        obj.relatedProjects = ApiClient.convertToType(data['related_projects'], [RelatedProject]);
 ...
 */
ProjectBase.prototype.teamId = undefined;

/**
 * Responsible parties for this project
 * @member {Array.<module:model/ResponsibleParty>} responsibleParties
 */
ProjectBase.prototype.responsibleParties = undefined;

/**
 * Relationships to other projects
 * @member {Array.<module:model/RelatedProject>} relatedProjects
 */
ProjectBase.prototype.relatedProjects = undefined;

/**
 * URL or reference to internal project page
 * @member {String} uri
 */
ProjectBase.prototype.uri = undefined;

/**
 * Project lifecycle status. Defaults to 'active' if not provided or set to null.
 * @member {String} status
 */
ProjectBase.prototype.status = undefined;
