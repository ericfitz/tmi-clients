...
/**
 * The AllOfSurveyResponseListItemOwner model module.
 * @module model/AllOfSurveyResponseListItemOwner
 * @version 1.0.0
 */
export default class AllOfSurveyResponseListItemOwner extends User {
  /**
   * Constructs a new <code>AllOfSurveyResponseListItemOwner</code>.
   * User who created the response
   * @alias module:model/AllOfSurveyResponseListItemOwner
   * @class
  ...
  /**
   * Constructs a <code>AllOfSurveyResponseListItemOwner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfSurveyResponseListItemOwner} obj Optional instance to populate.
   * @return {module:model/AllOfSurveyResponseListItemOwner} The populated <code>AllOfSurveyResponseListItemOwner</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfSurveyResponseListItemOwner.prototype);
