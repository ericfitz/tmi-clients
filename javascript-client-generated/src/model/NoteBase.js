...
/**
 * The NoteBase model module.
 * @module model/NoteBase
 * @version 1.0.0
 */
export default class NoteBase {
  /**
   * Constructs a new <code>NoteBase</code>.
  ...
  /**
   * Constructs a <code>NoteBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NoteBase} obj Optional instance to populate.
   * @return {module:model/NoteBase} The populated <code>NoteBase</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new NoteBase();
 ...
 */
NoteBase.prototype.description = undefined;
 ...
 * @default true
 */
NoteBase.prototype.includeInReport = true;
 ...
 * @default true
 */
NoteBase.prototype.timmyEnabled = true;
