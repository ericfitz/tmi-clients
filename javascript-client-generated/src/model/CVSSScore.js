 ...
 * @version 1.0.0
 */
export default class CVSSScore {
  /**
   * Constructs a new <code>CVSSScore</code>.
   * CVSS vector and score pair
   * @alias module:model/CVSSScore
   * @class
   * @param vector {String} CVSS vector string (e.g., CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H)
   * @param score {Number} CVSS score (0.0-10.0)
   */
  constructor(vector, score) {
    this.vector = vector;
    this.score = score;
  }
 ...
 */
CVSSScore.prototype.vector = undefined;

/**
 * CVSS score (0.0-10.0)
 * @member {Number} score
 */
CVSSScore.prototype.score = undefined;
