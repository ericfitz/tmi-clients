...
/**
 * The TriageNoteBase model module.
 * @module model/TriageNoteBase
 * @version 1.0.0
 */
export default class TriageNoteBase {
  /**
   * Constructs a new <code>TriageNoteBase</code>.
  ...
  /**
   * Constructs a <code>TriageNoteBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TriageNoteBase} obj Optional instance to populate.
   * @return {module:model/TriageNoteBase} The populated <code>TriageNoteBase</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TriageNoteBase();
