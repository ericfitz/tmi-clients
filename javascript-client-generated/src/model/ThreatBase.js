  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cwe_id'))
        obj.cweId = ApiClient.convertToType(data['cwe_id'], ['String']);
      if (data.hasOwnProperty('cvss'))
        obj.cvss = ApiClient.convertToType(data['cvss'], [CVSSScore]);
 ...
 * @member {Array.<String>} cweId
 */
ThreatBase.prototype.cweId = undefined;

/**
 * CVSS scoring information for this threat
 * @member {Array.<module:model/CVSSScore>} cvss
 */
ThreatBase.prototype.cvss = undefined;
 ...
 * @default true
 */
ThreatBase.prototype.includeInReport = true;
 ...
 * @default true
 */
ThreatBase.prototype.timmyEnabled = true;
