 ...
 * @version 1.0.0
 */
export default class WebhookTestResponse {
  /**
   ...
   * @class
   * @param deliveryId {String} Test delivery ID
   * @param status {String} Test result status
   */
  constructor(deliveryId, status) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('delivery_id'))
        obj.deliveryId = ApiClient.convertToType(data['delivery_id'], 'String');
 ...
 */
WebhookTestResponse.prototype.deliveryId = undefined;

/**
 * Test result status
 * @member {String} status
 */
WebhookTestResponse.prototype.status = undefined;

/**
 * Result message
 * @member {String} message
 */
WebhookTestResponse.prototype.message = undefined;
