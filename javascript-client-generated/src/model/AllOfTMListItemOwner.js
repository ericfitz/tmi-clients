...
/**
 * The AllOfTMListItemOwner model module.
 * @module model/AllOfTMListItemOwner
 * @version 1.0.0
 */
export default class AllOfTMListItemOwner extends User {
  /**
   * Constructs a new <code>AllOfTMListItemOwner</code>.
   * User who owns the threat model
   * @alias module:model/AllOfTMListItemOwner
   * @class
  ...
  /**
   * Constructs a <code>AllOfTMListItemOwner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfTMListItemOwner} obj Optional instance to populate.
   * @return {module:model/AllOfTMListItemOwner} The populated <code>AllOfTMListItemOwner</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfTMListItemOwner.prototype);
