...
/**
 * The ThreatModelInput model module.
 * @module model/ThreatModelInput
 * @version 1.0.0
 */
export default class ThreatModelInput {
  /**
   * Constructs a new <code>ThreatModelInput</code>.
   * Input schema for creating/updating ThreatModel
   * @alias module:model/ThreatModelInput
   * @class
  ...
  /**
   * Constructs a <code>ThreatModelInput</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ThreatModelInput} obj Optional instance to populate.
   * @return {module:model/ThreatModelInput} The populated <code>ThreatModelInput</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ThreatModelInput();
 ...
 * @default false
 */
ThreatModelInput.prototype.isConfidential = false;
