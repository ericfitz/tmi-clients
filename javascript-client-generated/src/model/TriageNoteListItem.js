...
/**
 * The TriageNoteListItem model module.
 * @module model/TriageNoteListItem
 * @version 1.0.0
 */
export default class TriageNoteListItem {
  /**
   * Constructs a new <code>TriageNoteListItem</code>.
   * Summary information for TriageNote in list responses
   * @alias module:model/TriageNoteListItem
   * @class
   * @param id {Number} Sequential identifier for the triage note within its survey response
  ...
  /**
   * Constructs a <code>TriageNoteListItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TriageNoteListItem} obj Optional instance to populate.
   * @return {module:model/TriageNoteListItem} The populated <code>TriageNoteListItem</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TriageNoteListItem();
 ...
 * @member {Number} id
 */
TriageNoteListItem.prototype.id = undefined;

/**
 * Triage note name
 * @member {String} name
 */
TriageNoteListItem.prototype.name = undefined;

/**
 * Creation timestamp (RFC3339)
 * @member {Date} createdAt
 */
TriageNoteListItem.prototype.createdAt = undefined;

/**
 * User who created this triage note
 * @member {Object} createdBy
 */
TriageNoteListItem.prototype.createdBy = undefined;
