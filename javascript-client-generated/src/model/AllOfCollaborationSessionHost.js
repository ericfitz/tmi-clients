...
/**
 * The AllOfCollaborationSessionHost model module.
 * @module model/AllOfCollaborationSessionHost
 * @version 1.0.0
 */
export default class AllOfCollaborationSessionHost extends User {
  /**
   * Constructs a new <code>AllOfCollaborationSessionHost</code>.
   * User hosting the collaboration session
   * @alias module:model/AllOfCollaborationSessionHost
   * @class
  ...
  /**
   * Constructs a <code>AllOfCollaborationSessionHost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfCollaborationSessionHost} obj Optional instance to populate.
   * @return {module:model/AllOfCollaborationSessionHost} The populated <code>AllOfCollaborationSessionHost</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfCollaborationSessionHost.prototype);
