...
/**
 * The WsTicketResponse model module.
 * @module model/WsTicketResponse
 * @version 1.0.0
 */
export default class WsTicketResponse {
  /**
   * Constructs a new <code>WsTicketResponse</code>.
   * Response containing a short-lived, single-use authentication ticket for WebSocket connection
   * @alias module:model/WsTicketResponse
   * @class
   * @param ticket {String} Short-lived, single-use authentication ticket for WebSocket connection
   */
  constructor(ticket) {
    this.ticket = ticket;
  }
  ...
  /**
   * Constructs a <code>WsTicketResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WsTicketResponse} obj Optional instance to populate.
   * @return {module:model/WsTicketResponse} The populated <code>WsTicketResponse</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new WsTicketResponse();
 ...
 */
WsTicketResponse.prototype.ticket = undefined;
