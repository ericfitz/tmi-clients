...
/**
 * The AllOfResponsiblePartyUser model module.
 * @module model/AllOfResponsiblePartyUser
 * @version 1.0.0
 */
export default class AllOfResponsiblePartyUser extends User {
  /**
   * Constructs a new <code>AllOfResponsiblePartyUser</code>.
   * Resolved user details (read-only, populated by server)
   * @alias module:model/AllOfResponsiblePartyUser
   * @class
  ...
  /**
   * Constructs a <code>AllOfResponsiblePartyUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfResponsiblePartyUser} obj Optional instance to populate.
   * @return {module:model/AllOfResponsiblePartyUser} The populated <code>AllOfResponsiblePartyUser</code> instance.
   */
