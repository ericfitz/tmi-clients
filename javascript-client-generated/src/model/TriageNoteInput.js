...
/**
 * The TriageNoteInput model module.
 * @module model/TriageNoteInput
 * @version 1.0.0
 */
export default class TriageNoteInput extends TriageNoteBase {
  /**
   * Constructs a new <code>TriageNoteInput</code>.
   * Input schema for creating a TriageNote
   * @alias module:model/TriageNoteInput
   * @class
  ...
  /**
   * Constructs a <code>TriageNoteInput</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TriageNoteInput} obj Optional instance to populate.
   * @return {module:model/TriageNoteInput} The populated <code>TriageNoteInput</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TriageNoteInput();
