...
/**
 * The AllOfCollaborationSessionPresenter model module.
 * @module model/AllOfCollaborationSessionPresenter
 * @version 1.0.0
 */
export default class AllOfCollaborationSessionPresenter extends User {
  /**
   * Constructs a new <code>AllOfCollaborationSessionPresenter</code>.
   * User currently presenting (may be null if no active presenter)
   * @alias module:model/AllOfCollaborationSessionPresenter
   * @class
  ...
  /**
   * Constructs a <code>AllOfCollaborationSessionPresenter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfCollaborationSessionPresenter} obj Optional instance to populate.
   * @return {module:model/AllOfCollaborationSessionPresenter} The populated <code>AllOfCollaborationSessionPresenter</code> instance.
   */
