...
/**
 * The AllOfThreatModelBaseSecurityReviewer model module.
 * @module model/AllOfThreatModelBaseSecurityReviewer
 * @version 1.0.0
 */
export default class AllOfThreatModelBaseSecurityReviewer extends User {
  /**
   * Constructs a new <code>AllOfThreatModelBaseSecurityReviewer</code>.
   ...
   * @alias module:model/AllOfThreatModelBaseSecurityReviewer
   * @class
  ...
  /**
   * Constructs a <code>AllOfThreatModelBaseSecurityReviewer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfThreatModelBaseSecurityReviewer} obj Optional instance to populate.
   * @return {module:model/AllOfThreatModelBaseSecurityReviewer} The populated <code>AllOfThreatModelBaseSecurityReviewer</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfThreatModelBaseSecurityReviewer.prototype);
