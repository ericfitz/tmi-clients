 ...
 * @version 1.0.0
 */
export default class TransferOwnershipRequest {
  /**
   ...
   * @class
   * @param targetUserId {String} Internal UUID of the user to receive ownership
   */
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('target_user_id'))
        obj.targetUserId = ApiClient.convertToType(data['target_user_id'], 'String');
    }
    return obj;
  }
}
 ...
 */
TransferOwnershipRequest.prototype.targetUserId = undefined;
