...
/**
 * The AllOfTMListItemCreatedBy model module.
 * @module model/AllOfTMListItemCreatedBy
 * @version 1.0.0
 */
export default class AllOfTMListItemCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfTMListItemCreatedBy</code>.
   * User who created the threat model
   * @alias module:model/AllOfTMListItemCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfTMListItemCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfTMListItemCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfTMListItemCreatedBy} The populated <code>AllOfTMListItemCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfTMListItemCreatedBy.prototype);
