...
/**
 * The TeamInput model module.
 * @module model/TeamInput
 * @version 1.0.0
 */
export default class TeamInput {
  /**
   * Constructs a new <code>TeamInput</code>.
   * @alias module:model/TeamInput
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>TeamInput</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TeamInput} obj Optional instance to populate.
   * @return {module:model/TeamInput} The populated <code>TeamInput</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TeamInput();
    }
    return obj;
  }
}
