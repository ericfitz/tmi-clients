...
/**
 * The AllOfSurveyListItemCreatedBy model module.
 * @module model/AllOfSurveyListItemCreatedBy
 * @version 1.0.0
 */
export default class AllOfSurveyListItemCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfSurveyListItemCreatedBy</code>.
   * Administrator who created the survey
   * @alias module:model/AllOfSurveyListItemCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfSurveyListItemCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfSurveyListItemCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfSurveyListItemCreatedBy} The populated <code>AllOfSurveyListItemCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      // Create object without calling constructor to avoid required parameter issues
      obj = obj || Object.create(AllOfSurveyListItemCreatedBy.prototype);
