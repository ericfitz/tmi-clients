...
/**
 * The SurveySettings model module.
 * @module model/SurveySettings
 * @version 1.0.0
 */
export default class SurveySettings {
  /**
   * Constructs a new <code>SurveySettings</code>.
   * Configuration settings for a survey
   * @alias module:model/SurveySettings
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>SurveySettings</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SurveySettings} obj Optional instance to populate.
   * @return {module:model/SurveySettings} The populated <code>SurveySettings</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SurveySettings();
      if (data.hasOwnProperty('allow_threat_model_linking'))
        obj.allowThreatModelLinking = ApiClient.convertToType(data['allow_threat_model_linking'], 'Boolean');
    }
    return obj;
  }
}
 ...
 * @member {Boolean} allowThreatModelLinking
 * @default true
 */
SurveySettings.prototype.allowThreatModelLinking = true;
