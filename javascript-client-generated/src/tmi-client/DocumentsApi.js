...
/**
* Documents service.
* @module tmi-client/DocumentsApi
* @version 1.0.0
*/
export default class DocumentsApi {
    ...
    * @alias module:tmi-client/DocumentsApi
    * @class
    ...
    */
     ...
     * @callback moduletmi-client/DocumentsApi~patchThreatModelDocumentCallback
     ...
     * @param {module:tmi-client/DocumentsApi~patchThreatModelDocumentCallback} callback The callback function, accepting three arguments: error, data, response
