...
export default class UsersApi {
    ...
    * @alias module:tmi-client/UsersApi
    * @class
    ...
    */
     ...
     * @callback moduletmi-client/UsersApi~deleteUserAccountCallback
     ...
     * @param {module:tmi-client/UsersApi~deleteUserAccountCallback} callback The callback function, accepting three arguments: error, data, response
