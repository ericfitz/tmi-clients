...
export default class AuthenticationApi {
    ...
    */
     ...
     * @param {String} opts.idp OAuth provider identifier. Defaults to &#x27;tmi&#x27; provider in non-production builds if not specified.
     ...
     * @param {String} opts.loginHint User identity hint for TMI OAuth provider. Allows specifying a desired user identity for testing and automation. Only supported by the TMI provider (ignored by production providers like Google, GitHub, etc.). Must be 3-20 characters, alphanumeric and hyphens only.
     ...
     * @param {module:model/MeClientCredentialsBody} body Client credential creation request
     ...
     */
    createCurrentUserClientCredentialWithHttpInfo(body) {
     ...
     * Create client credential
     * Creates a new OAuth 2.0 client credential for machine-to-machine authentication. The client_secret is ONLY returned once at creation and cannot be retrieved later.
     * @param {<&vendorExtensions.x-jsdoc-type>} body Client credential creation request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ClientCredentialResponse}
     */
    createCurrentUserClientCredential(body) {
      return this.createCurrentUserClientCredentialWithHttpInfo(body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:model/Oauth2TokenBody} body OAuth 2.0 token exchange request parameters
     ...
     * Exchange OAuth credentials for JWT tokens
     * Provider-neutral endpoint to exchange OAuth credentials for TMI JWT tokens. Supports three grant types: (1) authorization_code for OAuth provider flows (Google, GitHub, Microsoft), (2) client_credentials for machine-to-machine authentication (RFC 6749 Section 4.4), and (3) refresh_token for token renewal. Accepts both application/json and application/x-www-form-urlencoded content types.
     * @param {<&vendorExtensions.x-jsdoc-type>} body OAuth 2.0 token exchange request parameters
     ...
     */
    listMyGroupMembersWithHttpInfo(internalUuid, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'internalUuid' is set
      if (internalUuid === undefined || internalUuid === null) {
        throw new Error("Missing the required parameter 'internalUuid' when calling listMyGroupMembers");
      }
     ...
     */
    listMyGroupMembers(internalUuid, opts) {
      return this.listMyGroupMembersWithHttpInfo(internalUuid, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MyGroupListResponse} and HTTP response
     */
    listMyGroupsWithHttpInfo() {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = MyGroupListResponse;
     ...
     * List my groups
     * Returns the TMI-managed groups that the authenticated user belongs to. Returns direct memberships only (excludes the implicit everyone pseudo-group). Each group includes its internal_uuid which can be used to query group members via GET /me/groups/{internal_uuid}/members.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/MyGroupListResponse}
     */
    listMyGroups() {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TokenRefreshRequest} opts.body OAuth 2.0 token refresh request parameters
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AuthTokenResponse} and HTTP response
     */
     ...
     * @param {String} token 
     * @param {module:model/String} tokenTypeHint 
     * @param {String} clientId 
     * @param {String} clientSecret 
     * @param {module:model/TokenRevocationRequest} body Token revocation request per RFC 7009
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
    revokeTokenWithHttpInfo(token, tokenTypeHint, clientId, clientSecret, body) {
      ...
      // verify the required parameter 'tokenTypeHint' is set
      if (tokenTypeHint === undefined || tokenTypeHint === null) {
        throw new Error("Missing the required parameter 'tokenTypeHint' when calling revokeToken");
      }
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling revokeToken");
      }
      // verify the required parameter 'clientSecret' is set
      if (clientSecret === undefined || clientSecret === null) {
        throw new Error("Missing the required parameter 'clientSecret' when calling revokeToken");
      }
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
      ...
      let formParams = {
        'token': token,'token_type_hint': tokenTypeHint,'client_id': clientId,'client_secret': clientSecret
      };
     ...
     * @param {<&vendorExtensions.x-jsdoc-type>} clientId 
     * @param {<&vendorExtensions.x-jsdoc-type>} clientSecret 
     * @param {<&vendorExtensions.x-jsdoc-type>} body Token revocation request per RFC 7009
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object}
     */
    revokeToken(token, tokenTypeHint, clientId, clientSecret, body) {
      return this.revokeTokenWithHttpInfo(token, tokenTypeHint, clientId, clientSecret, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
