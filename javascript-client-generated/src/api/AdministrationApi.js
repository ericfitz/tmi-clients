...
export default class AdministrationApi {
    ...
    */
     ...
     * @param {module:model/CreateAdministratorRequest} body Administrator creation request
     ...
     * Create administrator grant
     * Grants administrator privileges to a user or group for a specific provider. Exactly one of email, provider_user_id, or group_name must be specified.
     * @param {<&vendorExtensions.x-jsdoc-type>} body Administrator creation request
