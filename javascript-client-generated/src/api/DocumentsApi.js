...
export default class DocumentsApi {
    ...
    */
     ...
     * @param {Array.<module:model/JsonPatchDocumentInner>} body JSON Patch operations to apply to the document
     ...
     * Partially update document
     * Apply JSON Patch operations to partially update a document
     * @param {<&vendorExtensions.x-jsdoc-type>} body JSON Patch operations to apply to the document
