...
export default class NotesApi {
    ...
    */
     ...
     * @param {Array.<module:model/JsonPatchDocumentInner>} body JSON Patch operations to apply to the note
     ...
     * Partially update note
     * Apply JSON Patch operations to partially update a note
     * @param {<&vendorExtensions.x-jsdoc-type>} body JSON Patch operations to apply to the note
