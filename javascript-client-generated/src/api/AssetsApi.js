...
export default class AssetsApi {
    ...
    */
     ...
     * @param {Array.<module:model/JsonPatchDocumentInner>} body JSON Patch operations to apply to the asset
     ...
     * Partially update asset
     * Apply JSON Patch operations to partially update a asset
     * @param {<&vendorExtensions.x-jsdoc-type>} body JSON Patch operations to apply to the asset
