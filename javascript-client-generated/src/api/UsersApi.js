...
export default class UsersApi {
    ...
    */
     ...
     */
    transferCurrentUserOwnershipWithHttpInfo(body) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling transferCurrentUserOwnership");
      }
     ...
     */
    transferCurrentUserOwnership(body) {
      return this.transferCurrentUserOwnershipWithHttpInfo(body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
