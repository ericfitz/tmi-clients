...
json = "{}"
# create an instance of DfdDiagramInputAllOfCells from a JSON string
dfd_diagram_input_all_of_cells_instance = DfdDiagramInputAllOfCells.from_json(json)
# print the JSON string representation of the object
print(DfdDiagramInputAllOfCells.to_json())

# convert the object into a dict
dfd_diagram_input_all_of_cells_dict = dfd_diagram_input_all_of_cells_instance.to_dict()
# create an instance of DfdDiagramInputAllOfCells from a dict
dfd_diagram_input_all_of_cells_from_dict = DfdDiagramInputAllOfCells.from_dict(dfd_diagram_input_all_of_cells_dict)
```
