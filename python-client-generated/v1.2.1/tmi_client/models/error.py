...
class Error(BaseModel):
    ...
    error_description: Annotated[str, Field(strict=True, max_length=1000)] = Field(
        description="Human-readable error description"
    )
    error_uri: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(
        default=None, description="URI to documentation about the error"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "details": ErrorDetails.from_dict(obj["details"])
