...
class ApiInfoApi(BaseModel):
    """
    ApiInfoApi
    """  # noqa: E501

    version: Annotated[str, Field(strict=True, max_length=32)] = Field(
        description="API version"
    )
    specification: Annotated[str, Field(strict=True, max_length=1000)] = Field(
    ...
    def version_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$", value):
            raise ValueError(
                r"must validate the regular expression /^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$/"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"version": obj.get("version"), "specification": obj.get("specification")}
        )
        return _obj
