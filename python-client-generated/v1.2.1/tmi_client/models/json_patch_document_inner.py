...
class JsonPatchDocumentInner(BaseModel):
    ...
    """ # noqa: E501
    op: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="Patch operation type")
    path: Annotated[str, Field(strict=True, max_length=512)] = Field(description="JSON path to target")
