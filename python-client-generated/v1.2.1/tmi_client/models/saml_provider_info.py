...
class SAMLProviderInfo(BaseModel):
    ...
    metadata_url: Annotated[str, Field(strict=True, max_length=1024)] = Field(
        description="SAML service provider metadata URL"
    )
    entity_id: Annotated[str, Field(strict=True, max_length=1000)] = Field(
        description="Service Provider entity ID"
    )
    acs_url: Annotated[str, Field(strict=True, max_length=1024)] = Field(
        description="Assertion Consumer Service URL"
    )
    slo_url: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(
        default=None, description="Single Logout URL"
    )
