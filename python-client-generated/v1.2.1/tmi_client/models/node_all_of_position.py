...
class NodeAllOfPosition(BaseModel):
    """
    Node position in X6 nested format. Use either this with size object OR use flat x/y/width/height properties.
    """  # noqa: E501

    x: Union[StrictFloat, StrictInt] = Field(description="X coordinate")
    y: Union[StrictFloat, StrictInt] = Field(description="Y coordinate")
