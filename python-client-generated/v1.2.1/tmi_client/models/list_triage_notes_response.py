...
class ListTriageNotesResponse(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in triage_notes (list)
        _items = []
        if self.triage_notes:
            for _item_triage_notes in self.triage_notes:
                if _item_triage_notes:
                    _items.append(_item_triage_notes.to_dict())
            _dict['triage_notes'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "triage_notes": [TriageNoteListItem.from_dict(_item) for _item in obj["triage_notes"]] if obj.get("triage_notes") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
