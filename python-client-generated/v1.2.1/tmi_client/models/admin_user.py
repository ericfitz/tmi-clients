...
class AdminUser(BaseModel):
    ...
    is_admin: Optional[StrictBool] = Field(default=None, description="Whether the user has administrator privileges (enriched)")
    groups: Optional[Annotated[List[StrictStr], Field(max_length=100)]] = Field(default=None, description="List of group names the user belongs to (enriched)")
    ...
    __properties: ClassVar[List[str]] = ["internal_uuid", "provider", "provider_user_id", "email", "name", "email_verified", "created_at", "modified_at", "last_login", "is_admin", "groups", "active_threat_models"]
