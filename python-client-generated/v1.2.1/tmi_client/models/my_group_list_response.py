...
class MyGroupListResponse(BaseModel):
    ...
    """ # noqa: E501
    groups: Annotated[List[UserGroupMembership], Field(max_length=100)] = Field(description="List of groups the user is a direct member of")
    total: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of groups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [UserGroupMembership.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "total": obj.get("total")
        })
        return _obj
