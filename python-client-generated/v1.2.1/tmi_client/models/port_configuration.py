...
class PortConfiguration(BaseModel):
    ...
    """ # noqa: E501
    groups: Optional[Dict[str, PortConfigurationGroupsValue]] = Field(default=None, description="Port group definitions")
    items: Optional[Annotated[List[PortConfigurationItemsInner], Field(max_length=1000)]] = Field(default=None, description="Individual port instances")
    __properties: ClassVar[List[str]] = ["groups", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": dict(
                (_k, PortConfigurationGroupsValue.from_dict(_v))
                for _k, _v in obj["groups"].items()
            )
            if obj.get("groups") is not None
            else None,
            "items": [PortConfigurationItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
