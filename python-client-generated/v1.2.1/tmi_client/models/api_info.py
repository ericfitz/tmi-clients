...
class ApiInfo(BaseModel):
    ...
    api: ApiInfoApi
    operator: Optional[ApiInfoOperator] = None
    health: Optional[ApiInfoHealth] = None
    __properties: ClassVar[List[str]] = ["status", "service", "api", "operator", "health"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": ApiInfoStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
            "service": ApiInfoService.from_dict(obj["service"]) if obj.get("service") is not None else None,
            "api": ApiInfoApi.from_dict(obj["api"]) if obj.get("api") is not None else None,
            "operator": ApiInfoOperator.from_dict(obj["operator"]) if obj.get("operator") is not None else None,
            "health": ApiInfoHealth.from_dict(obj["health"]) if obj.get("health") is not None else None
        })
        return _obj
