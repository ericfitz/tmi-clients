...
class ApiInfo(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "status": ApiInfoStatus.from_dict(obj["status"])
                if obj.get("status") is not None
                else None,
                "service": ApiInfoService.from_dict(obj["service"])
                if obj.get("service") is not None
                else None,
                "api": ApiInfoApi.from_dict(obj["api"])
                if obj.get("api") is not None
                else None,
                "operator": ApiInfoOperator.from_dict(obj["operator"])
                if obj.get("operator") is not None
                else None,
                "health": ApiInfoHealth.from_dict(obj["health"])
