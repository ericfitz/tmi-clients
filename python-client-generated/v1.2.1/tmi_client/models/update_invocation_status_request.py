...
class UpdateInvocationStatusRequest(BaseModel):
    """
    Request to update the status of an async addon invocation
    """ # noqa: E501
    status: StrictStr = Field(description="New status (cannot transition back to pending)")
    status_percent: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(default=None, description="Progress percentage")
    status_message: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="Optional status description")
