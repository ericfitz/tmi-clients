...
class CreateThreatModelFromSurveyResponse(BaseModel):
    """
    Response after creating a threat model from a survey response
    """  # noqa: E501

    threat_model_id: UUID = Field(description="ID of the newly created threat model")
    survey_response_id: UUID = Field(description="ID of the source survey response")
    __properties: ClassVar[List[str]] = ["threat_model_id", "survey_response_id"]
