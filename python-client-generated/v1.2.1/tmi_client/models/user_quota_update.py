...
class UserQuotaUpdate(BaseModel):
    ...
    max_requests_per_minute: Annotated[int, Field(le=10000, strict=True, ge=1)] = Field(
        description="Maximum API requests per minute"
    )
    max_requests_per_hour: Optional[
        Annotated[int, Field(le=600000, strict=True, ge=1)]
    ] = Field(default=None, description="Maximum API requests per hour (optional)")
