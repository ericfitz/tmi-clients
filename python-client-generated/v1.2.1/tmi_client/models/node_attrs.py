...
class NodeAttrs(BaseModel):
    ...
    """ # noqa: E501
    body: Optional[NodeAttrsBody] = None
    text: Optional[NodeAttrsText] = None
    __properties: ClassVar[List[str]] = ["body", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": NodeAttrsBody.from_dict(obj["body"]) if obj.get("body") is not None else None,
            "text": NodeAttrsText.from_dict(obj["text"]) if obj.get("text") is not None else None
        })
        return _obj
