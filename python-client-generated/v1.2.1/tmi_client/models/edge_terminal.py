...
class EdgeTerminal(BaseModel):
    """
    Connection point for an edge (source or target)
    """  # noqa: E501

    cell: UUID = Field(description="ID of the connected node (UUID)")
    port: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(
        default=None, description="ID of the specific port on the node (optional)"
    )
    __properties: ClassVar[List[str]] = ["cell", "port"]

    @field_validator("cell")
    def cell_validate_regular_expression(cls, value):
    ...
    def port_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"cell": obj.get("cell"), "port": obj.get("port")})
        return _obj
