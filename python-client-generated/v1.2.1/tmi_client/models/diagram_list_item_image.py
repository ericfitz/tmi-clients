...
class DiagramListItemImage(BaseModel):
    """
    Image data with version information for thumbnail rendering
    """ # noqa: E501
    svg: Optional[Union[Annotated[bytes, Field(strict=True, max_length=102400)], Annotated[str, Field(strict=True, max_length=102400)]]] = Field(default=None, description="BASE64 encoded SVG representation of the diagram, used for thumbnails and reports")
    update_vector: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Version of the diagram when this SVG was generated")
