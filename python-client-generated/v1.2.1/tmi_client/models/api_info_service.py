...
class ApiInfoService(BaseModel):
    """
    ApiInfoService
    """  # noqa: E501
    ...
    build: Annotated[str, Field(strict=True, max_length=32)] = Field(
    ...
    def build_validate_regular_expression(cls, value):
        ...
        value = value.isoformat() if hasattr(value, "isoformat") else str(value)
        if not re.match(
            r"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}(-[a-zA-Z0-9]{7})?$", value
        ):
            raise ValueError(
                r"must validate the regular expression /^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}(-[a-zA-Z0-9]{7})?$/"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "build": obj.get("build")})
        return _obj
