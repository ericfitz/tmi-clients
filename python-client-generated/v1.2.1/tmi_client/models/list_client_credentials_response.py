...
class ListClientCredentialsResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credentials": [ClientCredentialInfo.from_dict(_item) for _item in obj["credentials"]] if obj.get("credentials") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
