...
class GetProviderGroups200Response(BaseModel):
    """
    GetProviderGroups200Response
    """  # noqa: E501

    idp: Annotated[str, Field(strict=True, max_length=100)] = Field(
        description="Identity provider ID"
    )
    groups: Annotated[
        List[GetProviderGroups200ResponseGroupsInner], Field(max_length=1000)
    ]
        ...
        _obj = cls.model_validate(
            {
                "idp": obj.get("idp"),
                "groups": [
                    GetProviderGroups200ResponseGroupsInner.from_dict(_item)
