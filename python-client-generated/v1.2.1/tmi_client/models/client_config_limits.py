...
class ClientConfigLimits(BaseModel):
    ...
    max_file_upload_mb: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = (
        Field(default=None, description="Maximum file upload size in megabytes")
    )
    max_diagram_participants: Optional[
        Annotated[int, Field(le=100, strict=True, ge=1)]
    ] = Field(
        default=None, description="Maximum participants per collaboration session"
    )
