...
class ClientConfigLimits(BaseModel):
    """
    System limits and quotas
    """ # noqa: E501
    max_file_upload_mb: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=None, description="Maximum file upload size in megabytes")
    max_diagram_participants: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=None, description="Maximum participants per collaboration session")
    __properties: ClassVar[List[str]] = ["max_file_upload_mb", "max_diagram_participants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max_file_upload_mb": obj.get("max_file_upload_mb"),
            "max_diagram_participants": obj.get("max_diagram_participants")
        })
        return _obj
