...
class NodeAllOfSize(BaseModel):
    """
    Node size in X6 nested format. Use either this with position object OR use flat x/y/width/height properties.
    """ # noqa: E501
    width: Union[Annotated[float, Field(strict=True, ge=40)], Annotated[int, Field(strict=True, ge=40)]] = Field(description="Width in pixels")
    height: Union[Annotated[float, Field(strict=True, ge=30)], Annotated[int, Field(strict=True, ge=30)]] = Field(description="Height in pixels")
