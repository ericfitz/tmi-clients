...
class InvokeAddonResponse(BaseModel):
    """
    Response from addon invocation including result or invocation ID
    """  # noqa: E501

    invocation_id: UUID = Field(description="Invocation identifier for tracking")
    status: StrictStr = Field(description="Current invocation status")
    created_at: datetime = Field(description="Invocation creation timestamp")
    __properties: ClassVar[List[str]] = ["invocation_id", "status", "created_at"]
