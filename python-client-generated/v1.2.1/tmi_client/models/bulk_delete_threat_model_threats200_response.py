...
class BulkDeleteThreatModelThreats200Response(BaseModel):
    """
    BulkDeleteThreatModelThreats200Response
    """  # noqa: E501

    deleted_count: Optional[StrictInt] = Field(
        default=None, description="Number of threats deleted"
    )
    deleted_ids: Optional[Annotated[List[UUID], Field(max_length=1000)]] = Field(
        default=None, description="IDs of deleted threats"
    )
