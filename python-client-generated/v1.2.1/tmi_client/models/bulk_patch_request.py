...
class BulkPatchRequest(BaseModel):
    ...
    """ # noqa: E501
    patches: Annotated[List[BulkPatchRequestPatchesInner], Field(min_length=1, max_length=20)] = Field(description="Array of patch operations, each targeting a specific threat by ID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patches": [BulkPatchRequestPatchesInner.from_dict(_item) for _item in obj["patches"]] if obj.get("patches") is not None else None
        })
        return _obj
