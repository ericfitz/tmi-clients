...
class ThreatBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "mitigation", "diagram_id", "cell_id", "severity", "score", "priority", "mitigated", "status", "threat_type", "metadata", "issue_uri", "asset_id", "cwe_id", "cvss", "include_in_report"]
