...
class ListAddonsResponse(BaseModel):
    ...
    addons: Annotated[List[AddonResponse], Field(max_length=1000)]
    total: StrictInt = Field(description="Total number of add-ons matching criteria")
    limit: StrictInt = Field(description="Pagination limit")
    offset: StrictInt = Field(description="Pagination offset")
    __properties: ClassVar[List[str]] = ["addons", "total", "limit", "offset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "addons": [AddonResponse.from_dict(_item) for _item in obj["addons"]]
                if obj.get("addons") is not None
                else None,
                "total": obj.get("total"),
                "limit": obj.get("limit"),
