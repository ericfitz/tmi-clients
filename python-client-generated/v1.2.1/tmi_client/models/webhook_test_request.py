...
class WebhookTestRequest(BaseModel):
    ...
    def event_type_validate_enum(cls, value):
        ...
        if value not in set(['threat_model.created', 'threat_model.updated', 'threat_model.deleted', 'diagram.created', 'diagram.updated', 'diagram.deleted', 'document.created', 'document.updated', 'document.deleted', 'note.created', 'note.updated', 'note.deleted', 'repository.created', 'repository.updated', 'repository.deleted', 'asset.created', 'asset.updated', 'asset.deleted', 'threat.created', 'threat.updated', 'threat.deleted', 'metadata.created', 'metadata.updated', 'metadata.deleted']):
            raise ValueError("must be one of enum values ('threat_model.created', 'threat_model.updated', 'threat_model.deleted', 'diagram.created', 'diagram.updated', 'diagram.deleted', 'document.created', 'document.updated', 'document.deleted', 'note.created', 'note.updated', 'note.deleted', 'repository.created', 'repository.updated', 'repository.deleted', 'asset.created', 'asset.updated', 'asset.deleted', 'threat.created', 'threat.updated', 'threat.deleted', 'metadata.created', 'metadata.updated', 'metadata.deleted')")
        return value
