...
class GroupMemberListResponse(BaseModel):
    ...
    members: Annotated[List[GroupMember], Field(max_length=1000)]
    total: StrictInt = Field(description="Total number of members in the group")
    ...
    __properties: ClassVar[List[str]] = ["members", "total", "limit", "offset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "members": [GroupMember.from_dict(_item) for _item in obj["members"]]
