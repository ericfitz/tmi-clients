...
class ListDocumentsResponse(BaseModel):
    ...
    documents: Annotated[List[Document], Field(max_length=1000)]
    total: StrictInt = Field(description="Total number of documents matching criteria")
    limit: StrictInt = Field(description="Pagination limit")
    offset: StrictInt = Field(description="Pagination offset")
    __properties: ClassVar[List[str]] = ["documents", "total", "limit", "offset"]
