...
class ApiInfoStatus(BaseModel):
    ...
    ApiInfoStatus
    """ # noqa: E501
    code: Annotated[str, Field(strict=True, max_length=512)] = Field(description="Status code indicating system health: OK (all components healthy), DEGRADED (server up but database or Redis unhealthy), ERROR (critical failure)")
