...
class ListThreatModelsResponse(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in threat_models (list)
        _items = []
        if self.threat_models:
            for _item_threat_models in self.threat_models:
                if _item_threat_models:
                    _items.append(_item_threat_models.to_dict())
            _dict['threat_models'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "threat_models": [TMListItem.from_dict(_item) for _item in obj["threat_models"]] if obj.get("threat_models") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
