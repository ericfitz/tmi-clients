...
class InvocationResponse(BaseModel):
    ...
    addon_id: UUID = Field(description="Add-on that was invoked")
    threat_model_id: UUID = Field(description="Threat model context")
    object_type: Optional[StrictStr] = Field(default=None, description="Object type (if specified)")
    object_id: Optional[UUID] = Field(default=None, description="Object ID (if specified)")
    invoked_by: User = Field(description="User who triggered the invocation")
    payload: Optional[StrictStr] = Field(default=None, description="JSON-encoded payload")
    status: StrictStr = Field(description="Current status")
    status_percent: Annotated[int, Field(le=100, strict=True, ge=0)] = Field(description="Progress percentage (0-100)")
    status_message: Optional[StrictStr] = Field(default=None, description="Optional status description")
    created_at: datetime = Field(description="Creation timestamp")
    status_updated_at: datetime = Field(description="Last status update timestamp")
    __properties: ClassVar[List[str]] = ["id", "addon_id", "threat_model_id", "object_type", "object_id", "invoked_by", "payload", "status", "status_percent", "status_message", "created_at", "status_updated_at"]
