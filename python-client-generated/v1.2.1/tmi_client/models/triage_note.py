...
class TriageNote(BaseModel):
    ...
    content: Annotated[str, Field(min_length=1, strict=True, max_length=32768)] = Field(
    ...
    created_by: Optional[Dict[str, Any]] = Field(
        default=None, description="User who created this triage note"
    )
    modified_at: Optional[datetime] = Field(
        default=None, description="Last modification timestamp (RFC3339)"
    )
    modified_by: Optional[Dict[str, Any]] = Field(
        default=None, description="User who last modified this triage note"
    )
