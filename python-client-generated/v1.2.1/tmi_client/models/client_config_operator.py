...
class ClientConfigOperator(BaseModel):
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="Name of the service operator"
    )
    contact: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(
        default=None, description="Contact information for the operator"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"name": obj.get("name"), "contact": obj.get("contact")}
        )
        return _obj
