...
class RepositoriesApi:
    ...
    @validate_call
    def patch_threat_model_repository(
        self,
        ...
        json_patch_document_inner: Annotated[List[JsonPatchDocumentInner], Field(max_length=1000, description="JSON Patch operations to apply to the repository")],
        ...
        :param json_patch_document_inner: JSON Patch operations to apply to the repository (required)
        ...
        _param = self._patch_threat_model_repository_serialize(
    ...
    @validate_call
    def patch_threat_model_repository_with_http_info(
        self,
        threat_model_id: Annotated[UUID, Field(description="Threat model identifier")],
        repository_id: Annotated[UUID, Field(description="Repository identifier")],
        json_patch_document_inner: Annotated[List[JsonPatchDocumentInner], Field(max_length=1000, description="JSON Patch operations to apply to the repository")],
    ...
    @validate_call
    def patch_threat_model_repository_without_preload_content(
        self,
        threat_model_id: Annotated[UUID, Field(description="Threat model identifier")],
        repository_id: Annotated[UUID, Field(description="Repository identifier")],
        json_patch_document_inner: Annotated[List[JsonPatchDocumentInner], Field(max_length=1000, description="JSON Patch operations to apply to the repository")],
    ...
    def _patch_threat_model_repository_serialize(
        self,
        threat_model_id,
        repository_id,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/threat_models/{threat_model_id}/repositories/{repository_id}',
