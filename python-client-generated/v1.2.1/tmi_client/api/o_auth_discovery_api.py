...
class OAuthDiscoveryApi:
    ...
    @validate_call
    def get_o_auth_protected_resource_metadata(
        self,
        ...
        _param = self._get_o_auth_protected_resource_metadata_serialize(
    ...
    @validate_call
    def get_o_auth_protected_resource_metadata_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OAuthProtectedResourceMetadata]:
        """OAuth 2.0 Protected Resource Metadata
    ...
    @validate_call
    def get_o_auth_protected_resource_metadata_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_o_auth_protected_resource_metadata_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
