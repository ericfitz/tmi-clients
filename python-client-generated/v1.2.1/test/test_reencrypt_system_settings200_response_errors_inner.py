...
class TestReencryptSystemSettings200ResponseErrorsInner(unittest.TestCase):
    """ReencryptSystemSettings200ResponseErrorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        ...
        # uncomment below to create an instance of `ReencryptSystemSettings200ResponseErrorsInner`
        """
        model = ReencryptSystemSettings200ResponseErrorsInner()
        if include_optional:
            return ReencryptSystemSettings200ResponseErrorsInner(
                key = '',
                error = ''
            )
        else:
    ...
    def testReencryptSystemSettings200ResponseErrorsInner(self):
        """Test ReencryptSystemSettings200ResponseErrorsInner"""
