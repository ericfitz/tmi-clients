...
class TestEdgeLabelPositionOneOfOptions(unittest.TestCase):
    """EdgeLabelPositionOneOfOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test EdgeLabelPositionOneOfOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EdgeLabelPositionOneOfOptions`
        """
        model = EdgeLabelPositionOneOfOptions()
        if include_optional:
            return EdgeLabelPositionOneOfOptions(
    ...
    def testEdgeLabelPositionOneOfOptions(self):
        """Test EdgeLabelPositionOneOfOptions"""
