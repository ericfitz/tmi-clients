...
class TestTransferOwnershipResultThreatModelsTransferred(unittest.TestCase):
    """TransferOwnershipResultThreatModelsTransferred unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test TransferOwnershipResultThreatModelsTransferred
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TransferOwnershipResultThreatModelsTransferred`
        """
        model = TransferOwnershipResultThreatModelsTransferred()
        if include_optional:
            return TransferOwnershipResultThreatModelsTransferred(
                count = 0,
                threat_model_ids = [
                    ''
                    ]
    ...
    def testTransferOwnershipResultThreatModelsTransferred(self):
        """Test TransferOwnershipResultThreatModelsTransferred"""
