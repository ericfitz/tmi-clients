...
class TestUpdateInvocationStatusRequest(unittest.TestCase):
    """UpdateInvocationStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test UpdateInvocationStatusRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateInvocationStatusRequest`
        """
        model = UpdateInvocationStatusRequest()
        if include_optional:
            return UpdateInvocationStatusRequest(
                status = 'in_progress',
                status_percent = 0,
                status_message = ''
            )
    ...
    def testUpdateInvocationStatusRequest(self):
        """Test UpdateInvocationStatusRequest"""
