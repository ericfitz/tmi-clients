...
class TestEdgeLabelAttrsText(unittest.TestCase):
    """EdgeLabelAttrsText unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeLabelAttrsText:
        """Test EdgeLabelAttrsText
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeLabelAttrsText`
        """
        model = EdgeLabelAttrsText()
        if include_optional:
            return EdgeLabelAttrsText(
    ...
    def testEdgeLabelAttrsText(self):
        """Test EdgeLabelAttrsText"""
