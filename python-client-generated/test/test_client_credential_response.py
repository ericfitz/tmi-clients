...
class TestClientCredentialResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClientCredentialResponse:
        """Test ClientCredentialResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientCredentialResponse`
        """
        model = ClientCredentialResponse()
        if include_optional:
