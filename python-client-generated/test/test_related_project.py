...
class TestRelatedProject(unittest.TestCase):
    """RelatedProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedProject:
        """Test RelatedProject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedProject`
        """
        model = RelatedProject()
        if include_optional:
            return RelatedProject(
                related_project_id = '62ECB020-8429-30cc-01FF-CCfeEe150AC3',
                relationship = 'parent',
                custom_relationship = 'jUR,rZ#UM/?R,Fp^l6$ARj'
            )
        else:
            return RelatedProject(
                related_project_id = '62ECB020-8429-30cc-01FF-CCfeEe150AC3',
