...
class TestClientConfigFeatures(unittest.TestCase):
    """ClientConfigFeatures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientConfigFeatures:
        """Test ClientConfigFeatures
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientConfigFeatures`
        """
        model = ClientConfigFeatures()
        if include_optional:
            return ClientConfigFeatures(
    ...
    def testClientConfigFeatures(self):
        """Test ClientConfigFeatures"""
