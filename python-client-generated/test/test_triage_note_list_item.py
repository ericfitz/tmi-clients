...
class TestTriageNoteListItem(unittest.TestCase):
    """TriageNoteListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriageNoteListItem:
        """Test TriageNoteListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriageNoteListItem`
        """
        model = TriageNoteListItem()
        if include_optional:
            return TriageNoteListItem(
                id = 1,
    ...
    def testTriageNoteListItem(self):
        """Test TriageNoteListItem"""
