...
class TestTriageNoteBase(unittest.TestCase):
    """TriageNoteBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriageNoteBase:
        """Test TriageNoteBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriageNoteBase`
        """
        model = TriageNoteBase()
        if include_optional:
            return TriageNoteBase(
