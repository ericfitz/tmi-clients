...
class TestEdgeConnectorOneOfArgs(unittest.TestCase):
    """EdgeConnectorOneOfArgs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeConnectorOneOfArgs:
        """Test EdgeConnectorOneOfArgs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeConnectorOneOfArgs`
        """
        model = EdgeConnectorOneOfArgs()
        if include_optional:
            return EdgeConnectorOneOfArgs(
                radius = 1.337,
                precision = 1.337,
                size = 1.337,
                jump = 'arc'
    ...
    def testEdgeConnectorOneOfArgs(self):
        """Test EdgeConnectorOneOfArgs"""
