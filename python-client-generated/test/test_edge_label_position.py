...
class TestEdgeLabelPosition(unittest.TestCase):
    """EdgeLabelPosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeLabelPosition:
        """Test EdgeLabelPosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeLabelPosition`
        """
        model = EdgeLabelPosition()
        if include_optional:
    ...
    def testEdgeLabelPosition(self):
        """Test EdgeLabelPosition"""
