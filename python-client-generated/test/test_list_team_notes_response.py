...
class TestListTeamNotesResponse(unittest.TestCase):
    """ListTeamNotesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTeamNotesResponse:
        """Test ListTeamNotesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTeamNotesResponse`
        """
        model = ListTeamNotesResponse()
        if include_optional:
    ...
    def testListTeamNotesResponse(self):
        """Test ListTeamNotesResponse"""
