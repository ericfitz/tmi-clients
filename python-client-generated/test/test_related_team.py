...
class TestRelatedTeam(unittest.TestCase):
    """RelatedTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedTeam:
        """Test RelatedTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedTeam`
        """
        model = RelatedTeam()
        if include_optional:
            return RelatedTeam(
                related_team_id = '62ECB020-8429-30cc-01FF-CCfeEe150AC3',
                relationship = 'parent',
