...
class TestSurveyResponseBase(unittest.TestCase):
    """SurveyResponseBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SurveyResponseBase:
        """Test SurveyResponseBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SurveyResponseBase`
        """
        model = SurveyResponseBase()
        if include_optional:
    ...
    def testSurveyResponseBase(self):
        """Test SurveyResponseBase"""
