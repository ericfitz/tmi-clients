...
class TestTeamProjectNoteBase(unittest.TestCase):
    """TeamProjectNoteBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamProjectNoteBase:
        """Test TeamProjectNoteBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamProjectNoteBase`
        """
        model = TeamProjectNoteBase()
        if include_optional:
            return TeamProjectNoteBase(
...
Findings from the quarterly review.',
    ...
    def testTeamProjectNoteBase(self):
        """Test TeamProjectNoteBase"""
