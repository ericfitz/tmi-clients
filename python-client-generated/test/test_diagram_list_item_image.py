...
class TestDiagramListItemImage(unittest.TestCase):
    """DiagramListItemImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiagramListItemImage:
        """Test DiagramListItemImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiagramListItemImage`
        """
        model = DiagramListItemImage()
        if include_optional:
            return DiagramListItemImage(
                svg = 'YQ==',
                update_vector = 0
            )
        else:
    ...
    def testDiagramListItemImage(self):
        """Test DiagramListItemImage"""
