...
class TestUserWithAdminStatus(unittest.TestCase):
    """UserWithAdminStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserWithAdminStatus:
        """Test UserWithAdminStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserWithAdminStatus`
        """
        model = UserWithAdminStatus()
        if include_optional:
    ...
    def testUserWithAdminStatus(self):
        """Test UserWithAdminStatus"""
