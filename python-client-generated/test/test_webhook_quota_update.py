...
class TestWebhookQuotaUpdate(unittest.TestCase):
    """WebhookQuotaUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookQuotaUpdate:
        """Test WebhookQuotaUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookQuotaUpdate`
        """
        model = WebhookQuotaUpdate()
        if include_optional:
            return WebhookQuotaUpdate(
                max_subscriptions = 5,
    ...
    def testWebhookQuotaUpdate(self):
        """Test WebhookQuotaUpdate"""
