...
class TestCreateDiagramRequest(unittest.TestCase):
    """CreateDiagramRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDiagramRequest:
        """Test CreateDiagramRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDiagramRequest`
        """
        model = CreateDiagramRequest()
        if include_optional:
            return CreateDiagramRequest(
    ...
    def testCreateDiagramRequest(self):
        """Test CreateDiagramRequest"""
