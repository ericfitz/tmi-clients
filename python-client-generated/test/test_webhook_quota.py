...
class TestWebhookQuota(unittest.TestCase):
    """WebhookQuota unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookQuota:
        """Test WebhookQuota
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookQuota`
        """
        model = WebhookQuota()
        if include_optional:
            return WebhookQuota(
                ...
                max_subscription_requests_per_minute = 1,
                max_subscription_requests_per_day = 1,
