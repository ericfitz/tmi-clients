...
class TestAddonInvocationQuota(unittest.TestCase):
    """AddonInvocationQuota unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddonInvocationQuota:
        """Test AddonInvocationQuota
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddonInvocationQuota`
        """
        model = AddonInvocationQuota()
        if include_optional:
    ...
    def testAddonInvocationQuota(self):
        """Test AddonInvocationQuota"""
