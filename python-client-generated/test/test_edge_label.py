...
class TestEdgeLabel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EdgeLabel:
        """Test EdgeLabel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeLabel`
        """
        model = EdgeLabel()
        if include_optional:
            return EdgeLabel(
                attrs = tmi_client.models.edge_label_attrs.EdgeLabel_attrs(
