...
class TestListTimmyMessagesResponse(unittest.TestCase):
    """ListTimmyMessagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTimmyMessagesResponse:
        """Test ListTimmyMessagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTimmyMessagesResponse`
        """
        model = ListTimmyMessagesResponse()
        if include_optional:
            return ListTimmyMessagesResponse(
                messages = [
                    tmi_client.models.timmy_chat_message.TimmyChatMessage(
                        id = '62ECB020-8429-30cc-01FF-CCfeEe150AC3', 
                        session_id = '62ECB020-8429-30cc-01FF-CCfeEe150AC3', 
                        role = 'user', 
                        content = 'jUR,rZ#UM/?R,Fp^l6$ARj', 
                        token_count = 56, 
                        sequence = 56, 
    ...
    def testListTimmyMessagesResponse(self):
        """Test ListTimmyMessagesResponse"""
