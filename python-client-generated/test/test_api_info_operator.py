...
class TestApiInfoOperator(unittest.TestCase):
    """ApiInfoOperator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiInfoOperator:
        """Test ApiInfoOperator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiInfoOperator`
        """
        model = ApiInfoOperator()
        if include_optional:
            return ApiInfoOperator(
                name = 'jUR,rZ#UM/?R,Fp^l6$ARj',
                contact = 'jUR,rZ#UM/?R,Fp^l6$ARj'
            )
        else:
            return ApiInfoOperator(
                name = 'jUR,rZ#UM/?R,Fp^l6$ARj',
