...
class TestEdgeConnectorOneOf(unittest.TestCase):
    """EdgeConnectorOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeConnectorOneOf:
        """Test EdgeConnectorOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeConnectorOneOf`
        """
        model = EdgeConnectorOneOf()
        if include_optional:
            return EdgeConnectorOneOf(
                name = 'normal',
                args = { }
            )
        else:
    ...
    def testEdgeConnectorOneOf(self):
        """Test EdgeConnectorOneOf"""
