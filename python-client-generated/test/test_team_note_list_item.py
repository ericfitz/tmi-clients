...
class TestTeamNoteListItem(unittest.TestCase):
    """TeamNoteListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamNoteListItem:
        """Test TeamNoteListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamNoteListItem`
        """
        model = TeamNoteListItem()
        if include_optional:
