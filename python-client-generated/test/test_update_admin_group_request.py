...
class TestUpdateAdminGroupRequest(unittest.TestCase):
    """UpdateAdminGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAdminGroupRequest:
        """Test UpdateAdminGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAdminGroupRequest`
        """
        model = UpdateAdminGroupRequest()
        if include_optional:
            return UpdateAdminGroupRequest(
                name = '0',
                description = ''
            )
        else:
    ...
    def testUpdateAdminGroupRequest(self):
        """Test UpdateAdminGroupRequest"""
