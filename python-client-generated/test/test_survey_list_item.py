...
class TestSurveyListItem(unittest.TestCase):
    """SurveyListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SurveyListItem:
        """Test SurveyListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SurveyListItem`
        """
        model = SurveyListItem()
        if include_optional:
