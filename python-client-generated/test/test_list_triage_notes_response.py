...
class TestListTriageNotesResponse(unittest.TestCase):
    """ListTriageNotesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTriageNotesResponse:
        """Test ListTriageNotesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTriageNotesResponse`
        """
        model = ListTriageNotesResponse()
        if include_optional:
    ...
    def testListTriageNotesResponse(self):
        """Test ListTriageNotesResponse"""
