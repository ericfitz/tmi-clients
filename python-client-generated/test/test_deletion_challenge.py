...
class TestDeletionChallenge(unittest.TestCase):
    """DeletionChallenge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeletionChallenge:
        """Test DeletionChallenge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletionChallenge`
        """
        model = DeletionChallenge()
        if include_optional:
            return DeletionChallenge(
                challenge_text = 'jUR,rZ#UM/?R,Fp^l6$ARj',
    ...
    def testDeletionChallenge(self):
        """Test DeletionChallenge"""
