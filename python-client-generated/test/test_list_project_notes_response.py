...
class TestListProjectNotesResponse(unittest.TestCase):
    """ListProjectNotesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListProjectNotesResponse:
        """Test ListProjectNotesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListProjectNotesResponse`
        """
        model = ListProjectNotesResponse()
        if include_optional:
    ...
    def testListProjectNotesResponse(self):
        """Test ListProjectNotesResponse"""
