...
class TestDiagramListItem(unittest.TestCase):
    """DiagramListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiagramListItem:
        """Test DiagramListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiagramListItem`
        """
        model = DiagramListItem()
        if include_optional:
