...
class TestEdgeLabelAttrs(unittest.TestCase):
    """EdgeLabelAttrs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeLabelAttrs:
        """Test EdgeLabelAttrs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeLabelAttrs`
        """
        model = EdgeLabelAttrs()
        if include_optional:
            return EdgeLabelAttrs(
                text = tmi_client.models.edge_label_attrs_text.EdgeLabel_attrs_text(
                    font_size = 1, 
                    fill = 'rgb(                            072888001528021798096225500850762068629                                                                                     , 333975650685139102691291732729478601482026509127275504175770192981628648829166332287705219                                                    ,                                                              16                                          )', 
