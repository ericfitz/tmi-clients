...
class TestTriageNoteInput(unittest.TestCase):
    """TriageNoteInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriageNoteInput:
        """Test TriageNoteInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriageNoteInput`
        """
        model = TriageNoteInput()
        if include_optional:
            return TriageNoteInput(
