...
class TestApiInfoService(unittest.TestCase):
    """ApiInfoService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiInfoService:
        """Test ApiInfoService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiInfoService`
        """
        model = ApiInfoService()
        if include_optional:
            return ApiInfoService(
                name = 'jUR,rZ#UM/?R,Fp^l6$ARj',
                build = '480.288.001-Y864DZt'
            )
        else:
            return ApiInfoService(
                name = 'jUR,rZ#UM/?R,Fp^l6$ARj',
