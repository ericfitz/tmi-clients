...
class TestBaseDiagramImage(unittest.TestCase):
    """BaseDiagramImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseDiagramImage:
        """Test BaseDiagramImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseDiagramImage`
        """
        model = BaseDiagramImage()
        if include_optional:
            return BaseDiagramImage(
                svg = 'YQ==',
                update_vector = 0
            )
        else:
