...
class TestTimmyStatusResponse(unittest.TestCase):
    """TimmyStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimmyStatusResponse:
        """Test TimmyStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimmyStatusResponse`
        """
        model = TimmyStatusResponse()
        if include_optional:
            return TimmyStatusResponse(
                memory_used_bytes = 56,
                memory_budget_bytes = 56,
                memory_utilization_pct = 1.337,
                loaded_indexes = 56,
                active_sessions = 56,
                evictions_total = 56,
                evictions_pressure = 56,
                sessions_rejected_total = 56
            )
        else:
            return TimmyStatusResponse(
                memory_used_bytes = 56,
    ...
    def testTimmyStatusResponse(self):
        """Test TimmyStatusResponse"""
