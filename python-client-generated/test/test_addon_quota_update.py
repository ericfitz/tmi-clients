...
class TestAddonQuotaUpdate(unittest.TestCase):
    """AddonQuotaUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddonQuotaUpdate:
        """Test AddonQuotaUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddonQuotaUpdate`
        """
        model = AddonQuotaUpdate()
        if include_optional:
            return AddonQuotaUpdate(
