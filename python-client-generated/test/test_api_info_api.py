...
class TestApiInfoApi(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiInfoApi:
        """Test ApiInfoApi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiInfoApi`
        """
        model = ApiInfoApi()
        if include_optional:
            return ApiInfoApi(
                version = '480.288.001',
                specification = '              http://ynuaZcdyyvKX7HzKV.j:9756                                     '
            )
        else:
            return ApiInfoApi(
                version = '480.288.001',
