...
class TestCreateAdminGroupRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateAdminGroupRequest:
        """Test CreateAdminGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAdminGroupRequest`
        """
        model = CreateAdminGroupRequest()
        if include_optional:
            return CreateAdminGroupRequest(
                group_name = 'z0',
                name = '0',
                description = ''
            )
