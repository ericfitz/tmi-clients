...
class TestRepositoryBaseParameters(unittest.TestCase):
    """RepositoryBaseParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepositoryBaseParameters:
        """Test RepositoryBaseParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepositoryBaseParameters`
        """
        model = RepositoryBaseParameters()
        if include_optional:
            return RepositoryBaseParameters(
                ref_type = 'branch',
    ...
    def testRepositoryBaseParameters(self):
        """Test RepositoryBaseParameters"""
