...
class TestClientConfigOperator(unittest.TestCase):
    """ClientConfigOperator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientConfigOperator:
        """Test ClientConfigOperator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientConfigOperator`
        """
        model = ClientConfigOperator()
        if include_optional:
            return ClientConfigOperator(
                name = '',
                contact = ''
            )
        else:
    ...
    def testClientConfigOperator(self):
        """Test ClientConfigOperator"""
