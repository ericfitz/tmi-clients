...
class TestSAMLProviderInfo(unittest.TestCase):
    """SAMLProviderInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SAMLProviderInfo:
        """Test SAMLProviderInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SAMLProviderInfo`
        """
        model = SAMLProviderInfo()
        if include_optional:
            return SAMLProviderInfo(
                ...
                metadata_url = 'file://%?x!u\'K}qz^sEC)lJ*=-jQ+\'6`%c',
                entity_id = '',
                acs_url = '              http://ynuaZcdyyvKX7HzKV.j:9756                                     ',
                slo_url = '              http://ynuaZcdyyvKX7HzKV.j:9756                                     ',
                initialized = True
            )
        else:
            return SAMLProviderInfo(
