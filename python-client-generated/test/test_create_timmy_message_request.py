...
class TestCreateTimmyMessageRequest(unittest.TestCase):
    """CreateTimmyMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTimmyMessageRequest:
        """Test CreateTimmyMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTimmyMessageRequest`
        """
        model = CreateTimmyMessageRequest()
        if include_optional:
            return CreateTimmyMessageRequest(
                content = 'jUR,rZ#UM/?R,Fp^l6$ARj0'
            )
        else:
            return CreateTimmyMessageRequest(
                content = 'jUR,rZ#UM/?R,Fp^l6$ARj0',
    ...
    def testCreateTimmyMessageRequest(self):
        """Test CreateTimmyMessageRequest"""
