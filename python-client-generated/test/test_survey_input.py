...
class TestSurveyInput(unittest.TestCase):
    """SurveyInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SurveyInput:
        """Test SurveyInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SurveyInput`
        """
        model = SurveyInput()
        if include_optional:
            return SurveyInput(
