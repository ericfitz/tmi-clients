...
class TestDfdDiagramInput(unittest.TestCase):
    """DfdDiagramInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DfdDiagramInput:
        """Test DfdDiagramInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DfdDiagramInput`
        """
        model = DfdDiagramInput()
        if include_optional:
            return DfdDiagramInput(
                type = 'DFD-1.0.0',
                cells = [
                    null
                    ]
