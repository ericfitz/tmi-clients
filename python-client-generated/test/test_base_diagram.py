...
class TestBaseDiagram(unittest.TestCase):
    """BaseDiagram unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseDiagram:
        """Test BaseDiagram
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseDiagram`
        """
        model = BaseDiagram()
        if include_optional:
            return BaseDiagram(
                ...
                color_palette = [
                    tmi_client.models.color_palette_entry.ColorPaletteEntry(
                        position = 1, 
                        color = '#62E0123', )
                    ]
            )
