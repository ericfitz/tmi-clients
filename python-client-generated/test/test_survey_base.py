...
class TestSurveyBase(unittest.TestCase):
    """SurveyBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SurveyBase:
        """Test SurveyBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SurveyBase`
        """
        model = SurveyBase()
        if include_optional:
            return SurveyBase(
