...
class TestNodeAllOfSize(unittest.TestCase):
    """NodeAllOfSize unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeAllOfSize:
        """Test NodeAllOfSize
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAllOfSize`
        """
        model = NodeAllOfSize()
        if include_optional:
            return NodeAllOfSize(
                width = 40,
                height = 30
            )
        else:
