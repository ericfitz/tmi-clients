...
class TestCreateTimmySessionRequest(unittest.TestCase):
    """CreateTimmySessionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTimmySessionRequest:
        """Test CreateTimmySessionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTimmySessionRequest`
        """
        model = CreateTimmySessionRequest()
        if include_optional:
            return CreateTimmySessionRequest(
    ...
    def testCreateTimmySessionRequest(self):
        """Test CreateTimmySessionRequest"""
