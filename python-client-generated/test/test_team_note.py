...
class TestTeamNote(unittest.TestCase):
    """TeamNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamNote:
        """Test TeamNote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamNote`
        """
        model = TeamNote()
        if include_optional:
            return TeamNote(
