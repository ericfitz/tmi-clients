...
class TestClientConfigLimits(unittest.TestCase):
    """ClientConfigLimits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientConfigLimits:
        """Test ClientConfigLimits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientConfigLimits`
        """
        model = ClientConfigLimits()
        if include_optional:
            return ClientConfigLimits(
    ...
    def testClientConfigLimits(self):
        """Test ClientConfigLimits"""
