...
class TestProjectNoteListItem(unittest.TestCase):
    """ProjectNoteListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectNoteListItem:
        """Test ProjectNoteListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectNoteListItem`
        """
        model = ProjectNoteListItem()
        if include_optional:
    ...
    def testProjectNoteListItem(self):
        """Test ProjectNoteListItem"""
