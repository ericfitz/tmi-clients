...
class TestTimmyChatMessage(unittest.TestCase):
    """TimmyChatMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimmyChatMessage:
        """Test TimmyChatMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimmyChatMessage`
        """
        model = TimmyChatMessage()
        if include_optional:
