...
class TestNodeAttrsTextRefY(unittest.TestCase):
    """NodeAttrsTextRefY unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeAttrsTextRefY:
        """Test NodeAttrsTextRefY
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAttrsTextRefY`
        """
        model = NodeAttrsTextRefY()
        if include_optional:
    ...
    def testNodeAttrsTextRefY(self):
        """Test NodeAttrsTextRefY"""
