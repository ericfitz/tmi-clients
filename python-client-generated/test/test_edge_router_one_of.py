...
class TestEdgeRouterOneOf(unittest.TestCase):
    """EdgeRouterOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeRouterOneOf:
        """Test EdgeRouterOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeRouterOneOf`
        """
        model = EdgeRouterOneOf()
        if include_optional:
            return EdgeRouterOneOf(
                name = 'normal',
                args = { }
            )
        else:
