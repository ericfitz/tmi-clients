...
class TestApiInfoHealth(unittest.TestCase):
    """ApiInfoHealth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiInfoHealth:
        """Test ApiInfoHealth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiInfoHealth`
        """
        model = ApiInfoHealth()
        if include_optional:
            return ApiInfoHealth(
                database = tmi_client.models.component_health.ComponentHealth(
                    status = 'healthy', 
                    latency_ms = 0, 
                    message = 'jUR,rZ#UM/?R,Fp^l6$ARj', ),
                redis = tmi_client.models.component_health.ComponentHealth(
                    status = 'healthy', 
                    latency_ms = 0, 
                    message = 'jUR,rZ#UM/?R,Fp^l6$ARj', )
            )
