...
class TestTimmyUsageResponse(unittest.TestCase):
    """TimmyUsageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimmyUsageResponse:
        """Test TimmyUsageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimmyUsageResponse`
        """
        model = TimmyUsageResponse()
        if include_optional:
            return TimmyUsageResponse(
                usage = [
                    tmi_client.models.timmy_usage_record.TimmyUsageRecord(
    ...
    def testTimmyUsageResponse(self):
        """Test TimmyUsageResponse"""
