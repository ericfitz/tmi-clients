...
class TestEdgeRouterOneOfArgs(unittest.TestCase):
    """EdgeRouterOneOfArgs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeRouterOneOfArgs:
        """Test EdgeRouterOneOfArgs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeRouterOneOfArgs`
        """
        model = EdgeRouterOneOfArgs()
        if include_optional:
            return EdgeRouterOneOfArgs(
                padding = 1.337,
                step = 1.337,
                directions = [
                    'top'
    ...
    def testEdgeRouterOneOfArgs(self):
        """Test EdgeRouterOneOfArgs"""
