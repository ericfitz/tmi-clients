...
class TestExtendedAsset(unittest.TestCase):
    """ExtendedAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedAsset:
        """Test ExtendedAsset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedAsset`
        """
        model = ExtendedAsset()
        if include_optional:
