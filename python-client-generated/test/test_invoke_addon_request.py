...
class TestInvokeAddonRequest(unittest.TestCase):
    """InvokeAddonRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvokeAddonRequest:
        """Test InvokeAddonRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvokeAddonRequest`
        """
        model = InvokeAddonRequest()
        if include_optional:
            return InvokeAddonRequest(
                threat_model_id = '',
    ...
    def testInvokeAddonRequest(self):
        """Test InvokeAddonRequest"""
