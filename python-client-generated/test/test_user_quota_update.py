...
class TestUserQuotaUpdate(unittest.TestCase):
    """UserQuotaUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserQuotaUpdate:
        """Test UserQuotaUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserQuotaUpdate`
        """
        model = UserQuotaUpdate()
        if include_optional:
            return UserQuotaUpdate(
