...
class TestTriageNote(unittest.TestCase):
    """TriageNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriageNote:
        """Test TriageNote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriageNote`
        """
        model = TriageNote()
        if include_optional:
            return TriageNote(
