...
class TestEdgeAttrsLineSourceMarker(unittest.TestCase):
    """EdgeAttrsLineSourceMarker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeAttrsLineSourceMarker:
        """Test EdgeAttrsLineSourceMarker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeAttrsLineSourceMarker`
        """
        model = EdgeAttrsLineSourceMarker()
        if include_optional:
            return EdgeAttrsLineSourceMarker(
                name = 'classic',
                size = 1
            )
        else:
    ...
    def testEdgeAttrsLineSourceMarker(self):
        """Test EdgeAttrsLineSourceMarker"""
