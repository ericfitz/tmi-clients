...
class TestSurveyResponseInput(unittest.TestCase):
    """SurveyResponseInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SurveyResponseInput:
        """Test SurveyResponseInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SurveyResponseInput`
        """
        model = SurveyResponseInput()
        if include_optional:
            return SurveyResponseInput(
                answers = { },
    ...
    def testSurveyResponseInput(self):
        """Test SurveyResponseInput"""
