...
class TestNodeAllOfPosition(unittest.TestCase):
    """NodeAllOfPosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeAllOfPosition:
        """Test NodeAllOfPosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAllOfPosition`
        """
        model = NodeAllOfPosition()
        if include_optional:
            return NodeAllOfPosition(
                x = 1.337,
                y = 1.337
            )
        else:
    ...
    def testNodeAllOfPosition(self):
        """Test NodeAllOfPosition"""
