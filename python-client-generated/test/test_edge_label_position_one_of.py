...
class TestEdgeLabelPositionOneOf(unittest.TestCase):
    """EdgeLabelPositionOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdgeLabelPositionOneOf:
        """Test EdgeLabelPositionOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdgeLabelPositionOneOf`
        """
        model = EdgeLabelPositionOneOf()
        if include_optional:
            return EdgeLabelPositionOneOf(
                distance = 1.337,
                offset = None,
                angle = 1.337,
                options = tmi_client.models.edge_label_position_one_of_options.EdgeLabel_position_oneOf_options(
                    absolute_distance = True, 
                    reverse_distance = True, 
                    absolute_offset = True, 
                    keep_gradient = True, 
                    ensure_legibility = True, )
            )
        else:
            return EdgeLabelPositionOneOf(
                distance = 1.337,
    ...
    def testEdgeLabelPositionOneOf(self):
        """Test EdgeLabelPositionOneOf"""
