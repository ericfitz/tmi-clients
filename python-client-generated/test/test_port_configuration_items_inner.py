...
class TestPortConfigurationItemsInner(unittest.TestCase):
    """PortConfigurationItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortConfigurationItemsInner:
        """Test PortConfigurationItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortConfigurationItemsInner`
        """
        model = PortConfigurationItemsInner()
        if include_optional:
            return PortConfigurationItemsInner(
                id = 'jUR,rZ#UM/?R,Fp^l6$ARj',
                group = 'jUR,rZ#UM/?R,Fp^l6$ARj',
                attrs = tmi_client.models.attrs.attrs()
            )
        else:
            return PortConfigurationItemsInner(
                id = 'jUR,rZ#UM/?R,Fp^l6$ARj',
    ...
    def testPortConfigurationItemsInner(self):
        """Test PortConfigurationItemsInner"""
