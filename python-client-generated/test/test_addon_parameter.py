...
class TestAddonParameter(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddonParameter:
        """Test AddonParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddonParameter`
        """
        model = AddonParameter()
        if include_optional:
            return AddonParameter(
                name = 'ABAMDTMv2D2ylmgd10Z3UB6UkJSIS0',
                type = 'enum',
                description = '',
                required = True,
                enum_values = [
