...
class TestMyGroupListResponse(unittest.TestCase):
    """MyGroupListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyGroupListResponse:
        """Test MyGroupListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyGroupListResponse`
        """
        model = MyGroupListResponse()
        if include_optional:
            return MyGroupListResponse(
                groups = [
                    tmi_client.models.user_group_membership.UserGroupMembership(
                        internal_uuid = '', 
                        group_name = '', 
                        name = '', )
                    ],
    ...
    def testMyGroupListResponse(self):
        """Test MyGroupListResponse"""
