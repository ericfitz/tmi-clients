...
class TestNoteListItem(unittest.TestCase):
    """NoteListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteListItem:
        """Test NoteListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteListItem`
        """
        model = NoteListItem()
        if include_optional:
            return NoteListItem(
