...
class TestBaseDiagramInput(unittest.TestCase):
    """BaseDiagramInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseDiagramInput:
        """Test BaseDiagramInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseDiagramInput`
        """
        model = BaseDiagramInput()
        if include_optional:
            return BaseDiagramInput(
