...
class TestTransferOwnershipResult(unittest.TestCase):
    """TransferOwnershipResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferOwnershipResult:
        """Test TransferOwnershipResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferOwnershipResult`
        """
        model = TransferOwnershipResult()
        if include_optional:
            return TransferOwnershipResult(
                threat_models_transferred = tmi_client.models.transfer_ownership_result_threat_models_transferred.TransferOwnershipResult_threat_models_transferred(
                    count = 0, 
                    threat_model_ids = [
                        ''
                        ], ),
                survey_responses_transferred = tmi_client.models.transfer_ownership_result_survey_responses_transferred.TransferOwnershipResult_survey_responses_transferred(
                    count = 0, 
                    survey_response_ids = [
                        ''
                        ], )
    ...
    def testTransferOwnershipResult(self):
        """Test TransferOwnershipResult"""
