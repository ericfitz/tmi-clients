...
class TestClientCredentialInfo(unittest.TestCase):
    """ClientCredentialInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientCredentialInfo:
        """Test ClientCredentialInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientCredentialInfo`
        """
        model = ClientCredentialInfo()
        if include_optional:
    ...
    def testClientCredentialInfo(self):
        """Test ClientCredentialInfo"""
