...
class TestClientConfigUi(unittest.TestCase):
    """ClientConfigUi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientConfigUi:
        """Test ClientConfigUi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientConfigUi`
        """
        model = ClientConfigUi()
        if include_optional:
            return ClientConfigUi(
                default_theme = 'auto'
            )
        else:
            return ClientConfigUi(
