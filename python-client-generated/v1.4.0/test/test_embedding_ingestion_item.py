...
class TestEmbeddingIngestionItem(unittest.TestCase):
    """EmbeddingIngestionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test EmbeddingIngestionItem
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmbeddingIngestionItem`
        """
        model = EmbeddingIngestionItem()
        if include_optional:
    ...
    def testEmbeddingIngestionItem(self):
        """Test EmbeddingIngestionItem"""
