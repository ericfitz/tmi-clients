...
class TestUpdateWebhookDeliveryStatusRequest(unittest.TestCase):
    """UpdateWebhookDeliveryStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        ...
        # uncomment below to create an instance of `UpdateWebhookDeliveryStatusRequest`
        """
        model = UpdateWebhookDeliveryStatusRequest()
        if include_optional:
            return UpdateWebhookDeliveryStatusRequest(
                status = 'in_progress',
                status_percent = 0,
                status_message = ''
            )
    ...
    def testUpdateWebhookDeliveryStatusRequest(self):
        """Test UpdateWebhookDeliveryStatusRequest"""
