...
class TestWebhookDeliveriesApi(unittest.TestCase):
    ...
    def test_get_webhook_delivery_status(self) -> None:
        """Test case for get_webhook_delivery_status

        Get webhook delivery status
        """
        pass

    def test_update_webhook_delivery_status(self) -> None:
        """Test case for update_webhook_delivery_status
