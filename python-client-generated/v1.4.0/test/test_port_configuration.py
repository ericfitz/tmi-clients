    ...
    def make_instance(self, include_optional) -> None:
        ...
        if include_optional:
            return PortConfiguration(
                groups = {
                    'key' : tmi_client.models.port_configuration_groups_value.PortConfiguration_groups_value(
                        position = 'top', 
                        attrs = tmi_client.models.attrs.attrs(), )
                    },
                items = [
                    tmi_client.models.port_configuration_items_inner.PortConfiguration_items_inner(
