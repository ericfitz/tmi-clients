...
class TestMicrosoftPickerGrantRequest(unittest.TestCase):
    """MicrosoftPickerGrantRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test MicrosoftPickerGrantRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MicrosoftPickerGrantRequest`
        """
        model = MicrosoftPickerGrantRequest()
        if include_optional:
            return MicrosoftPickerGrantRequest(
                drive_id = '',
                item_id = ''
            )
        else:
    ...
    def testMicrosoftPickerGrantRequest(self):
        """Test MicrosoftPickerGrantRequest"""
