...
class TestEmbeddingConfig(unittest.TestCase):
    """EmbeddingConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        ...
        # uncomment below to create an instance of `EmbeddingConfig`
        """
        model = EmbeddingConfig()
        if include_optional:
            return EmbeddingConfig(
                text_embedding = tmi_client.models.embedding_provider_config.EmbeddingProviderConfig(
                    provider = 'openai', 
                    model = 'text-embedding-3-small', 
                    api_key = '', 
                    base_url = '', ),
                code_embedding = tmi_client.models.embedding_provider_config.EmbeddingProviderConfig(
                    provider = 'openai', 
                    model = 'text-embedding-3-small', 
                    api_key = '', 
                    base_url = '', )
