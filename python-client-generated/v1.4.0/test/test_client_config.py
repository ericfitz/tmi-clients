...
class TestClientConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> None:
        ...
        if include_optional:
            return ClientConfig(
                features = tmi_client.models.client_config_features.ClientConfig_features(
                    websocket_enabled = True, 
                    saml_enabled = True, 
                    webhooks_enabled = True, ),
                operator = tmi_client.models.client_config_operator.ClientConfig_operator(
                    name = '', 
                    contact = '', 
                    jurisdiction = '', ),
                limits = tmi_client.models.client_config_limits.ClientConfig_limits(
                    max_file_upload_mb = 1, 
                    max_diagram_participants = 1, ),
                ui = tmi_client.models.client_config_ui.ClientConfig_ui(
                    default_theme = 'auto', ),
                content_providers = [
                    tmi_client.models.content_provider.ContentProvider(
                        id = 'google_workspace', 
                        name = '', 
                        kind = 'delegated', 
                        icon = '', 
