...
class TestNodeAttrsTextRefX(unittest.TestCase):
    """NodeAttrsTextRefX unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        ...
        # uncomment below to create an instance of `NodeAttrsTextRefX`
        """
        model = NodeAttrsTextRefX()
        if include_optional:
    ...
    def testNodeAttrsTextRefX(self):
        """Test NodeAttrsTextRefX"""
