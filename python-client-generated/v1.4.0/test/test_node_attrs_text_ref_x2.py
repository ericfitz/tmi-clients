...
class TestNodeAttrsTextRefX2(unittest.TestCase):
    """NodeAttrsTextRefX2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test NodeAttrsTextRefX2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAttrsTextRefX2`
        """
        model = NodeAttrsTextRefX2()
        if include_optional:
    ...
    def testNodeAttrsTextRefX2(self):
        """Test NodeAttrsTextRefX2"""
