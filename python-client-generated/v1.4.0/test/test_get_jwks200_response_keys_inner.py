...
class TestGetJWKS200ResponseKeysInner(unittest.TestCase):
    """GetJWKS200ResponseKeysInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test GetJWKS200ResponseKeysInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetJWKS200ResponseKeysInner`
        """
        model = GetJWKS200ResponseKeysInner()
        if include_optional:
            return GetJWKS200ResponseKeysInner(
                kty = 'oct',
                use = 'sig',
                alg = 'HS256',
                kid = 'tmi-signing-key'
    ...
    def testGetJWKS200ResponseKeysInner(self):
        """Test GetJWKS200ResponseKeysInner"""
