...
class TestEmbeddingIngestionRequest(unittest.TestCase):
    """EmbeddingIngestionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test EmbeddingIngestionRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmbeddingIngestionRequest`
        """
        model = EmbeddingIngestionRequest()
        if include_optional:
            return EmbeddingIngestionRequest(
                index_type = 'text',
                embeddings = [
                    tmi_client.models.embedding_ingestion_item.EmbeddingIngestionItem(
                        entity_type = '', 
                        entity_id = '', 
                        chunk_index = 0, 
                        chunk_text = '', 
    ...
    def testEmbeddingIngestionRequest(self):
        """Test EmbeddingIngestionRequest"""
