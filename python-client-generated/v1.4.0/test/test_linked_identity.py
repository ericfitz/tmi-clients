...
class TestLinkedIdentity(unittest.TestCase):
    """LinkedIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        ...
        # uncomment below to create an instance of `LinkedIdentity`
        """
