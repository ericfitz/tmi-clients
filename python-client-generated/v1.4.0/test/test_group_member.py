    ...
    def make_instance(self, include_optional) -> None:
        ...
        if include_optional:
            return GroupMember(
                ...
                group_internal_uuid = '',
                user_internal_uuid = '',
                user_email = 'A@9LCSLv1C1ylmgd0.Y2TA5TkIRHRRA401iz1CiIy.dNTRddzXYdswQltRTtwKQzBuNJxBelKTmfIQcBkWgeAShmXXoTaDzlkczbtHjkljEhQVqeWYqqMQZlEQb',
                user_name = '',
                user_provider = '',
                user_provider_user_id = '',
                added_by_internal_uuid = '',
                added_by_email = 'A@9LCSLv1C1ylmgd0.Y2TA5TkIRHRRA401iz1CiIy.dNTRddzXYdswQltRTtwKQzBuNJxBelKTmfIQcBkWgeAShmXXoTaDzlkczbtHjkljEhQVqeWYqqMQZlEQb',
