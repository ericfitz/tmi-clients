...
class TestEmbeddingDeleteResponse(unittest.TestCase):
    """EmbeddingDeleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test EmbeddingDeleteResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmbeddingDeleteResponse`
        """
        model = EmbeddingDeleteResponse()
        if include_optional:
    ...
    def testEmbeddingDeleteResponse(self):
        """Test EmbeddingDeleteResponse"""
