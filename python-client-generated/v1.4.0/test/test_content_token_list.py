...
class TestContentTokenList(unittest.TestCase):
    """ContentTokenList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ContentTokenList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentTokenList`
        """
        model = ContentTokenList()
        if include_optional:
