...
class TestCreateCurrentUserClientCredentialRequest(unittest.TestCase):
    """CreateCurrentUserClientCredentialRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test CreateCurrentUserClientCredentialRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateCurrentUserClientCredentialRequest`
        """
        model = CreateCurrentUserClientCredentialRequest()
        if include_optional:
            return CreateCurrentUserClientCredentialRequest(
                name = 'CI/CD Pipeline',
    ...
    def testCreateCurrentUserClientCredentialRequest(self):
        """Test CreateCurrentUserClientCredentialRequest"""
