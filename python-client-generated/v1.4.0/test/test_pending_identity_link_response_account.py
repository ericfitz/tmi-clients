...
class TestPendingIdentityLinkResponseAccount(unittest.TestCase):
    """PendingIdentityLinkResponseAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test PendingIdentityLinkResponseAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingIdentityLinkResponseAccount`
        """
        model = PendingIdentityLinkResponseAccount()
        if include_optional:
            return PendingIdentityLinkResponseAccount(
                provider = '',
                email = ''
            )
        else:
    ...
    def testPendingIdentityLinkResponseAccount(self):
        """Test PendingIdentityLinkResponseAccount"""
