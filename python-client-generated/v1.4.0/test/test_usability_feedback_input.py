...
class TestUsabilityFeedbackInput(unittest.TestCase):
    """UsabilityFeedbackInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test UsabilityFeedbackInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsabilityFeedbackInput`
        """
        model = UsabilityFeedbackInput()
        if include_optional:
            return UsabilityFeedbackInput(
                sentiment = 'up',
                verbatim = '',
                surface = 'a6otgfww_r74cm.fyln9uyrj1gzi.i4v',
                client_id = 'awat5ikwowtta-3mh2lcafqw3zheseh1',
                client_version = '',
                client_build = 'f325375e0',
                user_agent = '',
                user_agent_data = { },
                viewport = '4x0728',
                screenshot = 'data:image/webp;base64,6bTTF'
            )
        else:
            return UsabilityFeedbackInput(
                sentiment = 'up',
    ...
    def testUsabilityFeedbackInput(self):
        """Test UsabilityFeedbackInput"""
