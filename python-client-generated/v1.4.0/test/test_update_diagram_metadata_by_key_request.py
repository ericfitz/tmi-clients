...
class TestUpdateDiagramMetadataByKeyRequest(unittest.TestCase):
    """UpdateDiagramMetadataByKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test UpdateDiagramMetadataByKeyRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateDiagramMetadataByKeyRequest`
        """
        model = UpdateDiagramMetadataByKeyRequest()
        if include_optional:
            return UpdateDiagramMetadataByKeyRequest(
    ...
    def testUpdateDiagramMetadataByKeyRequest(self):
        """Test UpdateDiagramMetadataByKeyRequest"""
