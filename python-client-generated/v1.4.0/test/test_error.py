...
class TestError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> None:
        ...
        if include_optional:
            return Error(
                error = 'jUR,rZ#UM/?R,Fp^l6$ARj',
                error_description = 'jUR,rZ#UM/?R,Fp^l6$ARj',
                error_uri = 'A5bTTFjjMRwg.Zbs8YayHLrJdgMvb://lu,k\'!\'su[.lzF6V,V6rEtCO?&28nxs',
                details = tmi_client.models.error_details.Error_details(
