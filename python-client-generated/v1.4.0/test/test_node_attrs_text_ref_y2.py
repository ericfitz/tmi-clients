...
class TestNodeAttrsTextRefY2(unittest.TestCase):
    """NodeAttrsTextRefY2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test NodeAttrsTextRefY2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAttrsTextRefY2`
        """
        model = NodeAttrsTextRefY2()
        if include_optional:
    ...
    def testNodeAttrsTextRefY2(self):
        """Test NodeAttrsTextRefY2"""
