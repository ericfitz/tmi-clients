...
class TestCreateThreatModelFromSurveyResponse(unittest.TestCase):
    """CreateThreatModelFromSurveyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test CreateThreatModelFromSurveyResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateThreatModelFromSurveyResponse`
        """
        model = CreateThreatModelFromSurveyResponse()
        if include_optional:
    ...
    def testCreateThreatModelFromSurveyResponse(self):
        """Test CreateThreatModelFromSurveyResponse"""
