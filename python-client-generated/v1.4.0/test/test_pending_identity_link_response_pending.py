...
class TestPendingIdentityLinkResponsePending(unittest.TestCase):
    """PendingIdentityLinkResponsePending unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test PendingIdentityLinkResponsePending
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingIdentityLinkResponsePending`
        """
        model = PendingIdentityLinkResponsePending()
        if include_optional:
            return PendingIdentityLinkResponsePending(
                provider = '',
                provider_user_id = '',
                email = '',
                name = ''
    ...
    def testPendingIdentityLinkResponsePending(self):
        """Test PendingIdentityLinkResponsePending"""
