...
class TestListThreatModelAuditTrailResponse(unittest.TestCase):
    """ListThreatModelAuditTrailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ListThreatModelAuditTrailResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListThreatModelAuditTrailResponse`
        """
        model = ListThreatModelAuditTrailResponse()
        if include_optional:
    ...
    def testListThreatModelAuditTrailResponse(self):
        """Test ListThreatModelAuditTrailResponse"""
