...
class TestSurveyResponseCreateRequest(unittest.TestCase):
    """SurveyResponseCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        ...
        # uncomment below to create an instance of `SurveyResponseCreateRequest`
        """
        model = SurveyResponseCreateRequest()
        if include_optional:
            return SurveyResponseCreateRequest(
                answers = { },
    ...
    def testSurveyResponseCreateRequest(self):
        """Test SurveyResponseCreateRequest"""
