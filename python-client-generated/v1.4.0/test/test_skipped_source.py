...
class TestSkippedSource(unittest.TestCase):
    """SkippedSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        ...
        # uncomment below to create an instance of `SkippedSource`
        """
        model = SkippedSource()
        if include_optional:
