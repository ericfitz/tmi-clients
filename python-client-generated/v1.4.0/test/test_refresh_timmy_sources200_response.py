...
class TestRefreshTimmySources200Response(unittest.TestCase):
    """RefreshTimmySources200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test RefreshTimmySources200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RefreshTimmySources200Response`
        """
        model = RefreshTimmySources200Response()
        if include_optional:
            return RefreshTimmySources200Response(
                source_count = 56,
                skipped_sources = [
                    tmi_client.models.skipped_source.SkippedSource(
                        entity_id = '', 
                        name = '', 
                        reason = '', )
                    ]
    ...
    def testRefreshTimmySources200Response(self):
        """Test RefreshTimmySources200Response"""
