...
class TestUpdateWebhookDeliveryStatusResponse(unittest.TestCase):
    """UpdateWebhookDeliveryStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test UpdateWebhookDeliveryStatusResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateWebhookDeliveryStatusResponse`
        """
        model = UpdateWebhookDeliveryStatusResponse()
        if include_optional:
    ...
    def testUpdateWebhookDeliveryStatusResponse(self):
        """Test UpdateWebhookDeliveryStatusResponse"""
