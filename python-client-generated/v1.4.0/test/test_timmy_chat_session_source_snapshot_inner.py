...
class TestTimmyChatSessionSourceSnapshotInner(unittest.TestCase):
    """TimmyChatSessionSourceSnapshotInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test TimmyChatSessionSourceSnapshotInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TimmyChatSessionSourceSnapshotInner`
        """
        model = TimmyChatSessionSourceSnapshotInner()
        if include_optional:
            return TimmyChatSessionSourceSnapshotInner(
    ...
    def testTimmyChatSessionSourceSnapshotInner(self):
        """Test TimmyChatSessionSourceSnapshotInner"""
