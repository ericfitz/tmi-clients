...
class TestNodeAttrsBodyRefHeight(unittest.TestCase):
    """NodeAttrsBodyRefHeight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test NodeAttrsBodyRefHeight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAttrsBodyRefHeight`
        """
        model = NodeAttrsBodyRefHeight()
        if include_optional:
    ...
    def testNodeAttrsBodyRefHeight(self):
        """Test NodeAttrsBodyRefHeight"""
