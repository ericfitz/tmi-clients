...
class TestAuditTrailApi(unittest.TestCase):
    ...
    def test_get_asset_audit_trail(self) -> None:
    ...
    def test_get_diagram_audit_trail(self) -> None:
    ...
    def test_get_document_audit_trail(self) -> None:
    ...
    def test_get_note_audit_trail(self) -> None:
    ...
    def test_get_repository_audit_trail(self) -> None:
    ...
    def test_get_threat_audit_trail(self) -> None:
    ...
    def test_get_threat_model_audit_trail(self) -> None:
