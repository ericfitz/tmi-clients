    ...
    def make_instance(self, include_optional) -> None:
        ...
        if include_optional:
            return Team(
                ...
                notes = [
                    {"id":"d4e5f6a7-b8c9-0123-defa-23456789abcd","name":"Team Security Guidelines","timmy_enabled":true,"sharable":true,"created_at":"2026-01-12T11:00:00Z","modified_at":"2026-01-13T16:00:00Z"}
                    ]
            )
        else:
            return Team(
