...
class TestContentTokenInfo(unittest.TestCase):
    """ContentTokenInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ContentTokenInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentTokenInfo`
        """
        model = ContentTokenInfo()
        if include_optional:
            return ContentTokenInfo(
                ...
                last_refresh_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
