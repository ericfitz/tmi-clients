...
class TestPortConfigurationGroupsValue(unittest.TestCase):
    """PortConfigurationGroupsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test PortConfigurationGroupsValue
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PortConfigurationGroupsValue`
        """
        model = PortConfigurationGroupsValue()
        if include_optional:
            return PortConfigurationGroupsValue(
                position = 'top',
    ...
    def testPortConfigurationGroupsValue(self):
        """Test PortConfigurationGroupsValue"""
