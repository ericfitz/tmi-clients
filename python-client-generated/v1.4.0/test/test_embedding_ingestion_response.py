...
class TestEmbeddingIngestionResponse(unittest.TestCase):
    """EmbeddingIngestionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test EmbeddingIngestionResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmbeddingIngestionResponse`
        """
        model = EmbeddingIngestionResponse()
        if include_optional:
    ...
    def testEmbeddingIngestionResponse(self):
        """Test EmbeddingIngestionResponse"""
