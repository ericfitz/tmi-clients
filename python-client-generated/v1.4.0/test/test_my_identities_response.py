...
class TestMyIdentitiesResponse(unittest.TestCase):
    """MyIdentitiesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test MyIdentitiesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyIdentitiesResponse`
        """
        model = MyIdentitiesResponse()
        if include_optional:
            return MyIdentitiesResponse(
                primary = tmi_client.models.my_identities_response_primary.MyIdentitiesResponse_primary(
                    provider = '', 
                    email = '', 
                    name = '', ),
                linked = [
    ...
    def testMyIdentitiesResponse(self):
        """Test MyIdentitiesResponse"""
