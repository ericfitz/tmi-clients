...
class CVSSScore(BaseModel):
    ...
    vector: Annotated[str, Field(min_length=26, strict=True, max_length=250)] = Field(
    ...
    ] = Field(description="CVSS score (0.0-10.0)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"vector": obj.get("vector"), "score": obj.get("score")}
        )
        return _obj
