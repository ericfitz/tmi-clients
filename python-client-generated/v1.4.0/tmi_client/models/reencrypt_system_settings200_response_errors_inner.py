...
class ReencryptSystemSettings200ResponseErrorsInner(BaseModel):
    """
    ReencryptSystemSettings200ResponseErrorsInner
    """  # noqa: E501

    key: StrictStr = Field(description="The setting key that failed")
    error: StrictStr = Field(description="Description of the failure")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"key": obj.get("key"), "error": obj.get("error")})
        return _obj
