...
class ClientConfigFeatures(BaseModel):
    ...
    websocket_enabled: Optional[StrictBool] = Field(
        default=None, description="Whether WebSocket collaboration is enabled"
    )
    saml_enabled: Optional[StrictBool] = Field(
        default=None, description="Whether SAML authentication is enabled"
    )
    webhooks_enabled: Optional[StrictBool] = Field(
        default=None, description="Whether webhook subscriptions are enabled"
    )
