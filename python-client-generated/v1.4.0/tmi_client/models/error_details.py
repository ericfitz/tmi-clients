...
class ErrorDetails(BaseModel):
    ...
    context: Optional[Dict[str, Any]] = Field(
        default=None, description="Contextual information about the error"
    )
    suggestion: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(
        default=None, description="Human-readable suggestion for resolving the error"
    )
