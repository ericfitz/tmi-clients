...
class UserAPIQuota(BaseModel):
    ...
    max_requests_per_minute: Annotated[int, Field(strict=True, ge=1)] = Field(
        description="Maximum API requests per minute"
    )
    max_requests_per_hour: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(
        default=None, description="Maximum API requests per hour (optional)"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.max_requests_per_hour is None
            and "max_requests_per_hour" in self.model_fields_set
        ):
