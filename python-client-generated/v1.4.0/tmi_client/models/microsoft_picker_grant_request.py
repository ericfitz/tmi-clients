...
class MicrosoftPickerGrantRequest(BaseModel):
    """
    Request body for the Microsoft picker-grant endpoint. Carries the drive id and item id of the picked file.
    """ # noqa: E501
    drive_id: StrictStr = Field(description="OneDrive or SharePoint drive identifier returned by the Microsoft File Picker.")
    item_id: StrictStr = Field(description="Drive item identifier returned by the Microsoft File Picker.")
    __properties: ClassVar[List[str]] = ["drive_id", "item_id"]
