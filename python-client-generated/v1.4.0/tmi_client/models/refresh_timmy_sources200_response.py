...
class RefreshTimmySources200Response(BaseModel):
    """
    RefreshTimmySources200Response
    """  # noqa: E501

    source_count: Optional[StrictInt] = None
    skipped_sources: Optional[
        Annotated[List[SkippedSource], Field(max_length=1000)]
    ] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in skipped_sources (list)
        _items = []
        if self.skipped_sources:
            for _item_skipped_sources in self.skipped_sources:
                if _item_skipped_sources:
                    _items.append(_item_skipped_sources.to_dict())
            _dict["skipped_sources"] = _items
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "skipped_sources": [
                    SkippedSource.from_dict(_item) for _item in obj["skipped_sources"]
                ]
                if obj.get("skipped_sources") is not None
                else None,
            }
        )
        return _obj
