...
class ClientConfigOperator(BaseModel):
    """
    Operator information
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Name of the service operator")
    contact: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="Contact information for the operator")
    jurisdiction: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Legal jurisdiction under which the service operates")
    __properties: ClassVar[List[str]] = ["name", "contact", "jurisdiction"]
