...
class MyIdentitiesResponsePrimary(BaseModel):
    """
    MyIdentitiesResponsePrimary
    """ # noqa: E501
    provider: StrictStr = Field(description="Primary identity provider ID")
    email: StrictStr = Field(description="Primary account email address")
    name: Optional[StrictStr] = Field(default=None, description="Primary account display name")
