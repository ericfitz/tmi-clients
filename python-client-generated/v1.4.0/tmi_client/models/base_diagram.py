...
class BaseDiagram(BaseModel):
    ...
    type: Annotated[str, Field(strict=True, max_length=64)] = Field(description="Type of diagram with version")
    ...
    update_vector: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Server-managed monotonic version counter, incremented on each diagram update")
    ...
    auto_generated: Optional[StrictBool] = Field(default=None, description="True when the diagram was created by an automation/service-account principal. Sticky from creation.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "created_at", "modified_at", "metadata", "update_vector", "image", "description", "include_in_report", "timmy_enabled", "deleted_at", "color_palette", "auto_generated", "alias"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DFD-1.0.0': 'DfdDiagram','Diagram': 'Diagram'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[DfdDiagram, Diagram]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DfdDiagram, Diagram]]:
        ...
        raise ValueError("BaseDiagram failed to lookup discriminator value from " +
