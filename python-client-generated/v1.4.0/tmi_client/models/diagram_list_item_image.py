...
class DiagramListItemImage(BaseModel):
    ...
    svg: Optional[
        Union[
            Annotated[bytes, Field(strict=True, max_length=102400)],
            Annotated[str, Field(strict=True, max_length=102400)],
        ]
    ] = Field(
        default=None,
    ...
    update_vector: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(
        default=None, description="Version of the diagram when this SVG was generated"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"svg": obj.get("svg"), "update_vector": obj.get("update_vector")}
        )
        return _obj
