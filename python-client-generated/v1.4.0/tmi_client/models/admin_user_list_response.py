...
class AdminUserListResponse(BaseModel):
    ...
    """ # noqa: E501
    users: Annotated[List[AdminUser], Field(max_length=1000)] = Field(description="List of users")
    total: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of users matching the filter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [AdminUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
