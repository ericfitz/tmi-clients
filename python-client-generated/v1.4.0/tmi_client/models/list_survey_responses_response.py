...
class ListSurveyResponsesResponse(BaseModel):
    ...
    """ # noqa: E501
    survey_responses: Annotated[List[SurveyResponseListItem], Field(max_length=1000)]
    total: StrictInt = Field(description="Total number of responses matching criteria")
