...
class AuditEntry(BaseModel):
    ...
    actor: AuditActor
    change_summary: Optional[StrictStr] = Field(
    ...
    def object_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('threat_model', 'diagram', 'threat', 'asset', 'document', 'note', 'repository')"
            )
        return value
    ...
    def change_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('created', 'updated', 'patched', 'deleted', 'rolled_back', 'restored')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "actor": AuditActor.from_dict(obj["actor"])
