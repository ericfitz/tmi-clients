...
class Threat(BaseModel):
    ...
    mitigation: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(
        default=None, description="Recommended or planned mitigation(s) for the threat"
    )
    ...
    severity: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(
        default=None, description="Severity level of the threat"
    )
    score: Optional[
        Union[
            Annotated[float, Field(multiple_of=0.1, le=10.0, strict=True, ge=0.0)],
    ...
    priority: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="Priority level for addressing the threat"
    )
    mitigated: Optional[StrictBool] = Field(
        default=None, description="Whether the threat has been mitigated"
    )
    status: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="Current status of the threat"
    )
    threat_type: Annotated[
        List[Annotated[str, Field(min_length=1, strict=True, max_length=256)]],
    ...
    metadata: Optional[Annotated[List[Metadata], Field(max_length=100)]] = Field(
        default=None, description="Key-value pairs for additional threat metadata"
    )
    ...
    cwe_id: Optional[
        Annotated[
            List[Annotated[str, Field(min_length=5, strict=True, max_length=16)]],
            Field(min_length=0, max_length=50),
        ]
    ] = Field(
        default=None,
        description="CWE (Common Weakness Enumeration) identifiers associated with this threat",
    )
    cvss: Optional[Annotated[List[CVSSScore], Field(min_length=0, max_length=10)]] = (
        Field(default=None, description="CVSS scoring information for this threat")
    )
    ...
    id: Optional[UUID] = Field(
        default=None, description="Unique identifier for the threat (UUID)"
    )
    threat_model_id: Optional[UUID] = Field(
        default=None, description="Unique identifier of the parent threat model (UUID)"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "cvss": [CVSSScore.from_dict(_item) for _item in obj["cvss"]]
                if obj.get("cvss") is not None
                else None,
                ...
                "ssvc": SSVCScore.from_dict(obj["ssvc"])
                if obj.get("ssvc") is not None
                else None,
                "id": obj.get("id"),
