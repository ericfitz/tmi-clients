...
class PortConfigurationItemsInner(BaseModel):
    """
    PortConfigurationItemsInner
    """ # noqa: E501
    id: Annotated[str, Field(strict=True, max_length=64)] = Field(description="Unique port identifier")
    group: Annotated[str, Field(strict=True, max_length=32)] = Field(description="Port group this port belongs to")
    attrs: Optional[Dict[str, Any]] = Field(default=None, description="Visual attributes for port rendering (e.g., text visibility, circle styling)")
    __properties: ClassVar[List[str]] = ["id", "group", "attrs"]
