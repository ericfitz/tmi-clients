...
class PortConfigurationItemsInner(BaseModel):
    ...
    id: Annotated[str, Field(strict=True, max_length=64)] = Field(
        description="Unique port identifier"
    )
    group: Annotated[str, Field(strict=True, max_length=32)] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "group": obj.get("group"), "attrs": obj.get("attrs")}
        )
        return _obj
