...
class ReencryptSystemSettings200Response(BaseModel):
    ...
    reencrypted: StrictInt = Field(
        description="Number of settings successfully re-encrypted"
    )
    errors: Annotated[
        List[ReencryptSystemSettings200ResponseErrorsInner], Field(max_length=1000)
    ] = Field(description="Settings that failed re-encryption")
        ...
        _obj = cls.model_validate(
            {
                ...
                "errors": [
                    ReencryptSystemSettings200ResponseErrorsInner.from_dict(_item)
