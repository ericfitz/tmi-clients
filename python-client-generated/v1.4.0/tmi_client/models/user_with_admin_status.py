...
class UserWithAdminStatus(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                "is_security_reviewer": obj.get("is_security_reviewer"),
                "groups": [
