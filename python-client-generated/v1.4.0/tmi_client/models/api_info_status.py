...
class ApiInfoStatus(BaseModel):
    """
    ApiInfoStatus
    """  # noqa: E501

    code: Annotated[str, Field(strict=True, max_length=512)] = Field(
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        value = value.isoformat() if hasattr(value, "isoformat") else str(value)
        if value not in set(["ok", "degraded", "error"]):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"code": obj.get("code"), "time": obj.get("time")})
        return _obj
