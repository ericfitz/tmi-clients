...
class EdgeAttrsLineSourceMarker(BaseModel):
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(
        default=None, description="Marker type"
    )
    size: Optional[
        Union[
    ...
    ] = Field(default=None, description="Marker size in pixels")
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(["classic", "block", "diamond", "circle"]):
            raise ValueError(
                "must be one of enum values ('classic', 'block', 'diamond', 'circle')"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "size": obj.get("size")})
        return _obj
