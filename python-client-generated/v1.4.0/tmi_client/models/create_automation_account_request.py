...
class CreateAutomationAccountRequest(BaseModel):
    """
    Request body for creating an automation (service) account
    """  # noqa: E501

    name: Annotated[str, Field(min_length=2, strict=True, max_length=64)] = Field(
    ...
    def name_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^[a-zA-Z][a-zA-Z0-9 _.@-]*[a-zA-Z0-9]$", value):
            raise ValueError(
                r"must validate the regular expression /^[a-zA-Z][a-zA-Z0-9 _.@-]*[a-zA-Z0-9]$/"
            )
        return value
