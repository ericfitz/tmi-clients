...
class SkippedSource(BaseModel):
    ...
    entity_id: UUID = Field(description="ID of the skipped entity")
    name: StrictStr = Field(description="Name of the skipped entity")
    reason: StrictStr = Field(description="Why this entity was skipped")
    __properties: ClassVar[List[str]] = ["entity_id", "name", "reason"]
