...
class MicrosoftPickerGrantResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    permission_id: StrictStr = Field(description="Microsoft Graph permission id created by the grant call.")
    drive_id: StrictStr = Field(description="OneDrive or SharePoint drive identifier of the granted file.")
    item_id: StrictStr = Field(description="Drive item identifier of the granted file.")
    __properties: ClassVar[List[str]] = ["permission_id", "drive_id", "item_id"]
