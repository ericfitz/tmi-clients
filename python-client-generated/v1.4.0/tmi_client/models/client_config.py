...
class ClientConfig(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "features": ClientConfigFeatures.from_dict(obj["features"])
                if obj.get("features") is not None
                else None,
                "operator": ClientConfigOperator.from_dict(obj["operator"])
                if obj.get("operator") is not None
                else None,
                "limits": ClientConfigLimits.from_dict(obj["limits"])
                if obj.get("limits") is not None
                else None,
                "ui": ClientConfigUi.from_dict(obj["ui"])
                if obj.get("ui") is not None
                else None,
            }
        )
        return _obj
