...
class PortConfiguration(BaseModel):
    ...
    groups: Optional[Dict[str, PortConfigurationGroupsValue]] = Field(
        default=None, description="Port group definitions"
    )
    items: Optional[
        Annotated[List[PortConfigurationItemsInner], Field(max_length=1000)]
    ] = Field(default=None, description="Individual port instances")
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": [
                    PortConfigurationItemsInner.from_dict(_item)
