...
class InvokeAddonRequest(BaseModel):
    ...
    object_type: Optional[StrictStr] = Field(
        default=None, description="Optional: Specific object type to operate on"
    )
    object_id: Optional[UUID] = Field(
        default=None, description="Optional: Specific object ID to operate on"
    )
    ...
    def object_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('threat_model', 'diagram', 'asset', 'threat', 'document', 'note', 'repository', 'metadata', 'survey', 'survey_response')"
            )
        return value
