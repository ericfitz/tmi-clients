...
class GetUserAPIQuota429Response(BaseModel):
    """
    GetUserAPIQuota429Response
    """  # noqa: E501

    error: StrictStr = Field(description="Error message")
    retry_after: Optional[StrictInt] = Field(
        default=None, description="Seconds until rate limit resets"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"error": obj.get("error"), "retry_after": obj.get("retry_after")}
        )
        return _obj
