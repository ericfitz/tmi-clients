...
class GetAuthProviders200Response(BaseModel):
    """
    GetAuthProviders200Response
    """  # noqa: E501

    providers: Annotated[
        List[GetAuthProviders200ResponseProvidersInner], Field(max_length=1000)
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "providers": [
                    GetAuthProviders200ResponseProvidersInner.from_dict(_item)
