...
class DocumentInput(BaseModel):
    ...
    picker_registration: Optional[Dict[str, Any]] = Field(default=None, description="Optional; when present, client has performed a Picker-based attachment")
    __properties: ClassVar[List[str]] = ["name", "description", "uri", "include_in_report", "timmy_enabled", "picker_registration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if picker_registration (nullable) is None
        # and model_fields_set contains the field
        if self.picker_registration is None and "picker_registration" in self.model_fields_set:
            _dict['picker_registration'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "picker_registration": obj.get("picker_registration")
        })
        return _obj
