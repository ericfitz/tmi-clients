...
class EmbeddingIngestionItem(BaseModel):
    ...
    chunk_index: Annotated[int, Field(strict=True, ge=0)] = Field(
    ...
    embedding_dim: Annotated[int, Field(strict=True, ge=1)] = Field(
        description="Embedding vector dimension"
    )
    vector: Annotated[List[Union[StrictFloat, StrictInt]], Field(max_length=4096)] = (
