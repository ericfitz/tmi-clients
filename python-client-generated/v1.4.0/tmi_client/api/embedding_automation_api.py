...
class EmbeddingAutomationApi:
    ...
    def delete_embeddings(
        ...
        entity_id: Annotated[Optional[UUID], Field(description="Filter by entity UUID")] = None,
    ...
    def ingest_embeddings(
        self,
        threat_model_id: Annotated[UUID, Field(description="Threat model identifier")],
        embedding_ingestion_request: Annotated[EmbeddingIngestionRequest, Field(description="Batch of pre-computed embeddings to ingest")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
