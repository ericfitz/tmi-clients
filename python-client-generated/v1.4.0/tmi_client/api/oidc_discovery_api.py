...
class OIDCDiscoveryApi:
    ...
    @validate_call
    def get_o_auth_authorization_server_metadata_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_o_auth_authorization_server_metadata_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_open_id_configuration(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetOpenIDConfiguration200Response",
            "400": "Error",
            "500": "Error",
            "503": "Error",
            "429": "Error",
    ...
    def get_open_id_configuration_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetOpenIDConfiguration200Response]:
        """OpenID Connect Discovery Configuration
