...
from tmi_client.api_response import ApiResponse, T as ApiResponseT
import tmi_client.models
from tmi_client import rest
from tmi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(tmi_client.models, klass)
