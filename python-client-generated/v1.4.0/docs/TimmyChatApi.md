# tmi_client.TimmyChatApi

All URIs are relative to *https://api.tmi.dev*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_timmy_chat_message**](TimmyChatApi.md#create_timmy_chat_message) | **POST** /threat_models/{threat_model_id}/chat/sessions/{session_id}/messages | Send a message to Timmy
[**create_timmy_chat_session**](TimmyChatApi.md#create_timmy_chat_session) | **POST** /threat_models/{threat_model_id}/chat/sessions | Create a new Timmy chat session
[**delete_timmy_chat_session**](TimmyChatApi.md#delete_timmy_chat_session) | **DELETE** /threat_models/{threat_model_id}/chat/sessions/{session_id} | Delete a Timmy chat session
...
> str create_timmy_chat_message(threat_model_id, session_id, create_timmy_message_request)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    create_timmy_message_request = {"content":"What are the main threats in the login flow?"} # CreateTimmyMessageRequest | Message content to send to Timmy

    try:
        # Send a message to Timmy
        api_response = api_instance.create_timmy_chat_message(threat_model_id, session_id, create_timmy_message_request)
        print("The response of TimmyChatApi->create_timmy_chat_message:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TimmyChatApi->create_timmy_chat_message: %s\n" % e)
```
 ...
 **create_timmy_message_request** | [**CreateTimmyMessageRequest**](CreateTimmyMessageRequest.md)| Message content to send to Timmy | 
...
# **create_timmy_chat_session**
> str create_timmy_chat_session(threat_model_id, create_timmy_session_request=create_timmy_session_request)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = tmi_client.TimmyChatApi(api_client)
    threat_model_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Threat model identifier
    create_timmy_session_request = {"title":"Payment flow threat analysis"} # CreateTimmySessionRequest | Optional session configuration (optional)

    try:
        # Create a new Timmy chat session
        api_response = api_instance.create_timmy_chat_session(threat_model_id, create_timmy_session_request=create_timmy_session_request)
        print("The response of TimmyChatApi->create_timmy_chat_session:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TimmyChatApi->create_timmy_chat_session: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **threat_model_id** | **UUID**| Threat model identifier | 
 **create_timmy_session_request** | [**CreateTimmySessionRequest**](CreateTimmySessionRequest.md)| Optional session configuration | [optional] 
...
# **delete_timmy_chat_session**
> delete_timmy_chat_session(threat_model_id, session_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a Timmy chat session
        api_instance.delete_timmy_chat_session(threat_model_id, session_id)
    except Exception as e:
        print("Exception when calling TimmyChatApi->delete_timmy_chat_session: %s\n" % e)
```
...
# **get_timmy_chat_session**
> TimmyChatSession get_timmy_chat_session(threat_model_id, session_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a Timmy chat session
        api_response = api_instance.get_timmy_chat_session(threat_model_id, session_id)
        print("The response of TimmyChatApi->get_timmy_chat_session:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TimmyChatApi->get_timmy_chat_session: %s\n" % e)
```
...
# **list_timmy_chat_messages**
> ListTimmyMessagesResponse list_timmy_chat_messages(threat_model_id, session_id, limit=limit, offset=offset)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List messages in a Timmy chat session
        api_response = api_instance.list_timmy_chat_messages(threat_model_id, session_id, limit=limit, offset=offset)
        print("The response of TimmyChatApi->list_timmy_chat_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TimmyChatApi->list_timmy_chat_messages: %s\n" % e)
```
...
# **list_timmy_chat_sessions**
> ListTimmySessionsResponse list_timmy_chat_sessions(threat_model_id, limit=limit, offset=offset)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Timmy chat sessions
        api_response = api_instance.list_timmy_chat_sessions(threat_model_id, limit=limit, offset=offset)
        print("The response of TimmyChatApi->list_timmy_chat_sessions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TimmyChatApi->list_timmy_chat_sessions: %s\n" % e)
```
