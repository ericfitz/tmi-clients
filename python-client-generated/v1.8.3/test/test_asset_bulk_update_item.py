...
class TestAssetBulkUpdateItem(unittest.TestCase):
    """AssetBulkUpdateItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test AssetBulkUpdateItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetBulkUpdateItem`
        """
        model = AssetBulkUpdateItem()
        if include_optional:
            return AssetBulkUpdateItem(
                name = 'Q+a4YUKiC 8pO_kmb|~K 60',
                description = 'lZCuMd%B;a5)#hGd-dx%p\\',
                type = 'data',
                criticality = 'jUR,rZ#UM/?R,Fp^l6$ARj',
                classification = [
                    'jUR,rZ#UM/?R,Fp^l6$ARj'
                    ],
                sensitivity = 'jUR,rZ#UM/?R,Fp^l6$ARj',
    ...
    def testAssetBulkUpdateItem(self):
        """Test AssetBulkUpdateItem"""
