...
class TestAdminUserIdentitiesResponsePrimary(unittest.TestCase):
    """AdminUserIdentitiesResponsePrimary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test AdminUserIdentitiesResponsePrimary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminUserIdentitiesResponsePrimary`
        """
        model = AdminUserIdentitiesResponsePrimary()
        if include_optional:
            return AdminUserIdentitiesResponsePrimary(
                provider = '',
                email = '',
                name = ''
            )
    ...
    def testAdminUserIdentitiesResponsePrimary(self):
        """Test AdminUserIdentitiesResponsePrimary"""
