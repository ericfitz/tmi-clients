...
class TestListUserQuotasResponseDefaults(unittest.TestCase):
    """ListUserQuotasResponseDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ListUserQuotasResponseDefaults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListUserQuotasResponseDefaults`
        """
        model = ListUserQuotasResponseDefaults()
        if include_optional:
            return ListUserQuotasResponseDefaults(
    ...
    def testListUserQuotasResponseDefaults(self):
        """Test ListUserQuotasResponseDefaults"""
