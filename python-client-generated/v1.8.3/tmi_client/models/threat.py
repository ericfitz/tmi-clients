...
class Threat(BaseModel):
    ...
    auto_generated: Optional[StrictBool] = Field(default=None, description="True when the threat was created by an automation/service-account principal. Sticky from creation.")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "mitigation", "diagram_id", "cell_id", "severity", "score", "priority", "mitigated", "status", "threat_type", "metadata", "issue_uri", "asset_id", "cwe_id", "cvss", "include_in_report", "timmy_enabled", "ssvc", "id", "threat_model_id", "created_at", "modified_at", "deleted_at", "auto_generated", "alias", "version"]
    ...
    @field_validator('diagram_id', mode="before")
    ...
    @field_validator('threat_model_id', mode="before")
