...
class ListAddonQuotasResponseDefaults(BaseModel):
    """
    Server default quota values applied when a user has no quota row
    """ # noqa: E501
    max_active_invocations: StrictInt = Field(description="Default max active invocations limit")
    max_invocations_per_hour: StrictInt = Field(description="Default max invocations-per-hour limit")
