...
class ListWebhookQuotasResponseDefaults(BaseModel):
    """
    Server default quota values applied when a user has no quota row
    """ # noqa: E501
    max_subscriptions: StrictInt = Field(description="Default max subscriptions limit")
    max_events_per_minute: StrictInt = Field(description="Default max events-per-minute limit")
    max_subscription_requests_per_minute: StrictInt = Field(description="Default max subscription requests-per-minute limit")
    max_subscription_requests_per_day: StrictInt = Field(description="Default max subscription requests-per-day limit")
