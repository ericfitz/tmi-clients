...
class SAMLApi:
    ...
    def list_saml_users(
        ...
        limit: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=0)]], Field(description="Maximum number of users to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of users to skip before starting to return results.")] = None,
        ...
        :type limit: int
        :param offset: Number of users to skip before starting to return results.
        :type offset: int
        ...
        _param = self._list_saml_users_serialize(
            idp=idp,
            email=email,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def list_saml_users_with_http_info(
        self,
        idp: Annotated[str, Field(strict=True, max_length=100, description="Identity provider ID (e.g., saml_okta, saml_azure)")],
        email: Annotated[Optional[Annotated[str, Field(strict=True, max_length=1024)]], Field(description="Filter by email (case-insensitive substring match)")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=0)]], Field(description="Maximum number of users to return.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListSAMLUsers200Response]:
        """List SAML users for UI autocomplete
    ...
    @validate_call
    def list_saml_users_without_preload_content(
        self,
        idp: Annotated[str, Field(strict=True, max_length=100, description="Identity provider ID (e.g., saml_okta, saml_azure)")],
        email: Annotated[Optional[Annotated[str, Field(strict=True, max_length=1024)]], Field(description="Filter by email (case-insensitive substring match)")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=0)]], Field(description="Maximum number of users to return.")] = None,
    ...
    def _list_saml_users_serialize(
        self,
        idp,
        email,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/saml/providers/{idp}/users',
