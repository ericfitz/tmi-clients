...
class AdministrationApi:
    ...
    def add_group_member(
        self,
        group_id: Annotated[UUID, Field(description="Internal system UUID of the group")],
        ...
        :param group_id: Internal system UUID of the group (required)
        :type group_id: UUID
    ...
    def _add_group_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/groups/{group_id}/members',
    ...
    def delete_addon_invocation_quota(
        self,
        user_id: Annotated[UUID, Field(description="Internal system UUID of the user")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_id: Internal system UUID of the user (required)
        :type user_id: UUID
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_admin_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/admin/groups/{group_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_admin_groups(
        ...
        built_in: Annotated[Optional[StrictBool], Field(description="Filter groups by built-in (server-seeded) status")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=0)]], Field(description="Maximum number of results to return")] = None,
        offset: Annotated[Optional[Annotated[int, Field(le=1000000, strict=True, ge=0)]], Field(description="Number of results to skip")] = None,
        ...
        :param built_in: Filter groups by built-in (server-seeded) status
        :type built_in: bool
        :param limit: Maximum number of results to return
        :type limit: int
        :param offset: Number of results to skip
    ...
    def _list_admin_groups_serialize(
        ...
        if built_in is not None:
            ...
            _query_params.append(('built_in', built_in))
    ...
    def _remove_group_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/admin/groups/{group_id}/members/{member_uuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _transfer_admin_user_ownership_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/users/{user_id}/transfer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
