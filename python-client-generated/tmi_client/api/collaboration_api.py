...
class CollaborationApi(object):
    ...
    def get_current_user_sessions(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_current_user_sessions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_current_user_sessions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_current_user_sessions_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_current_user_sessions_with_http_info(self, **kwargs):  # noqa: E501
        """List active collaboration sessions  # noqa: E501

        Returns all currently active collaboration sessions for diagrams. Clients can use this endpoint to discover existing sessions before connecting via WebSocket.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_current_user_sessions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_current_user_sessions" % key
                )
            params[key] = val
        del params['kwargs']
