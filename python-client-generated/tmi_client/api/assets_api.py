...
class AssetsApi(object):
    ...
    def patch_threat_model_asset(self, body, threat_model_id, asset_id, **kwargs):  # noqa: E501
        """Partially update asset  # noqa: E501

        Apply JSON Patch operations to partially update a asset  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_threat_model_asset(body, threat_model_id, asset_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[JsonPatchDocumentInner] body: JSON Patch operations to apply to the asset (required)
        ...
        if kwargs.get('async_req'):
            return self.patch_threat_model_asset_with_http_info(body, threat_model_id, asset_id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_threat_model_asset_with_http_info(body, threat_model_id, asset_id, **kwargs)  # noqa: E501
            return data

    def patch_threat_model_asset_with_http_info(self, body, threat_model_id, asset_id, **kwargs):  # noqa: E501
        """Partially update asset  # noqa: E501

        Apply JSON Patch operations to partially update a asset  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_threat_model_asset_with_http_info(body, threat_model_id, asset_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method patch_threat_model_asset" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_threat_model_asset`")  # noqa: E501
        # verify the required parameter 'threat_model_id' is set
        if ('threat_model_id' not in params or
                params['threat_model_id'] is None):
            raise ValueError("Missing the required parameter `threat_model_id` when calling `patch_threat_model_asset`")  # noqa: E501
        # verify the required parameter 'asset_id' is set
        if ('asset_id' not in params or
                params['asset_id'] is None):
            raise ValueError("Missing the required parameter `asset_id` when calling `patch_threat_model_asset`")  # noqa: E501
