...
class AdministrationApi(object):
    ...
    def add_group_member(self, body, internal_uuid, **kwargs):  # noqa: E501
        ...
        :param AddGroupMemberRequest body: Group membership update (required)
    ...
    def create_admin_group(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param CreateAdminGroupRequest body: Group creation request (required)
        :return: AdminGroup
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def reencrypt_system_settings(self, **kwargs):  # noqa: E501
        """Re-encrypt all system settings  # noqa: E501

        Re-encrypts all system settings with the current encryption key. Use this after rotating the encryption key or when first enabling encryption on existing settings. Requires administrator privileges. Settings that cannot be decrypted are reported as errors but do not prevent other settings from being processed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reencrypt_system_settings(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.reencrypt_system_settings_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reencrypt_system_settings_with_http_info(**kwargs)  # noqa: E501
            return data

    def reencrypt_system_settings_with_http_info(self, **kwargs):  # noqa: E501
        """Re-encrypt all system settings  # noqa: E501

        Re-encrypts all system settings with the current encryption key. Use this after rotating the encryption key or when first enabling encryption on existing settings. Requires administrator privileges. Settings that cannot be decrypted are reported as errors but do not prevent other settings from being processed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reencrypt_system_settings_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method reencrypt_system_settings" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def remove_group_member(self, internal_uuid, member_uuid, **kwargs):  # noqa: E501
        """Remove member from group  # noqa: E501

        Removes a user or nested group from a group. Use the subject_type query parameter to specify whether the member is a user (default) or a group. Cannot remove members from the special 'everyone' pseudo-group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_group_member(internal_uuid, member_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str internal_uuid: Internal system UUID of the user (required)
        :param str member_uuid: Internal system UUID of the member to remove (user UUID when subject_type is user, group UUID when subject_type is group) (required)
        :param str subject_type: Type of member to remove: 'user' (default) for a user member, 'group' for a nested group member
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.remove_group_member_with_http_info(internal_uuid, member_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.remove_group_member_with_http_info(internal_uuid, member_uuid, **kwargs)  # noqa: E501
            return data

    def remove_group_member_with_http_info(self, internal_uuid, member_uuid, **kwargs):  # noqa: E501
        """Remove member from group  # noqa: E501

        Removes a user or nested group from a group. Use the subject_type query parameter to specify whether the member is a user (default) or a group. Cannot remove members from the special 'everyone' pseudo-group.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_group_member_with_http_info(internal_uuid, member_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['internal_uuid', 'member_uuid', 'subject_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('member_uuid' not in params or
                params['member_uuid'] is None):
            raise ValueError("Missing the required parameter `member_uuid` when calling `remove_group_member`")  # noqa: E501
        ...
        if 'internal_uuid' in params:
            path_params['internal_uuid'] = params['internal_uuid']  # noqa: E501
        if 'member_uuid' in params:
            path_params['member_uuid'] = params['member_uuid']  # noqa: E501

        query_params = []
        if 'subject_type' in params:
            query_params.append(('subject_type', params['subject_type']))  # noqa: E501
    ...
    def transfer_admin_user_ownership(self, body, internal_uuid, **kwargs):  # noqa: E501
        """Transfer user ownership to another user  # noqa: E501

        Transfers ownership of all threat models and survey responses owned by the specified user to the target user. The source user is downgraded to writer role on all transferred items. Requires administrator privileges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_admin_user_ownership(body, internal_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TransferOwnershipRequest body: Ownership transfer request specifying the target user (required)
        :param str internal_uuid: Internal system UUID of the user (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.transfer_admin_user_ownership_with_http_info(body, internal_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.transfer_admin_user_ownership_with_http_info(body, internal_uuid, **kwargs)  # noqa: E501
            return data

    def transfer_admin_user_ownership_with_http_info(self, body, internal_uuid, **kwargs):  # noqa: E501
        """Transfer user ownership to another user  # noqa: E501

        Transfers ownership of all threat models and survey responses owned by the specified user to the target user. The source user is downgraded to writer role on all transferred items. Requires administrator privileges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_admin_user_ownership_with_http_info(body, internal_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method transfer_admin_user_ownership" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `transfer_admin_user_ownership`")  # noqa: E501
        # verify the required parameter 'internal_uuid' is set
        if ('internal_uuid' not in params or
                params['internal_uuid'] is None):
            raise ValueError("Missing the required parameter `internal_uuid` when calling `transfer_admin_user_ownership`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TransferOwnershipResult',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_addon_invocation_quota(self, body, user_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param AddonQuotaUpdate body: Addon quota update configuration (required)
        :param str user_id: User ID (required)
        :return: AddonInvocationQuota
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_admin_group(self, body, internal_uuid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UpdateAdminGroupRequest body: Group update details (required)
        :param str internal_uuid: Internal system UUID of the user (required)
        :return: AdminGroup
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_admin_user(self, body, internal_uuid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UpdateAdminUserRequest body: User profile update (required)
        :param str internal_uuid: Internal system UUID of the user (required)
        :return: AdminUser
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_user_api_quota(self, body, user_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UserQuotaUpdate body: User quota update configuration (required)
        :param str user_id: User ID (required)
        :return: UserAPIQuota
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_webhook_quota(self, body, user_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param WebhookQuotaUpdate body: Webhook quota update configuration (required)
        :param str user_id: User ID (required)
        :return: WebhookQuota
                 If the method is called asynchronously,
                 returns the request thread.
