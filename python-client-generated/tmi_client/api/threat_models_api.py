...
class ThreatModelsApi(object):
    ...
    def create_threat_model(self, body, **kwargs):  # noqa: E501
        ...
        :param ThreatModelInput body: Threat Model creation data (required)
        :return: ThreatModel
    ...
    def list_threat_models_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'owner', 'name', 'description', 'issue_uri', 'created_after', 'created_before', 'modified_after', 'modified_before', 'status', 'status_updated_after', 'status_updated_before', 'include_deleted']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def patch_threat_model(self, threat_model_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str threat_model_id: Threat model identifier (required)
        :param list[JsonPatchDocumentInner] body: JSON Patch operations to apply to the threat model
        :return: ThreatModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def restore_threat_model(self, threat_model_id, **kwargs):  # noqa: E501
        """Restore a soft-deleted threat model  # noqa: E501

        Restores a soft-deleted threat model and all its soft-deleted children (diagrams, threats, assets, documents, notes, repositories). Restricted to owner role or administrators.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.restore_threat_model(threat_model_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.restore_threat_model_with_http_info(threat_model_id, **kwargs)  # noqa: E501
        else:
            (data) = self.restore_threat_model_with_http_info(threat_model_id, **kwargs)  # noqa: E501
            return data

    def restore_threat_model_with_http_info(self, threat_model_id, **kwargs):  # noqa: E501
        """Restore a soft-deleted threat model  # noqa: E501

        Restores a soft-deleted threat model and all its soft-deleted children (diagrams, threats, assets, documents, notes, repositories). Restricted to owner role or administrators.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.restore_threat_model_with_http_info(threat_model_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method restore_threat_model" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'threat_model_id' is set
        if ('threat_model_id' not in params or
                params['threat_model_id'] is None):
            raise ValueError("Missing the required parameter `threat_model_id` when calling `restore_threat_model`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/threat_models/{threat_model_id}/restore', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_threat_model(self, body, threat_model_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ThreatModelInput body: Complete threat model data for replacement (required)
        :param str threat_model_id: Threat model identifier (required)
        :return: ThreatModel
                 If the method is called asynchronously,
                 returns the request thread.
