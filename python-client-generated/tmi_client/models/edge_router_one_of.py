...
class EdgeRouterOneOf(BaseModel):
    """
    Router with custom configuration
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=256)] = Field(description="Router algorithm name")
    args: Optional[EdgeRouterOneOfArgs] = None
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['normal', 'orth', 'one_side', 'manhattan', 'metro', 'er']):
            raise ValueError("must be one of enum values ('normal', 'orth', 'one_side', 'manhattan', 'metro', 'er')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "args": EdgeRouterOneOfArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
