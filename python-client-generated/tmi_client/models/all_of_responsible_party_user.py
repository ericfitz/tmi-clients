...
class AllOfResponsiblePartyUser(User):
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """AllOfResponsiblePartyUser - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfResponsiblePartyUser, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfResponsiblePartyUser):
            return False
