...
class TriageNoteInput(TriageNoteBase):
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """TriageNoteInput - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TriageNoteInput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TriageNoteInput):
            return False
