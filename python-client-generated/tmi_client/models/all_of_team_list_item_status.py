...
import six
from tmi_client.models.team_status import TeamStatus  # noqa: F401,E501

class AllOfTeamListItemStatus(TeamStatus):
    ...
    if hasattr(TeamStatus, "swagger_types"):
        swagger_types.update(TeamStatus.swagger_types)

    attribute_map = {
    }
    if hasattr(TeamStatus, "attribute_map"):
        attribute_map.update(TeamStatus.attribute_map)

    def __init__(self, **kwargs):  # noqa: E501
        """AllOfTeamListItemStatus - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        TeamStatus.__init__(self, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfTeamListItemStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfTeamListItemStatus):
            return False
