...
class TransferOwnershipResultSurveyResponsesTransferred(BaseModel):
    """
    Survey responses that were transferred
    """ # noqa: E501
    count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of survey responses transferred")
    survey_response_ids: Annotated[List[UUID], Field(max_length=10000)] = Field(description="IDs of the transferred survey responses")
    __properties: ClassVar[List[str]] = ["count", "survey_response_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "survey_response_ids": obj.get("survey_response_ids")
        })
        return _obj
