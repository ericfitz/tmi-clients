...
class TransferOwnershipResultThreatModelsTransferred(BaseModel):
    """
    Threat models that were transferred
    """ # noqa: E501
    count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of threat models transferred")
    threat_model_ids: Annotated[List[UUID], Field(max_length=10000)] = Field(description="IDs of the transferred threat models")
    __properties: ClassVar[List[str]] = ["count", "threat_model_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "threat_model_ids": obj.get("threat_model_ids")
        })
        return _obj
