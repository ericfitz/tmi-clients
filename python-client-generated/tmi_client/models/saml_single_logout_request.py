...
class SamlSingleLogoutRequest(object):
    ...
    def saml_request(self):
        """Gets the saml_request of this SamlSingleLogoutRequest.  # noqa: E501

        Base64-encoded SAML logout request  # noqa: E501

        :return: The saml_request of this SamlSingleLogoutRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def saml_request(self, saml_request):
        """Sets the saml_request of this SamlSingleLogoutRequest.

        Base64-encoded SAML logout request  # noqa: E501

        :param saml_request: The saml_request of this SamlSingleLogoutRequest.  # noqa: E501
        :type: str
        """
        if saml_request is None:
            raise ValueError("Invalid value for `saml_request`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SamlSingleLogoutRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SamlSingleLogoutRequest):
            return False
