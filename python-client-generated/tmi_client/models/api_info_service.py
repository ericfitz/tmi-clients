...
class ApiInfoService(object):
    ...
    def __init__(self, name=None, build=None, **kwargs):  # noqa: E501
        """ApiInfoService - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._build = None
    ...
    @property
    def name(self):
        """Gets the name of this ApiInfoService.  # noqa: E501

        Name of the service  # noqa: E501

        :return: The name of this ApiInfoService.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ApiInfoService.

        Name of the service  # noqa: E501

        :param name: The name of this ApiInfoService.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def build(self):
        """Gets the build of this ApiInfoService.  # noqa: E501

        Current build number  # noqa: E501

        :return: The build of this ApiInfoService.  # noqa: E501
        :rtype: str
        """
        return self._build
    ...
    def build(self, build):
        """Sets the build of this ApiInfoService.

        Current build number  # noqa: E501

        :param build: The build of this ApiInfoService.  # noqa: E501
        :type: str
        """
        if build is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiInfoService, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiInfoService):
            return False
