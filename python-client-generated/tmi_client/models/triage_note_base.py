...
class TriageNoteBase(object):
    ...
    def __init__(self, name=None, content=None, **kwargs):  # noqa: E501
        """TriageNoteBase - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._content = None
    ...
    @property
    def name(self):
        """Gets the name of this TriageNoteBase.  # noqa: E501

        Triage note name  # noqa: E501

        :return: The name of this TriageNoteBase.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TriageNoteBase.

        Triage note name  # noqa: E501

        :param name: The name of this TriageNoteBase.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TriageNoteBase, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TriageNoteBase):
            return False
