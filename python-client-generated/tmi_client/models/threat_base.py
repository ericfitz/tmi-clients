...
class ThreatBase(object):
    ...
    def __init__(self, name=None, description=None, mitigation=None, diagram_id=None, cell_id=None, severity=None, score=None, priority=None, mitigated=None, status=None, threat_type=None, metadata=None, issue_uri=None, asset_id=None, cwe_id=None, cvss=None, **kwargs):  # noqa: E501
