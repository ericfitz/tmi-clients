...
class JsonPatchDocumentInner(object):
    ...
    @property
    def op(self):
        """Gets the op of this JsonPatchDocumentInner.  # noqa: E501

        Patch operation type  # noqa: E501

        :return: The op of this JsonPatchDocumentInner.  # noqa: E501
        :rtype: str
        """
        return self._op
    ...
    @op.setter
    def op(self, op):
        """Sets the op of this JsonPatchDocumentInner.

        Patch operation type  # noqa: E501

        :param op: The op of this JsonPatchDocumentInner.  # noqa: E501
        :type: str
        """
        if op is None:
    ...
    @property
    def path(self):
        """Gets the path of this JsonPatchDocumentInner.  # noqa: E501

        JSON path to target  # noqa: E501

        :return: The path of this JsonPatchDocumentInner.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this JsonPatchDocumentInner.

        JSON path to target  # noqa: E501

        :param path: The path of this JsonPatchDocumentInner.  # noqa: E501
        :type: str
        """
        if path is None:
    ...
    @property
    def value(self):
        """Gets the value of this JsonPatchDocumentInner.  # noqa: E501
    ...
    def value(self, value):
        """Sets the value of this JsonPatchDocumentInner.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JsonPatchDocumentInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JsonPatchDocumentInner):
            return False
