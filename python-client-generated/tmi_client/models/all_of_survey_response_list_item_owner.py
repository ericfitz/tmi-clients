...
class AllOfSurveyResponseListItemOwner(User):
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """AllOfSurveyResponseListItemOwner - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfSurveyResponseListItemOwner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfSurveyResponseListItemOwner):
            return False
