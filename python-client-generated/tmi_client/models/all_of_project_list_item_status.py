...
import six
from tmi_client.models.project_status import ProjectStatus  # noqa: F401,E501

class AllOfProjectListItemStatus(ProjectStatus):
    ...
    if hasattr(ProjectStatus, "swagger_types"):
        swagger_types.update(ProjectStatus.swagger_types)

    attribute_map = {
    }
    if hasattr(ProjectStatus, "attribute_map"):
        attribute_map.update(ProjectStatus.attribute_map)

    def __init__(self, **kwargs):  # noqa: E501
        """AllOfProjectListItemStatus - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        ProjectStatus.__init__(self, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfProjectListItemStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfProjectListItemStatus):
            return False
