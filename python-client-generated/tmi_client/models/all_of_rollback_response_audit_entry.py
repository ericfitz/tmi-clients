...
import six
from tmi_client.models.audit_entry import AuditEntry  # noqa: F401,E501

class AllOfRollbackResponseAuditEntry(AuditEntry):
    ...
    if hasattr(AuditEntry, "swagger_types"):
        swagger_types.update(AuditEntry.swagger_types)

    attribute_map = {
    }
    if hasattr(AuditEntry, "attribute_map"):
        attribute_map.update(AuditEntry.attribute_map)

    def __init__(self, **kwargs):  # noqa: E501
        """AllOfRollbackResponseAuditEntry - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        AuditEntry.__init__(self, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfRollbackResponseAuditEntry, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfRollbackResponseAuditEntry):
            return False
