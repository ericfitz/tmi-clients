...
class InlineResponse2006(object):
    ...
    def __init__(self, sub=None, email=None, name=None, idp=None, groups=None, **kwargs):  # noqa: E501
    ...
    def sub(self):
        ...
        Subject identifier - unique identifier for the user (required per OIDC)  # noqa: E501
    ...
    def idp(self):
        ...
        Identity provider that authenticated the user  # noqa: E501
