...
class MinimalCell(object):
    ...
    discriminator_value_class_map = {
            'actor'.lower(): '#/components/schemas/MinimalNode',
            'process'.lower(): '#/components/schemas/MinimalNode',
            'store'.lower(): '#/components/schemas/MinimalNode',
            'security-boundary'.lower(): '#/components/schemas/MinimalNode',
            'text-box'.lower(): '#/components/schemas/MinimalNode',
            'flow'.lower(): '#/components/schemas/MinimalEdge',
            'MinimalEdge'.lower(): 'flow',
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MinimalCell, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MinimalCell):
            return False
