...
class BaseDiagram(object):
    ...
    def __init__(self, id=None, name=None, type=None, created_at=None, modified_at=None, metadata=None, update_vector=None, image=None, description=None, include_in_report=True, **kwargs):  # noqa: E501
