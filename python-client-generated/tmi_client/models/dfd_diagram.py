...
class DfdDiagram(BaseDiagram):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "created_at", "modified_at", "metadata", "update_vector", "image", "description", "include_in_report", "timmy_enabled", "deleted_at", "color_palette", "cells"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "update_vector": obj.get("update_vector"),
            ...
            "color_palette": [ColorPaletteEntry.from_dict(_item) for _item in obj["color_palette"]] if obj.get("color_palette") is not None else None,
            "cells": [DfdDiagramAllOfCells.from_dict(_item) for _item in obj["cells"]] if obj.get("cells") is not None else None
        })
        return _obj
