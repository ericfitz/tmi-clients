...
class WsTicketResponse(object):
    ...
    def __init__(self, ticket=None, **kwargs):  # noqa: E501
        """WsTicketResponse - a model defined in Swagger"""  # noqa: E501
        self._ticket = None
    ...
    @property
    def ticket(self):
        """Gets the ticket of this WsTicketResponse.  # noqa: E501

        Short-lived, single-use authentication ticket for WebSocket connection  # noqa: E501

        :return: The ticket of this WsTicketResponse.  # noqa: E501
        :rtype: str
        """
        return self._ticket
    ...
    def ticket(self, ticket):
        """Sets the ticket of this WsTicketResponse.

        Short-lived, single-use authentication ticket for WebSocket connection  # noqa: E501

        :param ticket: The ticket of this WsTicketResponse.  # noqa: E501
        :type: str
        """
        if ticket is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WsTicketResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WsTicketResponse):
            return False
