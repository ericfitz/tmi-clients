...
class ListWebhookQuotasResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quotas": [WebhookQuota.from_dict(_item) for _item in obj["quotas"]] if obj.get("quotas") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "defaults": ListWebhookQuotasResponseDefaults.from_dict(obj["defaults"]) if obj.get("defaults") is not None else None
        })
        return _obj
