...
class AdminGroup(BaseModel):
    ...
    usage_count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of times this group has been referenced")
    used_in_authorizations: Optional[StrictBool] = Field(default=None, description="Whether this group is used in any authorizations (enriched)")
    used_in_admin_grants: Optional[StrictBool] = Field(default=None, description="Whether this group is used in any admin grants (enriched)")
    member_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of members in the group from IdP (enriched, if available)")
    is_builtin: Optional[StrictBool] = Field(default=None, description="True only for server-seeded built-in groups; false for admin-created groups (which also use provider \"tmi\")")
    __properties: ClassVar[List[str]] = ["internal_uuid", "provider", "group_name", "name", "description", "first_used", "last_used", "usage_count", "used_in_authorizations", "used_in_admin_grants", "member_count", "is_builtin"]
