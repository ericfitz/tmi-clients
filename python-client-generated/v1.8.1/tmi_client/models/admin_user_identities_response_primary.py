...
class AdminUserIdentitiesResponsePrimary(BaseModel):
    """
    AdminUserIdentitiesResponsePrimary
    """ # noqa: E501
    provider: StrictStr = Field(description="Identity provider of the primary sign-in identity")
    email: StrictStr = Field(description="Email on the user record")
    name: StrictStr = Field(description="Display name on the user record")
    __properties: ClassVar[List[str]] = ["provider", "email", "name"]
