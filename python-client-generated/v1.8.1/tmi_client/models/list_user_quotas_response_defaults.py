...
class ListUserQuotasResponseDefaults(BaseModel):
    """
    Server default quota values applied when a user has no quota row
    """ # noqa: E501
    max_requests_per_minute: StrictInt = Field(description="Default requests-per-minute limit")
    max_requests_per_hour: StrictInt = Field(description="Default requests-per-hour limit")
