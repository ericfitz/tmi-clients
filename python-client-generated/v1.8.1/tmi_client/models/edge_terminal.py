...
class EdgeTerminal(BaseModel):
    ...
    """ # noqa: E501
    cell: UUID = Field(description="ID of the connected node (UUID)", json_schema_extra={"examples": ["37eaedfa-bf37-4996-8665-242fec34bbff"]})
    port: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="ID of the specific port on the node (optional)")
