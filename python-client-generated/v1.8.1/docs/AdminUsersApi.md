...
------------- | ------------- | -------------
[**admin_delete_user_content_token**](AdminUsersApi.md#admin_delete_user_content_token) | **DELETE** /admin/users/{user_id}/content_tokens/{provider_id} | Revoke a user&#39;s linked content provider token (admin)
[**admin_delete_user_identity**](AdminUsersApi.md#admin_delete_user_identity) | **DELETE** /admin/users/{user_id}/identities/{identity_id} | Unlink a user&#39;s linked sign-in identity (admin)
[**admin_list_user_content_tokens**](AdminUsersApi.md#admin_list_user_content_tokens) | **GET** /admin/users/{user_id}/content_tokens | List a user&#39;s linked content provider tokens (admin)
[**admin_list_user_identities**](AdminUsersApi.md#admin_list_user_identities) | **GET** /admin/users/{user_id}/identities | List a user&#39;s primary and linked sign-in identities (admin)
[**create_admin_user_client_credential**](AdminUsersApi.md#create_admin_user_client_credential) | **POST** /admin/users/{user_id}/client_credentials | Create a client credential for an automation user
...
[**delete_admin_user_client_credential**](AdminUsersApi.md#delete_admin_user_client_credential) | **DELETE** /admin/users/{user_id}/client_credentials/{credential_id} | Delete a client credential for an automation user
[**list_admin_user_client_credentials**](AdminUsersApi.md#list_admin_user_client_credentials) | **GET** /admin/users/{user_id}/client_credentials | List client credentials for an automation user


# **admin_delete_user_content_token**
> admin_delete_user_content_token(user_id, provider_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Revoke a user's linked content provider token (admin)
        api_instance.admin_delete_user_content_token(user_id, provider_id)
...
# **admin_delete_user_identity**
> admin_delete_user_identity(user_id, identity_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = tmi_client.AdminUsersApi(api_client)
    user_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Internal system UUID of the user
    identity_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Linked identity unique identifier

    try:
        # Unlink a user's linked sign-in identity (admin)
        api_instance.admin_delete_user_identity(user_id, identity_id)
    except Exception as e:
        print("Exception when calling AdminUsersApi->admin_delete_user_identity: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **user_id** | **UUID**| Internal system UUID of the user | 
 **identity_id** | **UUID**| Linked identity unique identifier | 
...
> ContentTokenList admin_list_user_content_tokens(user_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List a user's linked content provider tokens (admin)
        api_response = api_instance.admin_list_user_content_tokens(user_id)
...
# **admin_list_user_identities**
> AdminUserIdentitiesResponse admin_list_user_identities(user_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List a user's primary and linked sign-in identities (admin)
        api_response = api_instance.admin_list_user_identities(user_id)
        print("The response of AdminUsersApi->admin_list_user_identities:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AdminUsersApi->admin_list_user_identities: %s\n" % e)
```
...
> ClientCredentialResponse create_admin_user_client_credential(user_id, create_current_user_client_credential_request)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a client credential for an automation user
        api_response = api_instance.create_admin_user_client_credential(user_id, create_current_user_client_credential_request)
...
> delete_admin_user_client_credential(user_id, credential_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a client credential for an automation user
        api_instance.delete_admin_user_client_credential(user_id, credential_id)
    except Exception as e:
...
> ListClientCredentialsResponse list_admin_user_client_credentials(user_id, limit=limit, offset=offset)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List client credentials for an automation user
        api_response = api_instance.list_admin_user_client_credentials(user_id, limit=limit, offset=offset)
