...
class TestAdminGroupListResponse(unittest.TestCase):
    """AdminGroupListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test AdminGroupListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminGroupListResponse`
        """
        model = AdminGroupListResponse()
        if include_optional:
            return AdminGroupListResponse(
                groups = [
                    {"internal_uuid":"e50eabcd-e89b-41d4-a716-446655440014","group_name":"engineering-team","name":"Engineering","description":"Engineering team members","provider":"github","provider_group_id":"org-engineering","member_count":25,"first_used":"2024-01-02T10:00:00Z","last_used":"2024-01-20T15:00:00Z","usage_count":150,"created_at":"2024-01-02T10:00:00Z","modified_at":"2024-01-02T10:00:00Z","used_in_admin_grants":false,"used_in_authorizations":false,"is_builtin":false}
                    ],
                total = 0,
                limit = 0,
                offset = 0
    ...
    def testAdminGroupListResponse(self):
        """Test AdminGroupListResponse"""
