...
class TestResponsiblePartyInput(unittest.TestCase):
    """ResponsiblePartyInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ResponsiblePartyInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponsiblePartyInput`
        """
        model = ResponsiblePartyInput()
        if include_optional:
            return ResponsiblePartyInput(
                user_id = '62ECB020-8429-30cc-01FF-CCfeEe150AC3',
                role = 'engineering_lead',
                custom_role = 'jUR,rZ#UM/?R,Fp^l6$ARj'
            )
        else:
            return ResponsiblePartyInput(
                user_id = '62ECB020-8429-30cc-01FF-CCfeEe150AC3',
    ...
    def testResponsiblePartyInput(self):
        """Test ResponsiblePartyInput"""
