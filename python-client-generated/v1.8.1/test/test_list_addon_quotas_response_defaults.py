...
class TestListAddonQuotasResponseDefaults(unittest.TestCase):
    """ListAddonQuotasResponseDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ListAddonQuotasResponseDefaults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAddonQuotasResponseDefaults`
        """
        model = ListAddonQuotasResponseDefaults()
        if include_optional:
            return ListAddonQuotasResponseDefaults(
    ...
    def testListAddonQuotasResponseDefaults(self):
        """Test ListAddonQuotasResponseDefaults"""
