...
class TestListWebhookQuotasResponseDefaults(unittest.TestCase):
    """ListWebhookQuotasResponseDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ListWebhookQuotasResponseDefaults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListWebhookQuotasResponseDefaults`
        """
        model = ListWebhookQuotasResponseDefaults()
        if include_optional:
            return ListWebhookQuotasResponseDefaults(
    ...
    def testListWebhookQuotasResponseDefaults(self):
        """Test ListWebhookQuotasResponseDefaults"""
