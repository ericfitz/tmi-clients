...
class TestListSAMLUsers200ResponseUsersInner(unittest.TestCase):
    """ListSAMLUsers200ResponseUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ListSAMLUsers200ResponseUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListSAMLUsers200ResponseUsersInner`
        """
        model = ListSAMLUsers200ResponseUsersInner()
        if include_optional:
            return ListSAMLUsers200ResponseUsersInner(
    ...
    def testListSAMLUsers200ResponseUsersInner(self):
        """Test ListSAMLUsers200ResponseUsersInner"""
