...
class TestConfirmIdentityLink429Response(unittest.TestCase):
    """ConfirmIdentityLink429Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ConfirmIdentityLink429Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmIdentityLink429Response`
        """
        model = ConfirmIdentityLink429Response()
        if include_optional:
            return ConfirmIdentityLink429Response(
                error = '',
                retry_after = 56
            )
        else:
    ...
    def testConfirmIdentityLink429Response(self):
        """Test ConfirmIdentityLink429Response"""
