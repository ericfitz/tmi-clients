...
class TestAdminUsersApi(unittest.TestCase):
    ...
    def test_admin_delete_user_content_token(self) -> None:
        """Test case for admin_delete_user_content_token

        Revoke a user's linked content provider token (admin)
        """
        pass

    def test_admin_delete_user_identity(self) -> None:
        """Test case for admin_delete_user_identity

        Unlink a user's linked sign-in identity (admin)
        """
        pass

    def test_admin_list_user_content_tokens(self) -> None:
        """Test case for admin_list_user_content_tokens

        List a user's linked content provider tokens (admin)
        """
        pass

    def test_admin_list_user_identities(self) -> None:
        """Test case for admin_list_user_identities
