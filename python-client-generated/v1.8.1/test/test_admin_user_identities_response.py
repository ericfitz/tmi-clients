...
class TestAdminUserIdentitiesResponse(unittest.TestCase):
    """AdminUserIdentitiesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test AdminUserIdentitiesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminUserIdentitiesResponse`
        """
        model = AdminUserIdentitiesResponse()
        if include_optional:
            return AdminUserIdentitiesResponse(
                primary = tmi_client.models.admin_user_identities_response_primary.AdminUserIdentitiesResponse_primary(
                    provider = '', 
                    email = '', 
                    name = '', ),
                linked = [
                    tmi_client.models.linked_identity.LinkedIdentity(
                        id = '', 
                        provider = '', 
                        provider_user_id = '', 
                        email = '', 
    ...
    def testAdminUserIdentitiesResponse(self):
        """Test AdminUserIdentitiesResponse"""
