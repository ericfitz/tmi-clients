...
[**create_team_note**](TeamsApi.md#create_team_note) | **POST** /teams/{team_id}/notes | Create a new team note
...
[**delete_team_note**](TeamsApi.md#delete_team_note) | **DELETE** /teams/{team_id}/notes/{team_note_id} | Delete a team note
...
[**get_team_note**](TeamsApi.md#get_team_note) | **GET** /teams/{team_id}/notes/{team_note_id} | Get a specific team note
[**list_team_notes**](TeamsApi.md#list_team_notes) | **GET** /teams/{team_id}/notes | List notes in a team
[**list_teams**](TeamsApi.md#list_teams) | **GET** /teams | List teams
[**patch_team**](TeamsApi.md#patch_team) | **PATCH** /teams/{team_id} | Patch a team
[**patch_team_note**](TeamsApi.md#patch_team_note) | **PATCH** /teams/{team_id}/notes/{team_note_id} | Partially update a team note
...
[**update_team_note**](TeamsApi.md#update_team_note) | **PUT** /teams/{team_id}/notes/{team_note_id} | Update a team note


# **bulk_create_team_metadata**
> List[Metadata] bulk_create_team_metadata(team_id, metadata)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = tmi_client.TeamsApi(api_client)
    team_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Team identifier (UUID)
    metadata = [tmi_client.Metadata()] # List[Metadata] | Bulk metadata entries to create

    try:
        # Bulk create team metadata
        api_response = api_instance.bulk_create_team_metadata(team_id, metadata)
        print("The response of TeamsApi->bulk_create_team_metadata:\n")
        pprint(api_response)
...
------------- | ------------- | ------------- | -------------
 **team_id** | **UUID**| Team identifier (UUID) | 
...
> List[Metadata] bulk_replace_team_metadata(team_id, metadata)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Bulk replace team metadata
        api_response = api_instance.bulk_replace_team_metadata(team_id, metadata)
        print("The response of TeamsApi->bulk_replace_team_metadata:\n")
        pprint(api_response)
    except Exception as e:
...
> List[Metadata] bulk_upsert_team_metadata(team_id, bulk_patch_request)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Bulk upsert team metadata
        api_response = api_instance.bulk_upsert_team_metadata(team_id, bulk_patch_request)
        print("The response of TeamsApi->bulk_upsert_team_metadata:\n")
        pprint(api_response)
    except Exception as e:
...
with tmi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tmi_client.TeamsApi(api_client)
    team_input = {"name":"Platform Engineering","description":"Core platform infrastructure team"} # TeamInput | Team creation data

    try:
        # Create a team
        api_response = api_instance.create_team(team_input)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **team_input** | [**TeamInput**](TeamInput.md)| Team creation data | 
...
> Metadata create_team_metadata(team_id, metadata)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create team metadata
        api_response = api_instance.create_team_metadata(team_id, metadata)
        print("The response of TeamsApi->create_team_metadata:\n")
        pprint(api_response)
    except Exception as e:
...
# **create_team_note**
> TeamNote create_team_note(team_id, body)
...
with tmi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tmi_client.TeamsApi(api_client)
    team_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Team UUID
    ...
    try:
        # Create a new team note
        api_response = api_instance.create_team_note(team_id, body)
        print("The response of TeamsApi->create_team_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TeamsApi->create_team_note: %s\n" % e)
```
...
# **delete_team_note**
> delete_team_note(team_id, team_note_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = tmi_client.TeamsApi(api_client)
    team_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Team UUID
    team_note_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Team note identifier

    try:
        # Delete a team note
        api_instance.delete_team_note(team_id, team_note_id)
    except Exception as e:
        print("Exception when calling TeamsApi->delete_team_note: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **team_id** | **UUID**| Team UUID | 
 **team_note_id** | **UUID**| Team note identifier | 
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TeamsApi->get_team_metadata:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_team_note**
> TeamNote get_team_note(team_id, team_note_id)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a specific team note
        api_response = api_instance.get_team_note(team_id, team_note_id)
        print("The response of TeamsApi->get_team_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TeamsApi->get_team_note: %s\n" % e)
```
...
# **list_team_notes**
> ListTeamNotesResponse list_team_notes(team_id, limit=limit, offset=offset)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List notes in a team
        api_response = api_instance.list_team_notes(team_id, limit=limit, offset=offset)
        print("The response of TeamsApi->list_team_notes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TeamsApi->list_team_notes: %s\n" % e)
```
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    member_user_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Filter teams that include this user as a member (optional)
    related_to = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Include teams related to this team ID (optional)
 ...
 **member_user_id** | **UUID**| Filter teams that include this user as a member | [optional] 
 **related_to** | **UUID**| Include teams related to this team ID | [optional] 
...
# **patch_team**
> Team patch_team(team_id, json_patch_document_inner, if_match=if_match)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = tmi_client.TeamsApi(api_client)
    team_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Team UUID
    json_patch_document_inner = [{"op":"replace","path":"/description","value":"Updated team description"}] # List[JsonPatchDocumentInner] | Partial team data for update
    if_match = 'if_match_example' # str | Optimistic-locking precondition. Pass the integer version returned by the previous read (or as the body 'version' field on the previous write). On version mismatch the server returns 409 Conflict. In a future release this header will be required and missing values will return 428 Precondition Required. Accepts an integer version (bare or ETag-quoted) or \"*\" for an unconditional write (RFC 7232). (optional)

    try:
        # Patch a team
        api_response = api_instance.patch_team(team_id, json_patch_document_inner, if_match=if_match)
...
------------- | ------------- | ------------- | -------------
 **team_id** | **UUID**| Team UUID | 
 **json_patch_document_inner** | [**List[JsonPatchDocumentInner]**](JsonPatchDocumentInner.md)| Partial team data for update | 
 **if_match** | **str**| Optimistic-locking precondition. Pass the integer version returned by the previous read (or as the body &#39;version&#39; field on the previous write). On version mismatch the server returns 409 Conflict. In a future release this header will be required and missing values will return 428 Precondition Required. Accepts an integer version (bare or ETag-quoted) or \&quot;*\&quot; for an unconditional write (RFC 7232). | [optional] 
...
**500** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**415** | Unsupported media type - the request Content-Type is not supported for this operation |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**200** | Team patched |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  * ETag - Current optimistic-locking version of the resource (RFC 7232). Echo this value back via If-Match on the next PUT/PATCH. <br>  |
**401** | Unauthorized |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**403** | Forbidden |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**404** | Team not found |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
...
# **patch_team_note**
> TeamNote patch_team_note(team_id, team_note_id, json_patch_document_inner)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    team_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Team UUID
    team_note_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Team note identifier
    json_patch_document_inner = [{"op":"replace","path":"/name","value":"Updated Note Title"}] # List[JsonPatchDocumentInner] | JSON Patch operations to apply to the team note

    try:
        # Partially update a team note
        api_response = api_instance.patch_team_note(team_id, team_note_id, json_patch_document_inner)
        print("The response of TeamsApi->patch_team_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TeamsApi->patch_team_note: %s\n" % e)
```
 ...
 **team_id** | **UUID**| Team UUID | 
 **team_note_id** | **UUID**| Team note identifier | 
 **json_patch_document_inner** | [**List[JsonPatchDocumentInner]**](JsonPatchDocumentInner.md)| JSON Patch operations to apply to the team note | 
...
# **update_team**
> Team update_team(team_id, team_input, if_match=if_match)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = tmi_client.TeamsApi(api_client)
    team_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Team UUID
    team_input = {"name":"Platform Engineering","description":"Core platform infrastructure team - updated"} # TeamInput | Complete team data for replacement
    if_match = 'if_match_example' # str | Optimistic-locking precondition. Pass the integer version returned by the previous read (or as the body 'version' field on the previous write). On version mismatch the server returns 409 Conflict. In a future release this header will be required and missing values will return 428 Precondition Required. Accepts an integer version (bare or ETag-quoted) or \"*\" for an unconditional write (RFC 7232). (optional)

    try:
        # Update a team
        api_response = api_instance.update_team(team_id, team_input, if_match=if_match)
...
------------- | ------------- | ------------- | -------------
 **team_id** | **UUID**| Team UUID | 
 **team_input** | [**TeamInput**](TeamInput.md)| Complete team data for replacement | 
 **if_match** | **str**| Optimistic-locking precondition. Pass the integer version returned by the previous read (or as the body &#39;version&#39; field on the previous write). On version mismatch the server returns 409 Conflict. In a future release this header will be required and missing values will return 428 Precondition Required. Accepts an integer version (bare or ETag-quoted) or \&quot;*\&quot; for an unconditional write (RFC 7232). | [optional] 
...
**500** | Error response |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**415** | Unsupported media type - the request Content-Type is not supported for this operation |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**200** | Team updated |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  * ETag - Current optimistic-locking version of the resource (RFC 7232). Echo this value back via If-Match on the next PUT/PATCH. <br>  |
**401** | Unauthorized |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**403** | Forbidden |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**404** | Team not found |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
**409** | Conflict (e.g., relationship cycle detected) |  * X-RateLimit-Limit - Maximum number of requests allowed in the current time window <br>  * X-RateLimit-Remaining - Number of requests remaining in the current time window <br>  * X-RateLimit-Reset - Unix epoch seconds when the rate limit window resets <br>  |
...
> Metadata update_team_metadata(team_id, key, metadata)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update team metadata
        api_response = api_instance.update_team_metadata(team_id, key, metadata)
        print("The response of TeamsApi->update_team_metadata:\n")
        pprint(api_response)
    except Exception as e:
...
# **update_team_note**
> TeamNote update_team_note(team_id, team_note_id, body)
...
with tmi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a team note
        api_response = api_instance.update_team_note(team_id, team_note_id, body)
        print("The response of TeamsApi->update_team_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TeamsApi->update_team_note: %s\n" % e)
```
