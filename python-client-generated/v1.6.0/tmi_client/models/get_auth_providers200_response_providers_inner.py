...
class GetAuthProviders200ResponseProvidersInner(BaseModel):
    ...
    icon: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="Icon identifier for the provider")
    auth_url: Annotated[str, Field(strict=True, max_length=1024)] = Field(description="TMI authorization endpoint URL for this provider")
    token_url: Annotated[str, Field(strict=True, max_length=1024)] = Field(description="TMI token exchange endpoint URL for this provider")
    redirect_uri: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="OAuth callback URI configured for this provider")
    client_id: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="OAuth client ID for this provider")
    __properties: ClassVar[List[str]] = ["id", "name", "icon", "auth_url", "token_url", "redirect_uri", "client_id"]
