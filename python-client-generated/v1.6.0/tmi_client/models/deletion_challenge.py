...
class DeletionChallenge(BaseModel):
    """
    Challenge response for user account deletion
    """ # noqa: E501
    challenge_text: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="The exact challenge string that must be provided to confirm deletion")
    expires_at: datetime = Field(description="When the challenge expires (3 minutes from issuance)")
    __properties: ClassVar[List[str]] = ["challenge_text", "expires_at"]

    @field_validator('challenge_text', mode="before")
    def challenge_text_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "challenge_text": obj.get("challenge_text"),
