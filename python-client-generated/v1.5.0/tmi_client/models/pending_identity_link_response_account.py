...
class PendingIdentityLinkResponseAccount(BaseModel):
    """
    PendingIdentityLinkResponseAccount
    """ # noqa: E501
    provider: StrictStr = Field(description="Primary identity provider of this TMI account")
    email: StrictStr = Field(description="Email address of this TMI account")
    __properties: ClassVar[List[str]] = ["provider", "email"]
