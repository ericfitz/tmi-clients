...
class TokenRefreshRequest(BaseModel):
    ...
    """ # noqa: E501
    refresh_token: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1000)]] = Field(default=None, description="Refresh token. Optional: browser SPA clients may omit it and send an empty body, in which case the server reads the refresh token from the HttpOnly refresh cookie. Non-browser clients should supply it in the body.", json_schema_extra={"examples": ["8xLOxBtZp8_example_refresh_token"]})
