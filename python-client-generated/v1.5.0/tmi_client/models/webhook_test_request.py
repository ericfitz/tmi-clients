...
class WebhookTestRequest(BaseModel):
    ...
    """ # noqa: E501
    event_type: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(default=None, description="Webhook event type following {resource}.{action} pattern")
    ...
    def event_type_validate_enum(cls, value):
        ...
        if value not in set(['threat_model.created', 'threat_model.updated', 'threat_model.deleted', 'diagram.created', 'diagram.updated', 'diagram.deleted', 'document.created', 'document.updated', 'document.deleted', 'document.extraction_completed', 'document.extraction_failed', 'note.created', 'note.updated', 'note.deleted', 'repository.created', 'repository.updated', 'repository.deleted', 'asset.created', 'asset.updated', 'asset.deleted', 'threat.created', 'threat.updated', 'threat.deleted', 'metadata.created', 'metadata.updated', 'metadata.deleted', 'system_audit.admin_write']):
            raise ValueError("must be one of enum values ('threat_model.created', 'threat_model.updated', 'threat_model.deleted', 'diagram.created', 'diagram.updated', 'diagram.deleted', 'document.created', 'document.updated', 'document.deleted', 'document.extraction_completed', 'document.extraction_failed', 'note.created', 'note.updated', 'note.deleted', 'repository.created', 'repository.updated', 'repository.deleted', 'asset.created', 'asset.updated', 'asset.deleted', 'threat.created', 'threat.updated', 'threat.deleted', 'metadata.created', 'metadata.updated', 'metadata.deleted', 'system_audit.admin_write')")
        return value
