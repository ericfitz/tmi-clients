...
class MyIdentitiesResponse(BaseModel):
    """
    MyIdentitiesResponse
    """ # noqa: E501
    primary: MyIdentitiesResponsePrimary
    linked: Optional[List[LinkedIdentity]] = Field(default=None, description="Additional linked identities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "primary": MyIdentitiesResponsePrimary.from_dict(obj["primary"]) if obj.get("primary") is not None else None,
