...
class PendingIdentityLinkResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pending": PendingIdentityLinkResponsePending.from_dict(obj["pending"]) if obj.get("pending") is not None else None,
            "account": PendingIdentityLinkResponseAccount.from_dict(obj["account"]) if obj.get("account") is not None else None
        })
        return _obj
