...
class CreateThreatModelDocument202Response(BaseModel):
    """
    CreateThreatModelDocument202Response
    """ # noqa: E501
    document: Document
    job_id: UUID = Field(description="Identifier of the queued extraction job, for client correlation. The extraction result is surfaced via the document access_status and the document.extraction_* webhook events; there is no dedicated job-status endpoint.")
    __properties: ClassVar[List[str]] = ["document", "job_id"]
