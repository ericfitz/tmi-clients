...
class DiagramListItem(BaseModel):
    ...
    name: Annotated[str, Field(strict=True, max_length=256)] = Field(description="Name of the diagram")
    type: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="Type of the diagram")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "description", "created_at", "modified_at", "image", "include_in_report", "timmy_enabled", "deleted_at", "alias"]
