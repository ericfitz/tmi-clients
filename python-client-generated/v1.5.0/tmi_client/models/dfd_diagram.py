...
class DfdDiagram(BaseDiagram):
    """
    DfdDiagram
    """ # noqa: E501
    type: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(default=None, description="DFD diagram type with version")
    cells: Annotated[List[DfdDiagramAllOfCells], Field(max_length=10000)] = Field(description="List of diagram cells (nodes and edges) following X6 structure")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "created_at", "modified_at", "metadata", "update_vector", "image", "description", "include_in_report", "timmy_enabled", "deleted_at", "color_palette", "auto_generated", "alias", "cells", "version"]
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DfdDiagram, Diagram]]:
        ...
        raise ValueError("DfdDiagram failed to lookup discriminator value from " +
