...
class NodeAttrsText(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ref_x2
        if self.ref_x2:
            _dict['refX2'] = self.ref_x2.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ref_y2
        if self.ref_y2:
            _dict['refY2'] = self.ref_y2.to_dict()
        return _dict
