...
class ContentTokenList(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in content_tokens (list)
        _items = []
        if self.content_tokens:
            for _item_content_tokens in self.content_tokens:
                if _item_content_tokens:
                    _items.append(_item_content_tokens.to_dict())
            _dict['content_tokens'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content_tokens": [ContentTokenInfo.from_dict(_item) for _item in obj["content_tokens"]] if obj.get("content_tokens") is not None else None
        })
        return _obj
