...
class TestDocumentAccessDiagnostics(unittest.TestCase):
    """DocumentAccessDiagnostics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test DocumentAccessDiagnostics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAccessDiagnostics`
        """
        model = DocumentAccessDiagnostics()
        if include_optional:
            return DocumentAccessDiagnostics(
                reason_code = 'token_not_linked',
                reason_detail = '',
                remediations = [
                    tmi_client.models.access_remediation.AccessRemediation(
                        action = 'link_account', 
                        params = { }, )
                    ]
            )
    ...
    def testDocumentAccessDiagnostics(self):
        """Test DocumentAccessDiagnostics"""
