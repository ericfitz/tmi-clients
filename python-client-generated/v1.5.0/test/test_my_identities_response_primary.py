...
class TestMyIdentitiesResponsePrimary(unittest.TestCase):
    """MyIdentitiesResponsePrimary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test MyIdentitiesResponsePrimary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyIdentitiesResponsePrimary`
        """
        model = MyIdentitiesResponsePrimary()
        if include_optional:
            return MyIdentitiesResponsePrimary(
                provider = '',
                email = '',
                name = ''
            )
    ...
    def testMyIdentitiesResponsePrimary(self):
        """Test MyIdentitiesResponsePrimary"""
