...
class TestAuthorizeContentTokenRequest(unittest.TestCase):
    """AuthorizeContentTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test AuthorizeContentTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthorizeContentTokenRequest`
        """
        model = AuthorizeContentTokenRequest()
        if include_optional:
            return AuthorizeContentTokenRequest(
    ...
    def testAuthorizeContentTokenRequest(self):
        """Test AuthorizeContentTokenRequest"""
