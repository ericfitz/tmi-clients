...
class TestPendingIdentityLinkResponse(unittest.TestCase):
    """PendingIdentityLinkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test PendingIdentityLinkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingIdentityLinkResponse`
        """
        model = PendingIdentityLinkResponse()
        if include_optional:
            return PendingIdentityLinkResponse(
                pending = tmi_client.models.pending_identity_link_response_pending.PendingIdentityLinkResponse_pending(
                    provider = '', 
                    provider_user_id = '', 
                    email = '', 
                    name = '', ),
                account = tmi_client.models.pending_identity_link_response_account.PendingIdentityLinkResponse_account(
                    provider = '', 
                    email = '', )
            )
        else:
    ...
    def testPendingIdentityLinkResponse(self):
        """Test PendingIdentityLinkResponse"""
