...
class TestContentFeedbackInput(unittest.TestCase):
    """ContentFeedbackInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ContentFeedbackInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentFeedbackInput`
        """
        model = ContentFeedbackInput()
        if include_optional:
            return ContentFeedbackInput(
                sentiment = 'up',
                target_type = 'note',
                target_id = '',
                target_field = '',
    ...
    def testContentFeedbackInput(self):
        """Test ContentFeedbackInput"""
