...
class TestPickerTokenResponse(unittest.TestCase):
    """PickerTokenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test PickerTokenResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickerTokenResponse`
        """
        model = PickerTokenResponse()
        if include_optional:
    ...
    def testPickerTokenResponse(self):
        """Test PickerTokenResponse"""
