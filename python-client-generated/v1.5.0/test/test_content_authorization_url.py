...
class TestContentAuthorizationURL(unittest.TestCase):
    """ContentAuthorizationURL unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ContentAuthorizationURL
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentAuthorizationURL`
        """
        model = ContentAuthorizationURL()
        if include_optional:
    ...
    def testContentAuthorizationURL(self):
        """Test ContentAuthorizationURL"""
