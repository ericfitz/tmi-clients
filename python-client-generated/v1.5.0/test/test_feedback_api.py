...
class TestFeedbackApi(unittest.TestCase):
    ...
    def test_create_usability_feedback(self) -> None:
        """Test case for create_usability_feedback

        Submit usability feedback
        """
        pass

    def test_get_usability_feedback(self) -> None:
        """Test case for get_usability_feedback

        Get a single usability feedback entry (admin)
        """
        pass

    def test_list_usability_feedback(self) -> None:
        """Test case for list_usability_feedback
