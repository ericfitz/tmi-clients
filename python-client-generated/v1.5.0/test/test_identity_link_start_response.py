...
class TestIdentityLinkStartResponse(unittest.TestCase):
    """IdentityLinkStartResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test IdentityLinkStartResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityLinkStartResponse`
        """
        model = IdentityLinkStartResponse()
        if include_optional:
    ...
    def testIdentityLinkStartResponse(self):
        """Test IdentityLinkStartResponse"""
