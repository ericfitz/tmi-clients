...
class TestConfirmIdentityLinkRequest(unittest.TestCase):
    """ConfirmIdentityLinkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ConfirmIdentityLinkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmIdentityLinkRequest`
        """
        model = ConfirmIdentityLinkRequest()
        if include_optional:
            return ConfirmIdentityLinkRequest(
                token = ''
            )
        else:
            return ConfirmIdentityLinkRequest(
    ...
    def testConfirmIdentityLinkRequest(self):
        """Test ConfirmIdentityLinkRequest"""
