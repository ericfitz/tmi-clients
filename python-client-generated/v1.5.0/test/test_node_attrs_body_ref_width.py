...
class TestNodeAttrsBodyRefWidth(unittest.TestCase):
    """NodeAttrsBodyRefWidth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test NodeAttrsBodyRefWidth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeAttrsBodyRefWidth`
        """
        model = NodeAttrsBodyRefWidth()
        if include_optional:
    ...
    def testNodeAttrsBodyRefWidth(self):
        """Test NodeAttrsBodyRefWidth"""
