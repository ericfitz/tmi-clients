...
class TestAccessRemediation(unittest.TestCase):
    """AccessRemediation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test AccessRemediation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessRemediation`
        """
        model = AccessRemediation()
        if include_optional:
    ...
    def testAccessRemediation(self):
        """Test AccessRemediation"""
