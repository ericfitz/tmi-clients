...
class TestPickerRegistration(unittest.TestCase):
    """PickerRegistration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test PickerRegistration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickerRegistration`
        """
        model = PickerRegistration()
        if include_optional:
            return PickerRegistration(
    ...
    def testPickerRegistration(self):
        """Test PickerRegistration"""
