...
class TestUsabilityFeedback(unittest.TestCase):
    """UsabilityFeedback unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test UsabilityFeedback
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsabilityFeedback`
        """
        model = UsabilityFeedback()
        if include_optional:
    ...
    def testUsabilityFeedback(self):
        """Test UsabilityFeedback"""
