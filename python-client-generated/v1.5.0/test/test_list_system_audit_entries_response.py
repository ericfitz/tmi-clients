...
class TestListSystemAuditEntriesResponse(unittest.TestCase):
    """ListSystemAuditEntriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test ListSystemAuditEntriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListSystemAuditEntriesResponse`
        """
        model = ListSystemAuditEntriesResponse()
        if include_optional:
            return ListSystemAuditEntriesResponse(
                entries = [
                    tmi_client.models.system_audit_entry.SystemAuditEntry(
                        id = '', 
    ...
    def testListSystemAuditEntriesResponse(self):
        """Test ListSystemAuditEntriesResponse"""
