...
class TestMicrosoftPickerGrantResponse(unittest.TestCase):
    """MicrosoftPickerGrantResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test MicrosoftPickerGrantResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MicrosoftPickerGrantResponse`
        """
        model = MicrosoftPickerGrantResponse()
        if include_optional:
    ...
    def testMicrosoftPickerGrantResponse(self):
        """Test MicrosoftPickerGrantResponse"""
