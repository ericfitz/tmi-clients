...
json = "{}"
# create an instance of AssetInput from a JSON string
asset_input_instance = AssetInput.from_json(json)
# print the JSON string representation of the object
print(AssetInput.to_json())

# convert the object into a dict
asset_input_dict = asset_input_instance.to_dict()
# create an instance of AssetInput from a dict
asset_input_from_dict = AssetInput.from_dict(asset_input_dict)
```
