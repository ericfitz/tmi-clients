...
------------ | ------------- | ------------- | -------------
**id** | **str** | Unique identifier for the team (UUID) | [optional] 
**created_by** | **object** | User who created the team | [optional] 
**created_at** | **datetime** | Creation timestamp (RFC3339) | [optional] 
**modified_by** | **object** | User who last modified the team | [optional] 
