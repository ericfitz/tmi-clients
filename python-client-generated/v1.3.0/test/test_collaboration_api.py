...
class TestCollaborationApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = CollaborationApi()

    def tearDown(self) -> None:
        pass

    def test_create_diagram_collaboration_session(self) -> None:
    ...
    def test_end_diagram_collaboration_session(self) -> None:
    ...
    def test_get_current_user_sessions(self) -> None:
    ...
    def test_get_diagram_collaboration_session(self) -> None:
