...
class TestGetProviderGroups200ResponseGroupsInner(unittest.TestCase):
    """GetProviderGroups200ResponseGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test GetProviderGroups200ResponseGroupsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetProviderGroups200ResponseGroupsInner`
        """
        model = GetProviderGroups200ResponseGroupsInner()
        if include_optional:
            return GetProviderGroups200ResponseGroupsInner(
                name = 'jUR,rZ#UM/?R,Fp^l6$ARj',
                display_name = 'jUR,rZ#UM/?R,Fp^l6$ARj',
    ...
    def testGetProviderGroups200ResponseGroupsInner(self):
        """Test GetProviderGroups200ResponseGroupsInner"""
