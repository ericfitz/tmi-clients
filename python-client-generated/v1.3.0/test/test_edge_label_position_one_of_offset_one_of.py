...
class TestEdgeLabelPositionOneOfOffsetOneOf(unittest.TestCase):
    """EdgeLabelPositionOneOfOffsetOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test EdgeLabelPositionOneOfOffsetOneOf
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EdgeLabelPositionOneOfOffsetOneOf`
        """
        model = EdgeLabelPositionOneOfOffsetOneOf()
        if include_optional:
            return EdgeLabelPositionOneOfOffsetOneOf(
                x = 1.337,
                y = 1.337
            )
        else:
    ...
    def testEdgeLabelPositionOneOfOffsetOneOf(self):
        """Test EdgeLabelPositionOneOfOffsetOneOf"""
