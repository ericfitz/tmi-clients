...
class TestApiInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> None:
        ...
        if include_optional:
            return ApiInfo(
                status = {"code":"ok","time":"2026-01-17T12:00:00Z"},
                service = {"name":"TMI Threat Modeling Interface","build":"1.0.0"},
                api = {"version":"1.0.0","specification":"https://api.example.com/openapi.json"},
                operator = {"name":"Acme Corporation","contact":"support@acme.example.com"},
                health = {"database":{"status":"healthy","latency_ms":5},"redis":{"status":"healthy","latency_ms":2}}
            )
        else:
            return ApiInfo(
                status = {"code":"ok","time":"2026-01-17T12:00:00Z"},
