...
class TestUpdateThreatMetadataByKeyRequest(unittest.TestCase):
    """UpdateThreatMetadataByKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test UpdateThreatMetadataByKeyRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateThreatMetadataByKeyRequest`
        """
        model = UpdateThreatMetadataByKeyRequest()
        if include_optional:
            return UpdateThreatMetadataByKeyRequest(
    ...
    def testUpdateThreatMetadataByKeyRequest(self):
        """Test UpdateThreatMetadataByKeyRequest"""
