...
class TestTransferOwnershipResultSurveyResponsesTransferred(unittest.TestCase):
    """TransferOwnershipResultSurveyResponsesTransferred unit test stubs"""
    ...
    def make_instance(self, include_optional) -> None:
        """Test TransferOwnershipResultSurveyResponsesTransferred
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TransferOwnershipResultSurveyResponsesTransferred`
        """
        model = TransferOwnershipResultSurveyResponsesTransferred()
        if include_optional:
            return TransferOwnershipResultSurveyResponsesTransferred(
                count = 0,
                survey_response_ids = [
                    ''
                    ]
    ...
    def testTransferOwnershipResultSurveyResponsesTransferred(self):
        """Test TransferOwnershipResultSurveyResponsesTransferred"""
