...
class CVSSScore(BaseModel):
    ...
    """ # noqa: E501
    vector: Annotated[str, Field(min_length=26, strict=True, max_length=250)] = Field(description="CVSS vector string (e.g., CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H)")
