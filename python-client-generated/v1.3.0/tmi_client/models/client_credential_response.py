...
class ClientCredentialResponse(BaseModel):
    ...
    client_secret: StrictStr = Field(description="OAuth 2.0 client secret - ONLY returned at creation time, cannot be retrieved later")
    ...
    __properties: ClassVar[List[str]] = ["id", "client_id", "client_secret", "name", "description", "created_at", "expires_at"]
