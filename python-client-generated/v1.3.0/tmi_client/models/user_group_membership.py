...
class UserGroupMembership(BaseModel):
    ...
    """ # noqa: E501
    internal_uuid: UUID = Field(description="Group internal UUID")
    group_name: StrictStr = Field(description="Group name (e.g. administrators, security-reviewers)")
    name: Optional[StrictStr] = Field(default=None, description="Display name for the group")
    __properties: ClassVar[List[str]] = ["internal_uuid", "group_name", "name"]
