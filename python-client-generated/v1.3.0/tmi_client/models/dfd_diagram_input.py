...
class DfdDiagramInput(BaseDiagramInput):
    ...
    cells: Annotated[List[DfdDiagramInputAllOfCells], Field(max_length=10000)] = Field(description="List of diagram cells (nodes and edges) following X6 structure")
    __properties: ClassVar[List[str]] = ["name", "type", "metadata", "image", "description", "include_in_report", "timmy_enabled", "color_palette", "cells"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cells": [DfdDiagramInputAllOfCells.from_dict(_item) for _item in obj["cells"]] if obj.get("cells") is not None else None
        })
        return _obj
