...
class WebhookTestRequest(BaseModel):
    ...
    event_type: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(
        default=None,
    ...
    def event_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('threat_model.created', 'threat_model.updated', 'threat_model.deleted', 'diagram.created', 'diagram.updated', 'diagram.deleted', 'document.created', 'document.updated', 'document.deleted', 'note.created', 'note.updated', 'note.deleted', 'repository.created', 'repository.updated', 'repository.deleted', 'asset.created', 'asset.updated', 'asset.deleted', 'threat.created', 'threat.updated', 'threat.deleted', 'metadata.created', 'metadata.updated', 'metadata.deleted')"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"event_type": obj.get("event_type")})
        return _obj
