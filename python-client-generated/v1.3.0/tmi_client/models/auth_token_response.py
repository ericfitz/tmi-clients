...
class AuthTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    access_token: Annotated[str, Field(strict=True, max_length=4096)] = Field(description="JWT access token")
    refresh_token: Annotated[str, Field(strict=True, max_length=1024)] = Field(description="Refresh token for obtaining new access tokens")
    token_type: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="Token type")
