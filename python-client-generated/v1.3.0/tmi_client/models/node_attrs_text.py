...
class NodeAttrsText(BaseModel):
    ...
    ref_x: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Horizontal position (0-1 relative or pixels)", alias="refX")
    ref_y: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Vertical position (0-1 relative or pixels)", alias="refY")
