...
class ClientCredentialInfo(BaseModel):
    ...
    client_id: Annotated[str, Field(strict=True)] = Field(
    ...
    last_used_at: Optional[datetime] = Field(
        default=None, description="Last time this credential was used (ISO 8601)"
    )
    ...
    def client_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^tmi_cc_[A-Za-z0-9_-]+$", value):
            raise ValueError(
                r"must validate the regular expression /^tmi_cc_[A-Za-z0-9_-]+$/"
            )
        return value
