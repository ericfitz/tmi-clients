...
class ClientCredentialInfo(BaseModel):
    """
    Client credential information without the secret
    """ # noqa: E501
    id: UUID = Field(description="Unique identifier for the credential")
    client_id: Annotated[str, Field(strict=True)] = Field(description="OAuth 2.0 client ID (format: tmi_cc_*)")
    name: StrictStr = Field(description="Human-readable name for the credential")
    description: Optional[StrictStr] = Field(default=None, description="Optional description of the credential's purpose")
    is_active: StrictBool = Field(description="Whether the credential is active")
    last_used_at: Optional[datetime] = Field(default=None, description="Last time this credential was used (ISO 8601)")
    created_at: datetime = Field(description="Creation timestamp (ISO 8601)")
    modified_at: datetime = Field(description="Last modification timestamp (ISO 8601)")
