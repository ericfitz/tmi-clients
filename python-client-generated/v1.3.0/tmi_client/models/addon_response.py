...
class AddonResponse(BaseModel):
    ...
    """ # noqa: E501
    id: UUID = Field(description="Add-on identifier")
    created_at: datetime = Field(description="Creation timestamp")
    name: StrictStr = Field(description="Display name")
    webhook_id: UUID = Field(description="Associated webhook subscription ID")
    description: Optional[StrictStr] = Field(default=None, description="Add-on description")
    icon: Optional[StrictStr] = Field(default=None, description="Icon identifier")
    objects: Optional[Annotated[List[StrictStr], Field(max_length=100)]] = Field(default=None, description="Supported TMI object types")
    threat_model_id: Optional[UUID] = Field(default=None, description="Threat model scope (if scoped)")
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "name", "webhook_id", "description", "icon", "objects", "threat_model_id", "parameters"]
