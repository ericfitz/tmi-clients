...
class SurveySettings(BaseModel):
    ...
    allow_threat_model_linking: Optional[StrictBool] = Field(
        default=True,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "allow_threat_model_linking": obj.get("allow_threat_model_linking")
                if obj.get("allow_threat_model_linking") is not None
                else True
            }
        )
        return _obj
