...
class RepositoryBaseParameters(BaseModel):
    ...
    ref_type: Annotated[str, Field(strict=True, max_length=6)] = Field(
        description="Reference type (branch, tag, or commit)", alias="refType"
    )
    ref_value: Annotated[str, Field(strict=True, max_length=256)] = Field(
        description="Reference value (branch name, tag value, or commit id)",
        alias="refValue",
    )
    sub_path: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="Sub-path within the repository", alias="subPath"
    )
