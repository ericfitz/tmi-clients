...
class Participant(BaseModel):
    ...
    permissions: Annotated[str, Field(strict=True, max_length=1000)] = Field(
    ...
    def permissions_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["reader", "writer"]):
            raise ValueError("must be one of enum values ('reader', 'writer')")
        return value
