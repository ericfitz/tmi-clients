...
class CreateDiagramCollaborationSession409Response(BaseModel):
    """
    CreateDiagramCollaborationSession409Response
    """  # noqa: E501

    error: Annotated[str, Field(strict=True, max_length=1000)] = Field(
        description="Error message indicating session already exists"
    )
    join_url: Annotated[str, Field(strict=True, max_length=1024)] = Field(
    ...
    def join_url_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"error": obj.get("error"), "join_url": obj.get("join_url")}
        )
        return _obj
