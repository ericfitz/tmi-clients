...
class MigrateSystemSettings200Response(BaseModel):
    """
    MigrateSystemSettings200Response
    """  # noqa: E501

    migrated: StrictInt = Field(
    ...
    settings: Annotated[List[SystemSetting], Field(max_length=100)] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "settings": [
                    SystemSetting.from_dict(_item) for _item in obj["settings"]
                ]
