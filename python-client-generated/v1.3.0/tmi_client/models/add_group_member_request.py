...
class AddGroupMemberRequest(BaseModel):
    ...
    """ # noqa: E501
    user_internal_uuid: Optional[UUID] = Field(default=None, description="Internal UUID of the user to add to the group")
    notes: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(default=None, description="Optional notes about this membership")
    subject_type: Optional[StrictStr] = Field(default='user', description="Type of member to add: user or group")
    member_group_internal_uuid: Optional[UUID] = Field(default=None, description="Internal UUID of the group to add as a member (required when subject_type is group)")
    __properties: ClassVar[List[str]] = ["user_internal_uuid", "notes", "subject_type", "member_group_internal_uuid"]
