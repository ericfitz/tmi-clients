...
class InvocationResponse(BaseModel):
    ...
    data: Optional[StrictStr] = Field(default=None, description="JSON-encoded data")
    __properties: ClassVar[List[str]] = ["id", "addon_id", "threat_model_id", "object_type", "object_id", "invoked_by", "status", "status_percent", "status_message", "created_at", "status_updated_at", "data"]
