...
class ListInvocationsResponse(BaseModel):
    """
    Paginated list of addon invocations
    """ # noqa: E501
    invocations: Annotated[List[InvocationResponse], Field(max_length=1000)]
    total: StrictInt = Field(description="Total number of invocations")
    limit: StrictInt = Field(description="Pagination limit")
    offset: StrictInt = Field(description="Pagination offset")
    __properties: ClassVar[List[str]] = ["invocations", "total", "limit", "offset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invocations": [InvocationResponse.from_dict(_item) for _item in obj["invocations"]] if obj.get("invocations") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
