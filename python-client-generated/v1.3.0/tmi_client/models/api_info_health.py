...
class ApiInfoHealth(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "database": ComponentHealth.from_dict(obj["database"]) if obj.get("database") is not None else None,
            "redis": ComponentHealth.from_dict(obj["redis"]) if obj.get("redis") is not None else None
        })
        return _obj
