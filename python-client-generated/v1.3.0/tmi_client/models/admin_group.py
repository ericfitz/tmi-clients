...
class AdminGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["internal_uuid", "provider", "group_name", "name", "description", "first_used", "last_used", "usage_count", "used_in_authorizations", "used_in_admin_grants", "member_count"]
