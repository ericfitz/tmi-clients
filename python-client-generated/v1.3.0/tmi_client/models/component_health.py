...
class ComponentHealth(BaseModel):
    ...
    """ # noqa: E501
    status: Annotated[str, Field(strict=True, max_length=32)] = Field(description="Component health status")
    latency_ms: Optional[Annotated[int, Field(le=10000, strict=True, ge=0)]] = Field(default=None, description="Response latency in milliseconds")
    message: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Human-readable status message or error description")
    __properties: ClassVar[List[str]] = ["status", "latency_ms", "message"]
