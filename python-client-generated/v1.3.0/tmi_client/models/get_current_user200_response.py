...
class GetCurrentUser200Response(BaseModel):
    ...
    sub: Annotated[str, Field(strict=True, max_length=1000)] = Field(
    ...
    idp: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(
        default=None, description="Identity provider that authenticated the user"
    )
    groups: Optional[
        Annotated[
    ...
    ] = Field(default=None, description="Groups the user belongs to")
