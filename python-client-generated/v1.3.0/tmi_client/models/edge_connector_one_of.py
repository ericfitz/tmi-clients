...
class EdgeConnectorOneOf(BaseModel):
    """
    Connector with custom configuration
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=256)] = Field(description="Connector style name")
    args: Optional[EdgeConnectorOneOfArgs] = None
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['normal', 'rounded', 'smooth', 'jumpover']):
            raise ValueError("must be one of enum values ('normal', 'rounded', 'smooth', 'jumpover')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "args": EdgeConnectorOneOfArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
