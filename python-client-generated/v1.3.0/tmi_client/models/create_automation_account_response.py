...
class CreateAutomationAccountResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user", "client_credential"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of client_credential
        if self.client_credential:
            _dict['client_credential'] = self.client_credential.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": AdminUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "client_credential": ClientCredentialResponse.from_dict(obj["client_credential"]) if obj.get("client_credential") is not None else None
        })
        return _obj
