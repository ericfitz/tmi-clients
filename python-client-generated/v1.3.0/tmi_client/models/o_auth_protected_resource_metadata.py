...
class OAuthProtectedResourceMetadata(BaseModel):
    ...
    def bearer_methods_supported_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['header', 'body', 'query']):
                raise ValueError("each list item must be one of ('header', 'body', 'query')")
        return value
    ...
    @field_validator('resource_documentation', mode="before")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tls_client_certificate_bound_access_tokens": obj.get("tls_client_certificate_bound_access_tokens")
        })
        return _obj
