...
class EdgeLabel(BaseModel):
    ...
    """ # noqa: E501
    attrs: Optional[EdgeLabelAttrs] = None
    position: Optional[EdgeLabelPosition] = None
    __properties: ClassVar[List[str]] = ["attrs", "position"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attrs": EdgeLabelAttrs.from_dict(obj["attrs"]) if obj.get("attrs") is not None else None,
            "position": EdgeLabelPosition.from_dict(obj["position"]) if obj.get("position") is not None else None
        })
        return _obj
