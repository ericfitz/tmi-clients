...
class CreateAdminGroupRequest(BaseModel):
    ...
    group_name: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = (
        Field(description="Group identifier (alphanumeric, hyphens, underscores only)")
    )
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(
        default=None, description="Optional group description"
    )
