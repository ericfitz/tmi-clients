...
class Error(BaseModel):
    ...
    """ # noqa: E501
    error: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="Error code")
    error_description: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="Human-readable error description")
    error_uri: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(default=None, description="URI to documentation about the error")
    details: Optional[ErrorDetails] = None
    __properties: ClassVar[List[str]] = ["error", "error_description", "error_uri", "details"]

    @field_validator('error', mode="before")
    def error_validate_regular_expression(cls, value):
    ...
    @field_validator('error_description', mode="before")
    ...
    @field_validator('error_uri', mode="before")
    def error_uri_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
