...
class AddonQuotaUpdate(BaseModel):
    """
    Configuration update for addon invocation quotas
    """  # noqa: E501

    max_active_invocations: Annotated[int, Field(le=10, strict=True, ge=1)] = Field(
        description="Maximum concurrent active addon invocations"
    )
    max_invocations_per_hour: Annotated[int, Field(le=1000, strict=True, ge=1)] = Field(
