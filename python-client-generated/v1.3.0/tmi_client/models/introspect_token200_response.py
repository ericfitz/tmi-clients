...
class IntrospectToken200Response(BaseModel):
    ...
    sub: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(
        default=None, description="Subject (user identifier)"
    )
    email: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(
    ...
    exp: Optional[StrictInt] = Field(
        default=None, description="Token expiration time (Unix timestamp)"
    )
    iat: Optional[StrictInt] = Field(
        default=None, description="Token issued at time (Unix timestamp)"
    )
    iss: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(
        default=None, description="Token issuer"
    )
    token_type: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(
        default=None, description="Type of the token (RFC 7662)"
    )
    scope: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(
        default=None, description="Space-separated list of scopes (RFC 7662)"
    )
