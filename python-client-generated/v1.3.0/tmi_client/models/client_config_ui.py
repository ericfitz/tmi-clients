...
class ClientConfigUi(BaseModel):
    """
    UI configuration defaults
    """  # noqa: E501

    default_theme: Optional[StrictStr] = Field(
        default=None, description="Default UI theme"
    )
    __properties: ClassVar[List[str]] = ["default_theme"]

    @field_validator("default_theme")
    def default_theme_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"default_theme": obj.get("default_theme")})
        return _obj
