...
class RollbackResponse(BaseModel):
    ...
    restored_entity: Optional[Dict[str, Any]] = Field(
        default=None, description="The entity restored to its previous state"
    )
    audit_entry: AuditEntry = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of audit_entry
        if self.audit_entry:
            _dict["audit_entry"] = self.audit_entry.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "restored_entity": obj.get("restored_entity"),
                "audit_entry": AuditEntry.from_dict(obj["audit_entry"])
                if obj.get("audit_entry") is not None
                else None,
            }
        )
        return _obj
