...
class CellData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "_metadata": [Metadata.from_dict(_item) for _item in obj["_metadata"]]
