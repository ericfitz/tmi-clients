...
class AddonInvocationQuota(BaseModel):
    """
    Addon invocation quota for a user
    """ # noqa: E501
    owner_id: UUID = Field(description="User ID")
    max_active_invocations: Annotated[int, Field(strict=True, ge=1)] = Field(description="Maximum concurrent active addon invocations")
    max_invocations_per_hour: Annotated[int, Field(strict=True, ge=1)] = Field(description="Maximum addon invocations per hour")
    created_at: datetime = Field(description="Creation timestamp")
    modified_at: datetime = Field(description="Last modification timestamp")
    __properties: ClassVar[List[str]] = ["owner_id", "max_active_invocations", "max_invocations_per_hour", "created_at", "modified_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_active_invocations": obj.get("max_active_invocations"),
            "max_invocations_per_hour": obj.get("max_invocations_per_hour"),
