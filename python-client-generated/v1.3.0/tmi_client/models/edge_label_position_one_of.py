...
class EdgeLabelPositionOneOf(BaseModel):
    ...
    angle: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Rotation angle in degrees (clockwise)"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "offset": EdgeLabelPositionOneOfOffset.from_dict(obj["offset"])
                if obj.get("offset") is not None
                else None,
                "angle": obj.get("angle"),
                "options": EdgeLabelPositionOneOfOptions.from_dict(obj["options"])
