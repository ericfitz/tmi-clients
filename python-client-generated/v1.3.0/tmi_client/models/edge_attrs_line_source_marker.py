...
class EdgeAttrsLineSourceMarker(BaseModel):
    """
    Source marker configuration
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="Marker type")
    size: Optional[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="Marker size in pixels")
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(['classic', 'block', 'diamond', 'circle']):
            raise ValueError("must be one of enum values ('classic', 'block', 'diamond', 'circle')")
        return value
