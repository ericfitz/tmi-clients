...
class AdminGroupListResponse(BaseModel):
    ...
    """ # noqa: E501
    groups: Annotated[List[AdminGroup], Field(max_length=1000)] = Field(description="List of groups")
    total: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of groups matching the filter")
    limit: Annotated[int, Field(strict=True, ge=0)] = Field(description="Maximum number of results returned")
    offset: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of results skipped")
    __properties: ClassVar[List[str]] = ["groups", "total", "limit", "offset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [AdminGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
