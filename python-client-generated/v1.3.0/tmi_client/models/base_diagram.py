...
class BaseDiagram(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "created_at", "modified_at", "metadata", "update_vector", "image", "description", "include_in_report", "timmy_enabled", "deleted_at", "color_palette"]
