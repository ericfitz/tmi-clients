...
class ExchangeOAuthCodeRequest(BaseModel):
    ...
    code: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None,
    ...
    state: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None,
        description="State parameter for CSRF protection (optional but recommended)",
    )
    redirect_uri: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(
        default=None,
        description="Redirect URI used in the authorization request (must match exactly)",
    )
    code_verifier: Optional[
        Annotated[str, Field(min_length=43, strict=True, max_length=128)]
    ] = Field(
        default=None,
    ...
    def grant_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('authorization_code', 'client_credentials', 'refresh_token')"
            )
        return value
